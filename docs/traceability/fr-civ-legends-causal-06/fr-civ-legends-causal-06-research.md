# Research: FR-CIV-LEGENDS-CAUSAL-06 -- Civ Legends Causal
...
What is the best approach to implement Civ Legends Causal within the Civis simulation engine?

## Background

This FR belongs to the FR-CIV-LEGENDS-CAUSAL epic and is expected to be implemented in `crates/legends/src/`.
