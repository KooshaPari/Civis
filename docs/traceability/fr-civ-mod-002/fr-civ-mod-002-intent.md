# Intent: FR-CIV-MOD-002 -- Mod system (WASM)
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-MOD-002 contributes to the overall simulation capability by addressing: Mod system (WASM).
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-mod-002-spec.md` |
| ADR | `fr-civ-mod-002-adr.md` |
| Research | `fr-civ-mod-002-research.md` |
| Plan | `fr-civ-mod-002-plan.md` |
