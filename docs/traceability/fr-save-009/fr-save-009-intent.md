# Intent: FR-SAVE-009 -- Save system
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-SAVE-009 contributes to the overall simulation capability by addressing: Save system.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-save-009-spec.md` |
| ADR | `fr-save-009-adr.md` |
| Research | `fr-save-009-research.md` |
| Plan | `fr-save-009-plan.md` |
