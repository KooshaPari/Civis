# Intent: FR-CIV-BUILD-013 -- Building tiers and construction
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-BUILD-013 contributes to the overall simulation capability by addressing: Building tiers and construction.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-build-013-spec.md` |
| ADR | `fr-civ-build-013-adr.md` |
| Research | `fr-civ-build-013-research.md` |
| Plan | `fr-civ-build-013-plan.md` |
