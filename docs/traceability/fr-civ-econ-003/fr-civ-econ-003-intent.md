# Intent: FR-CIV-ECON-003 -- Economy and joule allocation
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-ECON-003 contributes to the overall simulation capability by addressing: Economy and joule allocation.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-econ-003-spec.md` |
| ADR | `fr-civ-econ-003-adr.md` |
| Research | `fr-civ-econ-003-research.md` |
| Plan | `fr-civ-econ-003-plan.md` |
