# ADR: FR-CIV-RTS-002 -- RTS gameplay

> Status: Proposed
> Date: 2026-09-17
> Deciders: CivLab
> Relates to: FR-CIV-RTS-002
> Epic: FR-CIV-RTS

## Context

FR-CIV-RTS-002 is part of the FR-CIV-RTS epic. This functional requirement captures: RTS gameplay.
...
- `docs/specs/CIV-0300-rts-ui-ux-spec.md:2005`
...
TBD -- The architectural decision for FR-CIV-RTS-002 needs to be finalized based on implementation exploration.
