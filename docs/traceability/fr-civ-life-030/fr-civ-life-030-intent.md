# Intent: FR-CIV-LIFE-030 -- Life simulation and needs
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-LIFE-030 contributes to the overall simulation capability by addressing: Life simulation and needs.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-life-030-spec.md` |
| ADR | `fr-civ-life-030-adr.md` |
| Research | `fr-civ-life-030-research.md` |
| Plan | `fr-civ-life-030-plan.md` |
