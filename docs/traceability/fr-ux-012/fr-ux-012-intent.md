# Intent: FR-UX-012 -- User experience
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-UX-012 contributes to the overall simulation capability by addressing: User experience.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-ux-012-spec.md` |
| ADR | `fr-ux-012-adr.md` |
| Research | `fr-ux-012-research.md` |
| Plan | `fr-ux-012-plan.md` |
