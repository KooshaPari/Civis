# Intent: FR-INST-005 -- Institution
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-INST-005 contributes to the overall simulation capability by addressing: Institution.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-inst-005-spec.md` |
| ADR | `fr-inst-005-adr.md` |
| Research | `fr-inst-005-research.md` |
| Plan | `fr-inst-005-plan.md` |
