# Intent: FR-CIV-MOD-003 -- Mod system (WASM)
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-MOD-003 contributes to the overall simulation capability by addressing: Mod system (WASM).
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-mod-003-spec.md` |
| ADR | `fr-civ-mod-003-adr.md` |
| Research | `fr-civ-mod-003-research.md` |
| Plan | `fr-civ-mod-003-plan.md` |
