# Intent: FR-CIV-UX-005 -- User experience
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-UX-005 contributes to the overall simulation capability by addressing: User experience.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-ux-005-spec.md` |
| ADR | `fr-civ-ux-005-adr.md` |
| Research | `fr-civ-ux-005-research.md` |
| Plan | `fr-civ-ux-005-plan.md` |
