...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-SOCI-005 contributes to the overall simulation capability by addressing: Sociology.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-soci-005-spec.md` |
| ADR | `fr-soci-005-adr.md` |
| Research | `fr-soci-005-research.md` |
| Plan | `fr-soci-005-plan.md` |
