# Intent: FR-CIV-AUDIO-005 -- Audio system
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-AUDIO-005 contributes to the overall simulation capability by addressing: Audio system.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-audio-005-spec.md` |
| ADR | `fr-civ-audio-005-adr.md` |
| Research | `fr-civ-audio-005-research.md` |
| Plan | `fr-civ-audio-005-plan.md` |
