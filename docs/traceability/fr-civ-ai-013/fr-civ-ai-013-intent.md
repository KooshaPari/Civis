# Intent: FR-CIV-AI-013 -- Artificial intelligence
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-AI-013 contributes to the overall simulation capability by addressing: Artificial intelligence.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-ai-013-spec.md` |
| ADR | `fr-civ-ai-013-adr.md` |
| Research | `fr-civ-ai-013-research.md` |
| Plan | `fr-civ-ai-013-plan.md` |
