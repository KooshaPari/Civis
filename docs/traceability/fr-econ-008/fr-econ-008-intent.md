...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-ECON-008 contributes to the overall simulation capability by addressing: Economics.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-econ-008-spec.md` |
| ADR | `fr-econ-008-adr.md` |
| Research | `fr-econ-008-research.md` |
| Plan | `fr-econ-008-plan.md` |
