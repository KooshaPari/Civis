# Intent: FR-CIV-TECH-010 -- Technology tree
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-TECH-010 contributes to the overall simulation capability by addressing: Technology tree.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-tech-010-spec.md` |
| ADR | `fr-civ-tech-010-adr.md` |
| Research | `fr-civ-tech-010-research.md` |
| Plan | `fr-civ-tech-010-plan.md` |
