# Intent: FR-SAVE-021 -- Save system
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-SAVE-021 contributes to the overall simulation capability by addressing: Save system.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-save-021-spec.md` |
| ADR | `fr-save-021-adr.md` |
| Research | `fr-save-021-research.md` |
| Plan | `fr-save-021-plan.md` |
