...
// ADR-020 legacy helpers (FR-PLAY-click-to-fire prerequisite). Phase stubs
// now live in the main `impl Simulation` block above; only non-phase helpers
// remain here for downstream mod-host + emergence metrics callers.
impl Simulation {
