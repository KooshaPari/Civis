# Intent: FR-CIV-LAWS-003 -- Legal system
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-LAWS-003 contributes to the overall simulation capability by addressing: Legal system.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-laws-003-spec.md` |
| ADR | `fr-civ-laws-003-adr.md` |
| Research | `fr-civ-laws-003-research.md` |
| Plan | `fr-civ-laws-003-plan.md` |
