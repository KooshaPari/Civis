# Intent: FR-SESSION-002 -- Session management
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-SESSION-002 contributes to the overall simulation capability by addressing: Session management.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-session-002-spec.md` |
| ADR | `fr-session-002-adr.md` |
| Research | `fr-session-002-research.md` |
| Plan | `fr-session-002-plan.md` |
