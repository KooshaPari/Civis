...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-ECO-010 contributes to the overall simulation capability by addressing: Economy.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-eco-010-spec.md` |
| ADR | `fr-eco-010-adr.md` |
| Research | `fr-eco-010-research.md` |
| Plan | `fr-eco-010-plan.md` |
