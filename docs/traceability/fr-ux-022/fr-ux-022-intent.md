# Intent: FR-UX-022 -- User experience
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-UX-022 contributes to the overall simulation capability by addressing: User experience.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-ux-022-spec.md` |
| ADR | `fr-ux-022-adr.md` |
| Research | `fr-ux-022-research.md` |
| Plan | `fr-ux-022-plan.md` |
