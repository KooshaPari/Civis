# Intent: FR-SOC-INTG-003 -- Social integration
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-SOC-INTG-003 contributes to the overall simulation capability by addressing: Social integration.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-soc-intg-003-spec.md` |
| ADR | `fr-soc-intg-003-adr.md` |
| Research | `fr-soc-intg-003-research.md` |
| Plan | `fr-soc-intg-003-plan.md` |
