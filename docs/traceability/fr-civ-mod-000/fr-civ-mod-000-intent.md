# Intent: FR-CIV-MOD-000 -- Mod system (WASM)
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-MOD-000 contributes to the overall simulation capability by addressing: Mod system (WASM).
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-mod-000-spec.md` |
| ADR | `fr-civ-mod-000-adr.md` |
| Research | `fr-civ-mod-000-research.md` |
| Plan | `fr-civ-mod-000-plan.md` |
