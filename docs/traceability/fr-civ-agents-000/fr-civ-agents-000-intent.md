# Intent: FR-CIV-AGENTS-000 -- Agent systems
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-AGENTS-000 contributes to the overall simulation capability by addressing: Agent systems.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-agents-000-spec.md` |
| ADR | `fr-civ-agents-000-adr.md` |
| Research | `fr-civ-agents-000-research.md` |
| Plan | `fr-civ-agents-000-plan.md` |
