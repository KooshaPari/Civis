# Intent: FR-CIV-DIFFUSION-006 -- Cultural diffusion
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-DIFFUSION-006 contributes to the overall simulation capability by addressing: Cultural diffusion.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-diffusion-006-spec.md` |
| ADR | `fr-civ-diffusion-006-adr.md` |
| Research | `fr-civ-diffusion-006-research.md` |
| Plan | `fr-civ-diffusion-006-plan.md` |
