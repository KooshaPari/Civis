# Intent: FR-SESSION-028 -- Session management
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-SESSION-028 contributes to the overall simulation capability by addressing: Session management.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-session-028-spec.md` |
| ADR | `fr-session-028-adr.md` |
| Research | `fr-session-028-research.md` |
| Plan | `fr-session-028-plan.md` |
