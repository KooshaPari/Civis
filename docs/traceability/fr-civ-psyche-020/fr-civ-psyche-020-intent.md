# Intent: FR-CIV-PSYCHE-020 -- Psychological and social modelling
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-PSYCHE-020 contributes to the overall simulation capability by addressing: Psychological and social modelling.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-psyche-020-spec.md` |
| ADR | `fr-civ-psyche-020-adr.md` |
| Research | `fr-civ-psyche-020-research.md` |
| Plan | `fr-civ-psyche-020-plan.md` |
