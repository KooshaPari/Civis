...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CLIM-004 contributes to the overall simulation capability by addressing: Climate.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-clim-004-spec.md` |
| ADR | `fr-clim-004-adr.md` |
| Research | `fr-clim-004-research.md` |
| Plan | `fr-clim-004-plan.md` |
