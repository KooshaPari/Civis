# Research: FR-CIV-TACTICS-025 -- Tactics and strategy
...
- `crates/engine/src/replay.rs:29`
- `docs/development-guide/p-w1-kickoff.md:28`

### Test References
- `crates/engine/src/engine.rs:3031`
- `crates/engine/src/engine.rs:3054`
- `crates/engine/src/engine.rs:3090`
- `crates/engine/src/engine.rs:3134`
- `crates/engine/src/engine.rs:3248`
