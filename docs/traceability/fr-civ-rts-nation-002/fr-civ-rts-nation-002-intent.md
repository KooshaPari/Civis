# Intent: FR-CIV-RTS-NATION-002 -- RTS nation system

> Date: 2026-09-17
> FR: FR-CIV-RTS-NATION-002
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-RTS-NATION-002 contributes to the overall simulation capability by addressing: RTS nation system.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-rts-nation-002-spec.md` |
| ADR | `fr-civ-rts-nation-002-adr.md` |
| Research | `fr-civ-rts-nation-002-research.md` |
| Plan | `fr-civ-rts-nation-002-plan.md` |
