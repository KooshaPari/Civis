# Intent: FR-CIV-PERF-RT-003 -- Civ Perf Rt
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-PERF-RT-003 contributes to the overall simulation capability by addressing: Civ Perf Rt.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-perf-rt-003-spec.md` |
| ADR | `fr-civ-perf-rt-003-adr.md` |
| Research | `fr-civ-perf-rt-003-research.md` |
| Plan | `fr-civ-perf-rt-003-plan.md` |
