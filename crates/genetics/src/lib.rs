//! civ-genetics — Algorithmic DNA, mutation/recombination, fitness, speciation thresholds
//!
...
//!
//! Functional requirements: FR-CIV-GENETICS-*
...
mod stub_tests {
    ...
    /// FR-CIV-GENETICS-000 — crate compiles and exposes a schema version.
