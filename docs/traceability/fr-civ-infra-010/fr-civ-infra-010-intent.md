# Intent: FR-CIV-INFRA-010 -- Infrastructure systems
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-INFRA-010 contributes to the overall simulation capability by addressing: Infrastructure systems.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-infra-010-spec.md` |
| ADR | `fr-civ-infra-010-adr.md` |
| Research | `fr-civ-infra-010-research.md` |
| Plan | `fr-civ-infra-010-plan.md` |
