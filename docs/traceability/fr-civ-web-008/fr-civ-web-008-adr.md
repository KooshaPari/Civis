# ADR: FR-CIV-WEB-008 -- Web client

> Status: Proposed
> Date: 2026-09-17
> Deciders: CivLab
> Relates to: FR-CIV-WEB-008
> Epic: FR-CIV-WEB

## Context

FR-CIV-WEB-008 is part of the FR-CIV-WEB epic. This functional requirement captures: Web client.
...
TBD -- The architectural decision for FR-CIV-WEB-008 needs to be finalized based on implementation exploration.
