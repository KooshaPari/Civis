...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-ECON-005 contributes to the overall simulation capability by addressing: Economics.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-econ-005-spec.md` |
| ADR | `fr-econ-005-adr.md` |
| Research | `fr-econ-005-research.md` |
| Plan | `fr-econ-005-plan.md` |
