...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-ECON-007 contributes to the overall simulation capability by addressing: Economics.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-econ-007-spec.md` |
| ADR | `fr-econ-007-adr.md` |
| Research | `fr-econ-007-research.md` |
| Plan | `fr-econ-007-plan.md` |
