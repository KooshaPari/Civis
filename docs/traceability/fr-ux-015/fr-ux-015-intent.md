# Intent: FR-UX-015 -- User experience
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-UX-015 contributes to the overall simulation capability by addressing: User experience.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-ux-015-spec.md` |
| ADR | `fr-ux-015-adr.md` |
| Research | `fr-ux-015-research.md` |
| Plan | `fr-ux-015-plan.md` |
