# ADR: FR-CIV-SPECIES-302 -- Species definitions

> Status: Proposed
> Date: 2026-09-17
> Deciders: CivLab
> Relates to: FR-CIV-SPECIES-302
> Epic: FR-CIV-SPECIES

## Context

FR-CIV-SPECIES-302 is part of the FR-CIV-SPECIES epic. This functional requirement captures: Species definitions.
...
TBD -- The architectural decision for FR-CIV-SPECIES-302 needs to be finalized based on implementation exploration.
