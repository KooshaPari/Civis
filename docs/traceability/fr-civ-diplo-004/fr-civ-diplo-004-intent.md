# Intent: FR-CIV-DIPLO-004 -- Diplomacy and treaties
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-DIPLO-004 contributes to the overall simulation capability by addressing: Diplomacy and treaties.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-diplo-004-spec.md` |
| ADR | `fr-civ-diplo-004-adr.md` |
| Research | `fr-civ-diplo-004-research.md` |
| Plan | `fr-civ-diplo-004-plan.md` |
