# Intent: FR-CIV-WAR-020 -- War and conflict
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-WAR-020 contributes to the overall simulation capability by addressing: War and conflict.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-war-020-spec.md` |
| ADR | `fr-civ-war-020-adr.md` |
| Research | `fr-civ-war-020-research.md` |
| Plan | `fr-civ-war-020-plan.md` |
