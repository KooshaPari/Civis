# Intent: FR-LOD-001 -- Level of detail
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-LOD-001 contributes to the overall simulation capability by addressing: Level of detail.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-lod-001-spec.md` |
| ADR | `fr-lod-001-adr.md` |
| Research | `fr-lod-001-research.md` |
| Plan | `fr-lod-001-plan.md` |
