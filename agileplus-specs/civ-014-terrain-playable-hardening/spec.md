...
| E7.2 Chunk-seam fix (`wt/chunk-seam`) | Planned |
| E7.3 CA-dirty-chunk perf (`perf/ca-dirty-chunk`) | Planned |
| E7.4 Map2D zoom + UX (`wt/map2d-zoom`, `wt/map2d-ux-2494`) | Planned |
| E7.5 Water placement single-source-of-truth (`wt/water-placement`) | Planned |
| E7.6 Actor-Y determinism (`wt/actor-y-fix`) | Planned |
| E7.7 Emergence spawn layout (`wt/emergence-spawn`) | Planned |
| E7.8 Map seed determinism (`wt/map-seed`) | Planned |
