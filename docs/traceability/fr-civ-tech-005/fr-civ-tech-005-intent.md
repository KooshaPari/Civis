# Intent: FR-CIV-TECH-005 -- Technology tree
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-TECH-005 contributes to the overall simulation capability by addressing: Technology tree.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-tech-005-spec.md` |
| ADR | `fr-civ-tech-005-adr.md` |
| Research | `fr-civ-tech-005-research.md` |
| Plan | `fr-civ-tech-005-plan.md` |
