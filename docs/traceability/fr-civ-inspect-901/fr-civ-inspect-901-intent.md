# Intent: FR-CIV-INSPECT-901 -- Inspection tools
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-INSPECT-901 contributes to the overall simulation capability by addressing: Inspection tools.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-inspect-901-spec.md` |
| ADR | `fr-civ-inspect-901-adr.md` |
| Research | `fr-civ-inspect-901-research.md` |
| Plan | `fr-civ-inspect-901-plan.md` |
