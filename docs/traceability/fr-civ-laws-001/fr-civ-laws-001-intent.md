# Intent: FR-CIV-LAWS-001 -- Legal system
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-LAWS-001 contributes to the overall simulation capability by addressing: Legal system.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-laws-001-spec.md` |
| ADR | `fr-civ-laws-001-adr.md` |
| Research | `fr-civ-laws-001-research.md` |
| Plan | `fr-civ-laws-001-plan.md` |
