//! civ-protocol-3d — WebSocket binary protocol extensions for voxel deltas, building diffs, agent appearance
//!
...
//!
//! Functional requirements: FR-CIV-PROTO3D-*
...
mod stub_tests {
    ...
    /// FR-CIV-PROTO3D-000 — crate compiles and exposes a schema version.
