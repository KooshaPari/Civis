# Intent: FR-SOC-INTG-005 -- Social integration
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-SOC-INTG-005 contributes to the overall simulation capability by addressing: Social integration.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-soc-intg-005-spec.md` |
| ADR | `fr-soc-intg-005-adr.md` |
| Research | `fr-soc-intg-005-research.md` |
| Plan | `fr-soc-intg-005-plan.md` |
