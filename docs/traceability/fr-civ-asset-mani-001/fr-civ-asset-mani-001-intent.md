# Intent: FR-CIV-ASSET-MANI-001 -- Civ Asset Mani

> Date: 2026-09-17
> FR: FR-CIV-ASSET-MANI-001
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-ASSET-MANI-001 contributes to the overall simulation capability by addressing: Civ Asset Mani.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-asset-mani-001-spec.md` |
| ADR | `fr-civ-asset-mani-001-adr.md` |
| Research | `fr-civ-asset-mani-001-research.md` |
| Plan | `fr-civ-asset-mani-001-plan.md` |
