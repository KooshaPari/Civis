# Intent: FR-CIV-PERF-004 -- Performance
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-PERF-004 contributes to the overall simulation capability by addressing: Performance.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-perf-004-spec.md` |
| ADR | `fr-civ-perf-004-adr.md` |
| Research | `fr-civ-perf-004-research.md` |
| Plan | `fr-civ-perf-004-plan.md` |
