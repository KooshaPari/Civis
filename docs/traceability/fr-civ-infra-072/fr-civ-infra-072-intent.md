# Intent: FR-CIV-INFRA-072 -- Infrastructure systems
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-INFRA-072 contributes to the overall simulation capability by addressing: Infrastructure systems.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-infra-072-spec.md` |
| ADR | `fr-civ-infra-072-adr.md` |
| Research | `fr-civ-infra-072-research.md` |
| Plan | `fr-civ-infra-072-plan.md` |
