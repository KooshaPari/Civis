...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-ECON-009 contributes to the overall simulation capability by addressing: Economics.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-econ-009-spec.md` |
| ADR | `fr-econ-009-adr.md` |
| Research | `fr-econ-009-research.md` |
| Plan | `fr-econ-009-plan.md` |
