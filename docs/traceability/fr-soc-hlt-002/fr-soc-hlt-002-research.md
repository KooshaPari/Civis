# Research: FR-SOC-HLT-002 -- Social health
...
What is the best approach to implement Social health within the Civis simulation engine?

## Background

This FR belongs to the FR-SOC-HLT epic and is expected to be implemented in `crates/civ-institutions/src/`.
