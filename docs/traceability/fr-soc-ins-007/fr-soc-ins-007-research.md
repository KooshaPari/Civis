# Research: FR-SOC-INS-007 -- Social institution
...
What is the best approach to implement Social institution within the Civis simulation engine?

## Background

This FR belongs to the FR-SOC-INS epic and is expected to be implemented in `crates/civ-institutions/src/`.
