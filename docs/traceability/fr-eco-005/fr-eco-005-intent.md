...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-ECO-005 contributes to the overall simulation capability by addressing: Economy.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-eco-005-spec.md` |
| ADR | `fr-eco-005-adr.md` |
| Research | `fr-eco-005-research.md` |
| Plan | `fr-eco-005-plan.md` |
