...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-SOCI-003 contributes to the overall simulation capability by addressing: Sociology.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-soci-003-spec.md` |
| ADR | `fr-soci-003-adr.md` |
| Research | `fr-soci-003-research.md` |
| Plan | `fr-soci-003-plan.md` |
