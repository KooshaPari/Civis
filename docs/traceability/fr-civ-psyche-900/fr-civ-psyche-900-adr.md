# ADR: FR-CIV-PSYCHE-900 -- Psychological and social modelling

> Status: Proposed
> Date: 2026-09-17
> Deciders: CivLab
> Relates to: FR-CIV-PSYCHE-900
> Epic: FR-CIV-PSYCHE

## Context

FR-CIV-PSYCHE-900 is part of the FR-CIV-PSYCHE epic. This functional requirement captures: Psychological and social modelling.
...
TBD -- The architectural decision for FR-CIV-PSYCHE-900 needs to be finalized based on implementation exploration.
