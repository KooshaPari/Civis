# Intent: FR-CIV-SERVER-002-PROTO -- Server infrastructure

> Date: 2026-09-17
> FR: FR-CIV-SERVER-002-PROTO
> Epic: FR-CIV-SERVER
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-SERVER-002-PROTO contributes to the overall simulation capability by addressing: Server infrastructure.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-server-002-proto-spec.md` |
| ADR | `fr-civ-server-002-proto-adr.md` |
| Research | `fr-civ-server-002-proto-research.md` |
| Plan | `fr-civ-server-002-proto-plan.md` |
