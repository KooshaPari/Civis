# Intent: FR-CIV-ROAD-901 -- Road and path systems
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-ROAD-901 contributes to the overall simulation capability by addressing: Road and path systems.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-road-901-spec.md` |
| ADR | `fr-civ-road-901-adr.md` |
| Research | `fr-civ-road-901-research.md` |
| Plan | `fr-civ-road-901-plan.md` |
