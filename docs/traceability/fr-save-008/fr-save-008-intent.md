# Intent: FR-SAVE-008 -- Save system
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-SAVE-008 contributes to the overall simulation capability by addressing: Save system.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-save-008-spec.md` |
| ADR | `fr-save-008-adr.md` |
| Research | `fr-save-008-research.md` |
| Plan | `fr-save-008-plan.md` |
