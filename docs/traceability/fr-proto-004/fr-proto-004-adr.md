# ADR: FR-PROTO-004 -- Protocol

> Status: Proposed
> Date: 2026-09-17
> Deciders: CivLab
> Relates to: FR-PROTO-004
> Epic: FR-PROTO

## Context

FR-PROTO-004 is part of the FR-PROTO epic. This functional requirement captures: Protocol.

Implementing crate: `crates/protocol-3d/src/`

### Referenced Source
- `docs/reference/agileplus-artifacts-index.md:185`
- `docs/reference/agileplus-artifacts-index.md:296`
...
TBD -- The architectural decision for FR-PROTO-004 needs to be finalized based on implementation exploration.
