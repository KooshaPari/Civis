# Intent: FR-CIV-AI-003 -- Artificial intelligence
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-AI-003 contributes to the overall simulation capability by addressing: Artificial intelligence.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-ai-003-spec.md` |
| ADR | `fr-civ-ai-003-adr.md` |
| Research | `fr-civ-ai-003-research.md` |
| Plan | `fr-civ-ai-003-plan.md` |
