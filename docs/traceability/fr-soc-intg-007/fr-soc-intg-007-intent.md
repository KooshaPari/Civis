# Intent: FR-SOC-INTG-007 -- Social integration
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-SOC-INTG-007 contributes to the overall simulation capability by addressing: Social integration.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-soc-intg-007-spec.md` |
| ADR | `fr-soc-intg-007-adr.md` |
| Research | `fr-soc-intg-007-research.md` |
| Plan | `fr-soc-intg-007-plan.md` |
