# Intent: FR-CIV-ASSET-015 -- Asset pipeline
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-ASSET-015 contributes to the overall simulation capability by addressing: Asset pipeline.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-asset-015-spec.md` |
| ADR | `fr-civ-asset-015-adr.md` |
| Research | `fr-civ-asset-015-research.md` |
| Plan | `fr-civ-asset-015-plan.md` |
