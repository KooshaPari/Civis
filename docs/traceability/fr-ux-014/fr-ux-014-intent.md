# Intent: FR-UX-014 -- User experience
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-UX-014 contributes to the overall simulation capability by addressing: User experience.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-ux-014-spec.md` |
| ADR | `fr-ux-014-adr.md` |
| Research | `fr-ux-014-research.md` |
| Plan | `fr-ux-014-plan.md` |
