# Intent: FR-SOC-COH-001 -- Social cohesion
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-SOC-COH-001 contributes to the overall simulation capability by addressing: Social cohesion.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-soc-coh-001-spec.md` |
| ADR | `fr-soc-coh-001-adr.md` |
| Research | `fr-soc-coh-001-research.md` |
| Plan | `fr-soc-coh-001-plan.md` |
