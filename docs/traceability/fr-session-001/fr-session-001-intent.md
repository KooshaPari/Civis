# Intent: FR-SESSION-001 -- Session management
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-SESSION-001 contributes to the overall simulation capability by addressing: Session management.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-session-001-spec.md` |
| ADR | `fr-session-001-adr.md` |
| Research | `fr-session-001-research.md` |
| Plan | `fr-session-001-plan.md` |
