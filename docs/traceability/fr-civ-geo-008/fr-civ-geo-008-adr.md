# ADR: FR-CIV-GEO-008 -- Geological systems

> Status: Proposed
> Date: 2026-09-17
> Deciders: CivLab
> Relates to: FR-CIV-GEO-008
> Epic: FR-CIV-GEO

## Context

FR-CIV-GEO-008 is part of the FR-CIV-GEO epic. This functional requirement captures: Geological systems.
...
TBD -- The architectural decision for FR-CIV-GEO-008 needs to be finalized based on implementation exploration.
