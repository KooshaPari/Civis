# Intent: FR-CIV-POLITY-005 -- Polity system
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-POLITY-005 contributes to the overall simulation capability by addressing: Polity system.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-polity-005-spec.md` |
| ADR | `fr-civ-polity-005-adr.md` |
| Research | `fr-civ-polity-005-research.md` |
| Plan | `fr-civ-polity-005-plan.md` |
