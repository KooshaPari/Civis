# Intent: FR-CIV-SCALE-008 -- Scale and performance
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-SCALE-008 contributes to the overall simulation capability by addressing: Scale and performance.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-scale-008-spec.md` |
| ADR | `fr-civ-scale-008-adr.md` |
| Research | `fr-civ-scale-008-research.md` |
| Plan | `fr-civ-scale-008-plan.md` |
