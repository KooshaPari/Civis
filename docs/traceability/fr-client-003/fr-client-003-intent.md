# Intent: FR-CLIENT-003 -- Client system
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CLIENT-003 contributes to the overall simulation capability by addressing: Client system.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-client-003-spec.md` |
| ADR | `fr-client-003-adr.md` |
| Research | `fr-client-003-research.md` |
| Plan | `fr-client-003-plan.md` |
