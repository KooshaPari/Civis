# Intent: FR-CIV-GEO-001 -- Geological systems
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-GEO-001 contributes to the overall simulation capability by addressing: Geological systems.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-geo-001-spec.md` |
| ADR | `fr-civ-geo-001-adr.md` |
| Research | `fr-civ-geo-001-research.md` |
| Plan | `fr-civ-geo-001-plan.md` |
