# Intent: FR-NFR-R-02 -- Reliability placeholder (deprecated)
...
`assert!(ws.tick == 0)` stub (`crates/engine/tests/fr_nfr_r_02.rs`)
...
| Artifact | Path |
|----------|------|
| Stub (removed) | `crates/engine/tests/fr_nfr_r_02.rs` |
