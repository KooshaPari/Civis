# Intent: FR-SAVE-014 -- Save system
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-SAVE-014 contributes to the overall simulation capability by addressing: Save system.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-save-014-spec.md` |
| ADR | `fr-save-014-adr.md` |
| Research | `fr-save-014-research.md` |
| Plan | `fr-save-014-plan.md` |
