# Intent: FR-CORE-008 -- Core system
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CORE-008 contributes to the overall simulation capability by addressing: Core system.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-core-008-spec.md` |
| ADR | `fr-core-008-adr.md` |
| Research | `fr-core-008-research.md` |
| Plan | `fr-core-008-plan.md` |
