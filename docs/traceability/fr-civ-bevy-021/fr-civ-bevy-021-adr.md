# ADR: FR-CIV-BEVY-021 -- Bevy rendering client

> Status: Proposed
> Date: 2026-09-17
> Deciders: CivLab
> Relates to: FR-CIV-BEVY-021
> Epic: FR-CIV-BEVY

## Context

FR-CIV-BEVY-021 is part of the FR-CIV-BEVY epic. This functional requirement captures: Bevy rendering client.
...
TBD -- The architectural decision for FR-CIV-BEVY-021 needs to be finalized based on implementation exploration.
