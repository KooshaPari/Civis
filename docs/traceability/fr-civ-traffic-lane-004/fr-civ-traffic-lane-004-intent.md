# Intent: FR-CIV-TRAFFIC-LANE-004 -- Traffic lanes

> Date: 2026-09-17
> FR: FR-CIV-TRAFFIC-LANE-004
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-TRAFFIC-LANE-004 contributes to the overall simulation capability by addressing: Traffic lanes.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-traffic-lane-004-spec.md` |
| ADR | `fr-civ-traffic-lane-004-adr.md` |
| Research | `fr-civ-traffic-lane-004-research.md` |
| Plan | `fr-civ-traffic-lane-004-plan.md` |
