# Intent: FR-CIV-WAR-001-UNITS -- War and conflict
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-WAR-001-UNITS contributes to the overall simulation capability by addressing: War and conflict.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-war-001-units-spec.md` |
| ADR | `fr-civ-war-001-units-adr.md` |
| Research | `fr-civ-war-001-units-research.md` |
| Plan | `fr-civ-war-001-units-plan.md` |
