...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-ECO-001 contributes to the overall simulation capability by addressing: Economy.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-eco-001-spec.md` |
| ADR | `fr-eco-001-adr.md` |
| Research | `fr-eco-001-research.md` |
| Plan | `fr-eco-001-plan.md` |
