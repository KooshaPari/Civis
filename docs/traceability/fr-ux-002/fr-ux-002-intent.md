# Intent: FR-UX-002 -- User experience
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-UX-002 contributes to the overall simulation capability by addressing: User experience.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-ux-002-spec.md` |
| ADR | `fr-ux-002-adr.md` |
| Research | `fr-ux-002-research.md` |
| Plan | `fr-ux-002-plan.md` |
