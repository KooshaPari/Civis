# Intent: FR-SESSION-015 -- Session management
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-SESSION-015 contributes to the overall simulation capability by addressing: Session management.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-session-015-spec.md` |
| ADR | `fr-session-015-adr.md` |
| Research | `fr-session-015-research.md` |
| Plan | `fr-session-015-plan.md` |
