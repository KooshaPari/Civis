# Intent: FR-CIV-GENETICS-001 -- Procedural genetics
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-GENETICS-001 contributes to the overall simulation capability by addressing: Procedural genetics.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-genetics-001-spec.md` |
| ADR | `fr-civ-genetics-001-adr.md` |
| Research | `fr-civ-genetics-001-research.md` |
| Plan | `fr-civ-genetics-001-plan.md` |
