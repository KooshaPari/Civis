# Intent: FR-CIV-SPECIES-105 -- Species definitions
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-SPECIES-105 contributes to the overall simulation capability by addressing: Species definitions.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-species-105-spec.md` |
| ADR | `fr-civ-species-105-adr.md` |
| Research | `fr-civ-species-105-research.md` |
| Plan | `fr-civ-species-105-plan.md` |
