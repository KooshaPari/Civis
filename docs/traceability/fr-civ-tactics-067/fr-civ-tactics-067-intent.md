# Intent: FR-CIV-TACTICS-067 -- Tactics and strategy
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-TACTICS-067 contributes to the overall simulation capability by addressing: Tactics and strategy.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-tactics-067-spec.md` |
| ADR | `fr-civ-tactics-067-adr.md` |
| Research | `fr-civ-tactics-067-research.md` |
| Plan | `fr-civ-tactics-067-plan.md` |
