# Intent: FR-INST-006 -- Institution
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-INST-006 contributes to the overall simulation capability by addressing: Institution.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-inst-006-spec.md` |
| ADR | `fr-inst-006-adr.md` |
| Research | `fr-inst-006-research.md` |
| Plan | `fr-inst-006-plan.md` |
