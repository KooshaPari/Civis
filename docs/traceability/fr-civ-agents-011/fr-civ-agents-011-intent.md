# Intent: FR-CIV-AGENTS-011 -- Agent systems

> Date: 2026-09-17
> FR: FR-CIV-AGENTS-011
> Epic: FR-CIV-AGENTS
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-AGENTS-011 contributes to the overall simulation capability by addressing: Agent systems.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-agents-011-spec.md` |
| ADR | `fr-civ-agents-011-adr.md` |
| Research | `fr-civ-agents-011-research.md` |
| Plan | `fr-civ-agents-011-plan.md` |
