# Intent: FR-CIV-WEB-005 -- Web client
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-WEB-005 contributes to the overall simulation capability by addressing: Web client.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-web-005-spec.md` |
| ADR | `fr-civ-web-005-adr.md` |
| Research | `fr-civ-web-005-research.md` |
| Plan | `fr-civ-web-005-plan.md` |
