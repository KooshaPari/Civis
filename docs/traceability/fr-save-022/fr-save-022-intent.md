# Intent: FR-SAVE-022 -- Save system
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-SAVE-022 contributes to the overall simulation capability by addressing: Save system.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-save-022-spec.md` |
| ADR | `fr-save-022-adr.md` |
| Research | `fr-save-022-research.md` |
| Plan | `fr-save-022-plan.md` |
