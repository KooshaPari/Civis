# Intent: FR-CIV-INFOVIEW-904 -- Info views and inspectors

> Date: 2026-09-17
> FR: FR-CIV-INFOVIEW-904
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-INFOVIEW-904 contributes to the overall simulation capability by addressing: Info views and inspectors.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-infoview-904-spec.md` |
| ADR | `fr-civ-infoview-904-adr.md` |
| Research | `fr-civ-infoview-904-research.md` |
| Plan | `fr-civ-infoview-904-plan.md` |
