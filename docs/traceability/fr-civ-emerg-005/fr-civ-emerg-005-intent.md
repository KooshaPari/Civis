# Intent: FR-CIV-EMERG-005 -- Emergence mechanics
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-EMERG-005 contributes to the overall simulation capability by addressing: Emergence mechanics.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-emerg-005-spec.md` |
| ADR | `fr-civ-emerg-005-adr.md` |
| Research | `fr-civ-emerg-005-research.md` |
| Plan | `fr-civ-emerg-005-plan.md` |
