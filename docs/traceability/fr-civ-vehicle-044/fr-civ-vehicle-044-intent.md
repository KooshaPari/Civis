# Intent: FR-CIV-VEHICLE-044 -- Vehicle systems

> Date: 2026-09-17
> FR: FR-CIV-VEHICLE-044
> Epic: FR-CIV-VEHICLE
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-VEHICLE-044 contributes to the overall simulation capability by addressing: Vehicle systems.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-vehicle-044-spec.md` |
| ADR | `fr-civ-vehicle-044-adr.md` |
| Research | `fr-civ-vehicle-044-research.md` |
| Plan | `fr-civ-vehicle-044-plan.md` |
