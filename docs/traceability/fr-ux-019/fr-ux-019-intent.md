# Intent: FR-UX-019 -- User experience
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-UX-019 contributes to the overall simulation capability by addressing: User experience.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-ux-019-spec.md` |
| ADR | `fr-ux-019-adr.md` |
| Research | `fr-ux-019-research.md` |
| Plan | `fr-ux-019-plan.md` |
