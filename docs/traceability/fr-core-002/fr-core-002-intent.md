# Intent: FR-CORE-002 -- Core system
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CORE-002 contributes to the overall simulation capability by addressing: Core system.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-core-002-spec.md` |
| ADR | `fr-core-002-adr.md` |
| Research | `fr-core-002-research.md` |
| Plan | `fr-core-002-plan.md` |
