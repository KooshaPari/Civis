# Intent: FR-SAVE-012 -- Save system
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-SAVE-012 contributes to the overall simulation capability by addressing: Save system.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-save-012-spec.md` |
| ADR | `fr-save-012-adr.md` |
| Research | `fr-save-012-research.md` |
| Plan | `fr-save-012-plan.md` |
