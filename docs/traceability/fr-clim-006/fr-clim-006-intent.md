...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CLIM-006 contributes to the overall simulation capability by addressing: Climate.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-clim-006-spec.md` |
| ADR | `fr-clim-006-adr.md` |
| Research | `fr-clim-006-research.md` |
| Plan | `fr-clim-006-plan.md` |
