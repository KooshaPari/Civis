# Intent: FR-CIV-TACTICS-031 -- Tactics and strategy
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-TACTICS-031 contributes to the overall simulation capability by addressing: Tactics and strategy.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-tactics-031-spec.md` |
| ADR | `fr-civ-tactics-031-adr.md` |
| Research | `fr-civ-tactics-031-research.md` |
| Plan | `fr-civ-tactics-031-plan.md` |
