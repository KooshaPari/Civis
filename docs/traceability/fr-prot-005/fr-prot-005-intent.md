...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-PROT-005 contributes to the overall simulation capability by addressing: Protocol.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-prot-005-spec.md` |
| ADR | `fr-prot-005-adr.md` |
| Research | `fr-prot-005-research.md` |
| Plan | `fr-prot-005-plan.md` |
