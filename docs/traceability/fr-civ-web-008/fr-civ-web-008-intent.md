# Intent: FR-CIV-WEB-008 -- Web client
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-WEB-008 contributes to the overall simulation capability by addressing: Web client.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-web-008-spec.md` |
| ADR | `fr-civ-web-008-adr.md` |
| Research | `fr-civ-web-008-research.md` |
| Plan | `fr-civ-web-008-plan.md` |
