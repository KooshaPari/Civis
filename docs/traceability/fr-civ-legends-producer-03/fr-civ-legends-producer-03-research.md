# Research: FR-CIV-LEGENDS-PRODUCER-03 -- Civ Legends Producer
...
What is the best approach to implement Civ Legends Producer within the Civis simulation engine?

## Background

This FR belongs to the FR-CIV-LEGENDS-PRODUCER epic and is expected to be implemented in `crates/legends/src/`.
