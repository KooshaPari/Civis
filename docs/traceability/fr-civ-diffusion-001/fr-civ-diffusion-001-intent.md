# Intent: FR-CIV-DIFFUSION-001 -- Cultural diffusion
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-DIFFUSION-001 contributes to the overall simulation capability by addressing: Cultural diffusion.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-diffusion-001-spec.md` |
| ADR | `fr-civ-diffusion-001-adr.md` |
| Research | `fr-civ-diffusion-001-research.md` |
| Plan | `fr-civ-diffusion-001-plan.md` |
