# Intent: FR-CIV-RTS-014 -- RTS gameplay
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-RTS-014 contributes to the overall simulation capability by addressing: RTS gameplay.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-rts-014-spec.md` |
| ADR | `fr-civ-rts-014-adr.md` |
| Research | `fr-civ-rts-014-research.md` |
| Plan | `fr-civ-rts-014-plan.md` |
