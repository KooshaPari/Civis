# Intent: FR-CIV-SAVE-001 -- Save/load persistence
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-SAVE-001 contributes to the overall simulation capability by addressing: Save/load persistence.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-save-001-spec.md` |
| ADR | `fr-civ-save-001-adr.md` |
| Research | `fr-civ-save-001-research.md` |
| Plan | `fr-civ-save-001-plan.md` |
