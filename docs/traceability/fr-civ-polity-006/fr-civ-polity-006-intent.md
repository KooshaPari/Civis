# Intent: FR-CIV-POLITY-006 -- Polity system

> Date: 2026-09-17
> FR: FR-CIV-POLITY-006
> Epic: FR-CIV-POLITY
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-POLITY-006 contributes to the overall simulation capability by addressing: Polity system.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-polity-006-spec.md` |
| ADR | `fr-civ-polity-006-adr.md` |
| Research | `fr-civ-polity-006-research.md` |
| Plan | `fr-civ-polity-006-plan.md` |
