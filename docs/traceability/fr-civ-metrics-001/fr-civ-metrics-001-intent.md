# Intent: FR-CIV-METRICS-001 -- Metrics and monitoring

> Date: 2026-09-17
> FR: FR-CIV-METRICS-001
> Epic: FR-CIV-METRICS
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-METRICS-001 contributes to the overall simulation capability by addressing: Metrics and monitoring.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-metrics-001-spec.md` |
| ADR | `fr-civ-metrics-001-adr.md` |
| Research | `fr-civ-metrics-001-research.md` |
| Plan | `fr-civ-metrics-001-plan.md` |
