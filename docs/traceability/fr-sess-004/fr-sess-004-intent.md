...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-SESS-004 contributes to the overall simulation capability by addressing: Session.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-sess-004-spec.md` |
| ADR | `fr-sess-004-adr.md` |
| Research | `fr-sess-004-research.md` |
| Plan | `fr-sess-004-plan.md` |
