# Intent: FR-UX-010 -- User experience
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-UX-010 contributes to the overall simulation capability by addressing: User experience.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-ux-010-spec.md` |
| ADR | `fr-ux-010-adr.md` |
| Research | `fr-ux-010-research.md` |
| Plan | `fr-ux-010-plan.md` |
