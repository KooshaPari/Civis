...
What is the best approach to implement Asset within the Civis simulation engine?

## Background

This FR belongs to the FR-ASSET epic and is expected to be implemented in `crates/asset-pipeline/src/`.
