# Intent: FR-CIV-TERRAIN-003 -- Civ Terrain

> Date: 2026-09-17
> FR: FR-CIV-TERRAIN-003
> Epic: FR-CIV-TERRAIN
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-TERRAIN-003 contributes to the overall simulation capability by addressing: Civ Terrain.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-terrain-003-spec.md` |
| ADR | `fr-civ-terrain-003-adr.md` |
| Research | `fr-civ-terrain-003-research.md` |
| Plan | `fr-civ-terrain-003-plan.md` |
