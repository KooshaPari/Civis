# Intent: FR-CIV-AUDIO-009 -- Audio system
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-AUDIO-009 contributes to the overall simulation capability by addressing: Audio system.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-audio-009-spec.md` |
| ADR | `fr-civ-audio-009-adr.md` |
| Research | `fr-civ-audio-009-research.md` |
| Plan | `fr-civ-audio-009-plan.md` |
