# Intent: FR-CIV-CORE-001 -- Core simulation engine
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-CORE-001 contributes to the overall simulation capability by addressing: Core simulation engine.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-core-001-spec.md` |
| ADR | `fr-civ-core-001-adr.md` |
| Research | `fr-civ-core-001-research.md` |
| Plan | `fr-civ-core-001-plan.md` |
