# Intent: FR-SAVE-006 -- Save system
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-SAVE-006 contributes to the overall simulation capability by addressing: Save system.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-save-006-spec.md` |
| ADR | `fr-save-006-adr.md` |
| Research | `fr-save-006-research.md` |
| Plan | `fr-save-006-plan.md` |
