# Intent: FR-CIV-ASSET-008 -- Asset pipeline
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-ASSET-008 contributes to the overall simulation capability by addressing: Asset pipeline.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-asset-008-spec.md` |
| ADR | `fr-civ-asset-008-adr.md` |
| Research | `fr-civ-asset-008-research.md` |
| Plan | `fr-civ-asset-008-plan.md` |
