# Intent: FR-SESSION-008 -- Session management
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-SESSION-008 contributes to the overall simulation capability by addressing: Session management.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-session-008-spec.md` |
| ADR | `fr-session-008-adr.md` |
| Research | `fr-session-008-research.md` |
| Plan | `fr-session-008-plan.md` |
