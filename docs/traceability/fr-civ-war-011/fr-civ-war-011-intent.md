# Intent: FR-CIV-WAR-011 -- War and conflict
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-WAR-011 contributes to the overall simulation capability by addressing: War and conflict.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-war-011-spec.md` |
| ADR | `fr-civ-war-011-adr.md` |
| Research | `fr-civ-war-011-research.md` |
| Plan | `fr-civ-war-011-plan.md` |
