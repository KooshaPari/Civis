# Intent: FR-SESSION-005 -- Session management
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-SESSION-005 contributes to the overall simulation capability by addressing: Session management.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-session-005-spec.md` |
| ADR | `fr-session-005-adr.md` |
| Research | `fr-session-005-research.md` |
| Plan | `fr-session-005-plan.md` |
