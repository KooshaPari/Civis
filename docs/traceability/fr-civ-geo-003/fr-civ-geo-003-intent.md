# Intent: FR-CIV-GEO-003 -- Geological systems
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-GEO-003 contributes to the overall simulation capability by addressing: Geological systems.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-geo-003-spec.md` |
| ADR | `fr-civ-geo-003-adr.md` |
| Research | `fr-civ-geo-003-research.md` |
| Plan | `fr-civ-geo-003-plan.md` |
