# Intent: FR-CIV-TECH-012 -- Technology tree
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-TECH-012 contributes to the overall simulation capability by addressing: Technology tree.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-tech-012-spec.md` |
| ADR | `fr-civ-tech-012-adr.md` |
| Research | `fr-civ-tech-012-research.md` |
| Plan | `fr-civ-tech-012-plan.md` |
