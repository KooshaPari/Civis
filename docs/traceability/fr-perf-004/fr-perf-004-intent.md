# Intent: FR-PERF-004 -- Performance
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-PERF-004 contributes to the overall simulation capability by addressing: Performance.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-perf-004-spec.md` |
| ADR | `fr-perf-004-adr.md` |
| Research | `fr-perf-004-research.md` |
| Plan | `fr-perf-004-plan.md` |
