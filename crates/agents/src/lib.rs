...
/// Affinity threshold above which a tie is considered a "friend" for faction
/// formation/joining purposes.
pub const FRIEND_AFFINITY_THRESHOLD: f32 = 0.35;

/// Kinship threshold above which a tie is considered a "kin" for faction
/// formation/joining purposes.
pub const KIN_THRESHOLD: f32 = 0.5;

/// Returns true if the tie is positive (friend or kin) for faction cohesion.
