# Intent: FR-CIV-GODOT-ATTACH-001 -- Civ Godot Attach
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-GODOT-ATTACH-001 contributes to the overall simulation capability by addressing: Civ Godot Attach.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-godot-attach-001-spec.md` |
| ADR | `fr-civ-godot-attach-001-adr.md` |
| Research | `fr-civ-godot-attach-001-research.md` |
| Plan | `fr-civ-godot-attach-001-plan.md` |
