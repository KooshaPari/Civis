# Intent: FR-CIV-RTS-001 -- RTS gameplay
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-RTS-001 contributes to the overall simulation capability by addressing: RTS gameplay.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-rts-001-spec.md` |
| ADR | `fr-civ-rts-001-adr.md` |
| Research | `fr-civ-rts-001-research.md` |
| Plan | `fr-civ-rts-001-plan.md` |
