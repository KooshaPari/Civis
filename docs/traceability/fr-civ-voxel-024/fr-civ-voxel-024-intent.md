# Intent: FR-CIV-VOXEL-024 -- Voxel rendering
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-VOXEL-024 contributes to the overall simulation capability by addressing: Voxel rendering.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-voxel-024-spec.md` |
| ADR | `fr-civ-voxel-024-adr.md` |
| Research | `fr-civ-voxel-024-research.md` |
| Plan | `fr-civ-voxel-024-plan.md` |
