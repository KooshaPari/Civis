# Intent: FR-SOC-INS-001 -- Social institution
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-SOC-INS-001 contributes to the overall simulation capability by addressing: Social institution.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-soc-ins-001-spec.md` |
| ADR | `fr-soc-ins-001-adr.md` |
| Research | `fr-soc-ins-001-research.md` |
| Plan | `fr-soc-ins-001-plan.md` |
