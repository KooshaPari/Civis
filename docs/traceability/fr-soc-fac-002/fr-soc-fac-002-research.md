# Research: FR-SOC-FAC-002 -- Social faction
...
What is the best approach to implement Social faction within the Civis simulation engine?

## Background

This FR belongs to the FR-SOC-FAC epic and is expected to be implemented in `crates/civ-institutions/src/`.
