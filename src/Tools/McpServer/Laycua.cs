...
/// <summary>
/// Thin C# client for the laycua-native binary via stdio JSON-RPC 2.0.
...
public sealed class NativeComputer : IAsyncDisposable
{
    ...
    /// </summary>
    /// <param name="nativePath">Path or name of the laycua-native executable.</param>
    ...
    public static async Task<NativeComputer> StartAsync(
        string nativePath = "laycua-native",
