...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CLIM-003 contributes to the overall simulation capability by addressing: Climate.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-clim-003-spec.md` |
| ADR | `fr-clim-003-adr.md` |
| Research | `fr-clim-003-research.md` |
| Plan | `fr-clim-003-plan.md` |
