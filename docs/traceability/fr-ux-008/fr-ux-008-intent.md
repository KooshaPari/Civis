# Intent: FR-UX-008 -- User experience
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-UX-008 contributes to the overall simulation capability by addressing: User experience.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-ux-008-spec.md` |
| ADR | `fr-ux-008-adr.md` |
| Research | `fr-ux-008-research.md` |
| Plan | `fr-ux-008-plan.md` |
