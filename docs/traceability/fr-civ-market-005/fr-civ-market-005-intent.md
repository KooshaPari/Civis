# Intent: FR-CIV-MARKET-005 -- Market dynamics

> Date: 2026-09-17
> FR: FR-CIV-MARKET-005
> Epic: FR-CIV-MARKET
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-MARKET-005 contributes to the overall simulation capability by addressing: Market dynamics.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-market-005-spec.md` |
| ADR | `fr-civ-market-005-adr.md` |
| Research | `fr-civ-market-005-research.md` |
| Plan | `fr-civ-market-005-plan.md` |
