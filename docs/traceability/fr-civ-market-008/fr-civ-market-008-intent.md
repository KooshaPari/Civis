# Intent: FR-CIV-MARKET-008 -- Market dynamics
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-MARKET-008 contributes to the overall simulation capability by addressing: Market dynamics.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-market-008-spec.md` |
| ADR | `fr-civ-market-008-adr.md` |
| Research | `fr-civ-market-008-research.md` |
| Plan | `fr-civ-market-008-plan.md` |
