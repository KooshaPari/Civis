# Intent: FR-CIV-AGENTS-034 -- Agent systems
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-AGENTS-034 contributes to the overall simulation capability by addressing: Agent systems.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-agents-034-spec.md` |
| ADR | `fr-civ-agents-034-adr.md` |
| Research | `fr-civ-agents-034-research.md` |
| Plan | `fr-civ-agents-034-plan.md` |
