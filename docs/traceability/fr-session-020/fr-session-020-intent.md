# Intent: FR-SESSION-020 -- Session management
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-SESSION-020 contributes to the overall simulation capability by addressing: Session management.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-session-020-spec.md` |
| ADR | `fr-session-020-adr.md` |
| Research | `fr-session-020-research.md` |
| Plan | `fr-session-020-plan.md` |
