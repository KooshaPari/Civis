...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-ASSET-003 contributes to the overall simulation capability by addressing: Asset.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-asset-003-spec.md` |
| ADR | `fr-asset-003-adr.md` |
| Research | `fr-asset-003-research.md` |
| Plan | `fr-asset-003-plan.md` |
