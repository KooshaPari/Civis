# Intent: FR-CIV-PERF-009 -- Performance
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-PERF-009 contributes to the overall simulation capability by addressing: Performance.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-perf-009-spec.md` |
| ADR | `fr-civ-perf-009-adr.md` |
| Research | `fr-civ-perf-009-research.md` |
| Plan | `fr-civ-perf-009-plan.md` |
