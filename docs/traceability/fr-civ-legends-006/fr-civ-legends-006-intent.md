# Intent: FR-CIV-LEGENDS-006 -- Legend and narrative system
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-LEGENDS-006 contributes to the overall simulation capability by addressing: Legend and narrative system.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-legends-006-spec.md` |
| ADR | `fr-civ-legends-006-adr.md` |
| Research | `fr-civ-legends-006-research.md` |
| Plan | `fr-civ-legends-006-plan.md` |
