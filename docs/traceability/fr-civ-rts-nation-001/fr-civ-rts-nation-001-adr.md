# ADR: FR-CIV-RTS-NATION-001 -- RTS nation system

> Status: Proposed
> Date: 2026-09-17
> Deciders: CivLab
> Relates to: FR-CIV-RTS-NATION-001
> Epic: FR-CIV-RTS-NATION

## Context

FR-CIV-RTS-NATION-001 is part of the FR-CIV-RTS-NATION epic. This functional requirement captures: RTS nation system.
...
TBD -- The architectural decision for FR-CIV-RTS-NATION-001 needs to be finalized based on implementation exploration.
