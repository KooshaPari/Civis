# Intent: FR-CIV-TRAFFIC-LANE-002 -- Traffic lanes
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-TRAFFIC-LANE-002 contributes to the overall simulation capability by addressing: Traffic lanes.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-traffic-lane-002-spec.md` |
| ADR | `fr-civ-traffic-lane-002-adr.md` |
| Research | `fr-civ-traffic-lane-002-research.md` |
| Plan | `fr-civ-traffic-lane-002-plan.md` |
