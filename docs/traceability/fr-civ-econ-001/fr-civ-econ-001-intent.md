# Intent: FR-CIV-ECON-001 -- Economy and joule allocation
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-ECON-001 contributes to the overall simulation capability by addressing: Economy and joule allocation.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-econ-001-spec.md` |
| ADR | `fr-civ-econ-001-adr.md` |
| Research | `fr-civ-econ-001-research.md` |
| Plan | `fr-civ-econ-001-plan.md` |
