# Research: FR-CIV-LEGENDS-GAP-12 -- Civ Legends Gap
...
What is the best approach to implement Civ Legends Gap within the Civis simulation engine?

## Background

This FR belongs to the FR-CIV-LEGENDS-GAP epic and is expected to be implemented in `crates/legends/src/`.
