# Intent: FR-SESSION-018 -- Session management
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-SESSION-018 contributes to the overall simulation capability by addressing: Session management.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-session-018-spec.md` |
| ADR | `fr-session-018-adr.md` |
| Research | `fr-session-018-research.md` |
| Plan | `fr-session-018-plan.md` |
