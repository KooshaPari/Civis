# ADR: FR-CIV-WEB-001 -- Web client

> Status: Proposed
> Date: 2026-09-17
> Deciders: CivLab
> Relates to: FR-CIV-WEB-001
> Epic: FR-CIV-WEB

## Context

FR-CIV-WEB-001 is part of the FR-CIV-WEB epic. This functional requirement captures: Web client.
...
TBD -- The architectural decision for FR-CIV-WEB-001 needs to be finalized based on implementation exploration.
