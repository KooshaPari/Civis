# Intent: FR-CIV-LIFE-025 -- Life simulation and needs
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-LIFE-025 contributes to the overall simulation capability by addressing: Life simulation and needs.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-life-025-spec.md` |
| ADR | `fr-civ-life-025-adr.md` |
| Research | `fr-civ-life-025-research.md` |
| Plan | `fr-civ-life-025-plan.md` |
