# Intent: FR-CIV-VEHICLE-020 -- Vehicle systems
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-VEHICLE-020 contributes to the overall simulation capability by addressing: Vehicle systems.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-vehicle-020-spec.md` |
| ADR | `fr-civ-vehicle-020-adr.md` |
| Research | `fr-civ-vehicle-020-research.md` |
| Plan | `fr-civ-vehicle-020-plan.md` |
