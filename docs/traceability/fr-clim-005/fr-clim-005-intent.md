...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CLIM-005 contributes to the overall simulation capability by addressing: Climate.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-clim-005-spec.md` |
| ADR | `fr-clim-005-adr.md` |
| Research | `fr-clim-005-research.md` |
| Plan | `fr-clim-005-plan.md` |
