...
- **FR-CIV-PROTO3D-014** — All `Frame3d` variants (`VoxelDelta`, `BuildingDiff`,
  `AgentAppearance`, `CivilianState`, `FactionState`, `EventFeed`, `Climate`)
  round-trip through the F3D0 binary envelope losslessly.
