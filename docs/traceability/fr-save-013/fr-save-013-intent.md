# Intent: FR-SAVE-013 -- Save system
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-SAVE-013 contributes to the overall simulation capability by addressing: Save system.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-save-013-spec.md` |
| ADR | `fr-save-013-adr.md` |
| Research | `fr-save-013-research.md` |
| Plan | `fr-save-013-plan.md` |
