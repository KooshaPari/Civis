# Intent: FR-CIV-WEB-006 -- Web client
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-WEB-006 contributes to the overall simulation capability by addressing: Web client.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-web-006-spec.md` |
| ADR | `fr-civ-web-006-adr.md` |
| Research | `fr-civ-web-006-research.md` |
| Plan | `fr-civ-web-006-plan.md` |
