# Intent: FR-CIV-PERF-006 -- Performance
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-PERF-006 contributes to the overall simulation capability by addressing: Performance.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-perf-006-spec.md` |
| ADR | `fr-civ-perf-006-adr.md` |
| Research | `fr-civ-perf-006-research.md` |
| Plan | `fr-civ-perf-006-plan.md` |
