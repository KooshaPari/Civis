...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-ECO-004 contributes to the overall simulation capability by addressing: Economy.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-eco-004-spec.md` |
| ADR | `fr-eco-004-adr.md` |
| Research | `fr-eco-004-research.md` |
| Plan | `fr-eco-004-plan.md` |
