# Intent: FR-CIV-SCALE-005 -- Scale and performance
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-SCALE-005 contributes to the overall simulation capability by addressing: Scale and performance.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-scale-005-spec.md` |
| ADR | `fr-civ-scale-005-adr.md` |
| Research | `fr-civ-scale-005-research.md` |
| Plan | `fr-civ-scale-005-plan.md` |
