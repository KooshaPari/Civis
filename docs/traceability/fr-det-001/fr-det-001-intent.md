...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-DET-001 contributes to the overall simulation capability by addressing: Determinism.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-det-001-spec.md` |
| ADR | `fr-det-001-adr.md` |
| Research | `fr-det-001-research.md` |
| Plan | `fr-det-001-plan.md` |
