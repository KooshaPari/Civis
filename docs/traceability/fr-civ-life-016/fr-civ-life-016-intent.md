# Intent: FR-CIV-LIFE-016 -- Life simulation and needs
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-LIFE-016 contributes to the overall simulation capability by addressing: Life simulation and needs.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-life-016-spec.md` |
| ADR | `fr-civ-life-016-adr.md` |
| Research | `fr-civ-life-016-research.md` |
| Plan | `fr-civ-life-016-plan.md` |
