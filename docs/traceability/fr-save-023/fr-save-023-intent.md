# Intent: FR-SAVE-023 -- Save system
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-SAVE-023 contributes to the overall simulation capability by addressing: Save system.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-save-023-spec.md` |
| ADR | `fr-save-023-adr.md` |
| Research | `fr-save-023-research.md` |
| Plan | `fr-save-023-plan.md` |
