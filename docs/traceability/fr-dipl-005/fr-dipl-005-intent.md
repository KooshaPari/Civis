...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-DIPL-005 contributes to the overall simulation capability by addressing: Diplomacy.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-dipl-005-spec.md` |
| ADR | `fr-dipl-005-adr.md` |
| Research | `fr-dipl-005-research.md` |
| Plan | `fr-dipl-005-plan.md` |
