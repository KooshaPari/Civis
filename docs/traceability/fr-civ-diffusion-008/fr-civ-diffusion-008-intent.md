# Intent: FR-CIV-DIFFUSION-008 -- Cultural diffusion
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-DIFFUSION-008 contributes to the overall simulation capability by addressing: Cultural diffusion.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-diffusion-008-spec.md` |
| ADR | `fr-civ-diffusion-008-adr.md` |
| Research | `fr-civ-diffusion-008-research.md` |
| Plan | `fr-civ-diffusion-008-plan.md` |
