# Intent: FR-CIV-AUDIO-003 -- Audio system
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-AUDIO-003 contributes to the overall simulation capability by addressing: Audio system.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-audio-003-spec.md` |
| ADR | `fr-civ-audio-003-adr.md` |
| Research | `fr-civ-audio-003-research.md` |
| Plan | `fr-civ-audio-003-plan.md` |
