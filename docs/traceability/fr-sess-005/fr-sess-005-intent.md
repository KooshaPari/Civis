...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-SESS-005 contributes to the overall simulation capability by addressing: Session.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-sess-005-spec.md` |
| ADR | `fr-sess-005-adr.md` |
| Research | `fr-sess-005-research.md` |
| Plan | `fr-sess-005-plan.md` |
