# ADR: FR-CIV-BUILD-012 -- Building tiers and construction

> Status: Proposed
> Date: 2026-09-17
> Deciders: CivLab
> Relates to: FR-CIV-BUILD-012
> Epic: FR-CIV-BUILD

## Context

FR-CIV-BUILD-012 is part of the FR-CIV-BUILD epic. This functional requirement captures: Building tiers and construction.
...
TBD -- The architectural decision for FR-CIV-BUILD-012 needs to be finalized based on implementation exploration.
