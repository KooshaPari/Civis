# Intent: FR-SAVE-015 -- Save system
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-SAVE-015 contributes to the overall simulation capability by addressing: Save system.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-save-015-spec.md` |
| ADR | `fr-save-015-adr.md` |
| Research | `fr-save-015-research.md` |
| Plan | `fr-save-015-plan.md` |
