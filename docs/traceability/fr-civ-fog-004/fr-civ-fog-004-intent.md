# Intent: FR-CIV-FOG-004 -- Fog of war
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-FOG-004 contributes to the overall simulation capability by addressing: Fog of war.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-fog-004-spec.md` |
| ADR | `fr-civ-fog-004-adr.md` |
| Research | `fr-civ-fog-004-research.md` |
| Plan | `fr-civ-fog-004-plan.md` |
