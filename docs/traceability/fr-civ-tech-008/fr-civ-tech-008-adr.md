# ADR: FR-CIV-TECH-008 -- Technology tree

> Status: Proposed
> Date: 2026-09-17
> Deciders: CivLab
> Relates to: FR-CIV-TECH-008
> Epic: FR-CIV-TECH

## Context

FR-CIV-TECH-008 is part of the FR-CIV-TECH epic. This functional requirement captures: Technology tree.
...
TBD -- The architectural decision for FR-CIV-TECH-008 needs to be finalized based on implementation exploration.
