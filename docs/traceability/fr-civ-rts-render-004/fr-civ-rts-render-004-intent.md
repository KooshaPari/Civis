# Intent: FR-CIV-RTS-RENDER-004 -- RTS rendering

> Date: 2026-09-17
> FR: FR-CIV-RTS-RENDER-004
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-RTS-RENDER-004 contributes to the overall simulation capability by addressing: RTS rendering.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-rts-render-004-spec.md` |
| ADR | `fr-civ-rts-render-004-adr.md` |
| Research | `fr-civ-rts-render-004-research.md` |
| Plan | `fr-civ-rts-render-004-plan.md` |
