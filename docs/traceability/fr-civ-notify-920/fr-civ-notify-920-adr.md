# ADR: FR-CIV-NOTIFY-920 -- Notification system

> Status: Proposed
> Date: 2026-09-17
> Deciders: CivLab
> Relates to: FR-CIV-NOTIFY-920
> Epic: FR-CIV-NOTIFY

## Context

FR-CIV-NOTIFY-920 is part of the FR-CIV-NOTIFY epic. This functional requirement captures: Notification system.
...
- `docs/specs/requirements/FR-CIV-NOTIFY.md:15`
...
TBD -- The architectural decision for FR-CIV-NOTIFY-920 needs to be finalized based on implementation exploration.
