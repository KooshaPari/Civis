# Intent: FR-CIV-LEGENDS-007 -- Legend and narrative system

> Date: 2026-09-17
> FR: FR-CIV-LEGENDS-007
> Epic: FR-CIV-LEGENDS
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-LEGENDS-007 contributes to the overall simulation capability by addressing: Legend and narrative system.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-legends-007-spec.md` |
| ADR | `fr-civ-legends-007-adr.md` |
| Research | `fr-civ-legends-007-research.md` |
| Plan | `fr-civ-legends-007-plan.md` |
