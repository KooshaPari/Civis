# Intent: FR-CIV-LIFE-014 -- Life simulation and needs
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-LIFE-014 contributes to the overall simulation capability by addressing: Life simulation and needs.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-life-014-spec.md` |
| ADR | `fr-civ-life-014-adr.md` |
| Research | `fr-civ-life-014-research.md` |
| Plan | `fr-civ-life-014-plan.md` |
