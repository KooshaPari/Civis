# Intent: FR-CIV-ASSET-007 -- Asset pipeline
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-ASSET-007 contributes to the overall simulation capability by addressing: Asset pipeline.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-asset-007-spec.md` |
| ADR | `fr-civ-asset-007-adr.md` |
| Research | `fr-civ-asset-007-research.md` |
| Plan | `fr-civ-asset-007-plan.md` |
