# Intent: FR-CIV-ECON-002-JOULE -- Economy and joule allocation
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-ECON-002-JOULE contributes to the overall simulation capability by addressing: Economy and joule allocation.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-econ-002-joule-spec.md` |
| ADR | `fr-civ-econ-002-joule-adr.md` |
| Research | `fr-civ-econ-002-joule-research.md` |
| Plan | `fr-civ-econ-002-joule-plan.md` |
