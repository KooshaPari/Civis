# Intent: FR-CIV-BUILD-002 -- Building tiers and construction
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-BUILD-002 contributes to the overall simulation capability by addressing: Building tiers and construction.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-build-002-spec.md` |
| ADR | `fr-civ-build-002-adr.md` |
| Research | `fr-civ-build-002-research.md` |
| Plan | `fr-civ-build-002-plan.md` |
