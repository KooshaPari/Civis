# Intent: FR-CIV-POLITY-001 -- Polity system
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-POLITY-001 contributes to the overall simulation capability by addressing: Polity system.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-polity-001-spec.md` |
| ADR | `fr-civ-polity-001-adr.md` |
| Research | `fr-civ-polity-001-research.md` |
| Plan | `fr-civ-polity-001-plan.md` |
