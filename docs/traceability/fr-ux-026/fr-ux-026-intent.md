# Intent: FR-UX-026 -- User experience
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-UX-026 contributes to the overall simulation capability by addressing: User experience.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-ux-026-spec.md` |
| ADR | `fr-ux-026-adr.md` |
| Research | `fr-ux-026-research.md` |
| Plan | `fr-ux-026-plan.md` |
