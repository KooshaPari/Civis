# Intent: FR-CIV-INFRA-060 -- Infrastructure systems
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-INFRA-060 contributes to the overall simulation capability by addressing: Infrastructure systems.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-infra-060-spec.md` |
| ADR | `fr-civ-infra-060-adr.md` |
| Research | `fr-civ-infra-060-research.md` |
| Plan | `fr-civ-infra-060-plan.md` |
