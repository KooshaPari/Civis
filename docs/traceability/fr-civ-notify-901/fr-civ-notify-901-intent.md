# Intent: FR-CIV-NOTIFY-901 -- Notification system

> Date: 2026-09-17
> FR: FR-CIV-NOTIFY-901
> Epic: FR-CIV-NOTIFY
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-NOTIFY-901 contributes to the overall simulation capability by addressing: Notification system.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-notify-901-spec.md` |
| ADR | `fr-civ-notify-901-adr.md` |
| Research | `fr-civ-notify-901-research.md` |
| Plan | `fr-civ-notify-901-plan.md` |
