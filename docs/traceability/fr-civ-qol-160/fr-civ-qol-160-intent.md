...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-QOL-160 contributes to the overall simulation capability by addressing: Civ Qol.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-qol-160-spec.md` |
| ADR | `fr-civ-qol-160-adr.md` |
| Research | `fr-civ-qol-160-research.md` |
| Plan | `fr-civ-qol-160-plan.md` |
