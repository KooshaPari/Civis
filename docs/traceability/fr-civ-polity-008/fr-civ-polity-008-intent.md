# Intent: FR-CIV-POLITY-008 -- Polity system

> Date: 2026-09-17
> FR: FR-CIV-POLITY-008
> Epic: FR-CIV-POLITY
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-POLITY-008 contributes to the overall simulation capability by addressing: Polity system.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-polity-008-spec.md` |
| ADR | `fr-civ-polity-008-adr.md` |
| Research | `fr-civ-polity-008-research.md` |
| Plan | `fr-civ-polity-008-plan.md` |
