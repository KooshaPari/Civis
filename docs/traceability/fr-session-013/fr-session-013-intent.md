# Intent: FR-SESSION-013 -- Session management
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-SESSION-013 contributes to the overall simulation capability by addressing: Session management.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-session-013-spec.md` |
| ADR | `fr-session-013-adr.md` |
| Research | `fr-session-013-research.md` |
| Plan | `fr-session-013-plan.md` |
