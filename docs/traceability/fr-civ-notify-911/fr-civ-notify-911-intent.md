# Intent: FR-CIV-NOTIFY-911 -- Notification system

> Date: 2026-09-17
> FR: FR-CIV-NOTIFY-911
> Epic: FR-CIV-NOTIFY
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-NOTIFY-911 contributes to the overall simulation capability by addressing: Notification system.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-notify-911-spec.md` |
| ADR | `fr-civ-notify-911-adr.md` |
| Research | `fr-civ-notify-911-research.md` |
| Plan | `fr-civ-notify-911-plan.md` |
