# ADR: FR-CIV-VOXEL-022 -- Voxel rendering

> Status: Proposed
> Date: 2026-09-17
> Deciders: CivLab
> Relates to: FR-CIV-VOXEL-022
> Epic: FR-CIV-VOXEL

## Context

FR-CIV-VOXEL-022 is part of the FR-CIV-VOXEL epic. This functional requirement captures: Voxel rendering.

Implementing crate: `crates/voxel/src/`

### Referenced Source
- `docs/guides/voxel-emergent-vision-and-migration.md:94`
- `docs/guides/voxel-emergent-vision-and-migration.md:125`
...
TBD -- The architectural decision for FR-CIV-VOXEL-022 needs to be finalized based on implementation exploration.
