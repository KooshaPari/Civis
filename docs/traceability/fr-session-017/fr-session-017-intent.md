# Intent: FR-SESSION-017 -- Session management
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-SESSION-017 contributes to the overall simulation capability by addressing: Session management.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-session-017-spec.md` |
| ADR | `fr-session-017-adr.md` |
| Research | `fr-session-017-research.md` |
| Plan | `fr-session-017-plan.md` |
