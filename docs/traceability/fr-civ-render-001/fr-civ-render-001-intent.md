# Intent: FR-CIV-RENDER-001 -- Rendering pipeline
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-RENDER-001 contributes to the overall simulation capability by addressing: Rendering pipeline.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-render-001-spec.md` |
| ADR | `fr-civ-render-001-adr.md` |
| Research | `fr-civ-render-001-research.md` |
| Plan | `fr-civ-render-001-plan.md` |
