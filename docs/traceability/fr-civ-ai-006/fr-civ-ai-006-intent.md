# Intent: FR-CIV-AI-006 -- Artificial intelligence
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-AI-006 contributes to the overall simulation capability by addressing: Artificial intelligence.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-ai-006-spec.md` |
| ADR | `fr-civ-ai-006-adr.md` |
| Research | `fr-civ-ai-006-research.md` |
| Plan | `fr-civ-ai-006-plan.md` |
