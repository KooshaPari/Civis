...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-DIPL-001 contributes to the overall simulation capability by addressing: Diplomacy.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-dipl-001-spec.md` |
| ADR | `fr-dipl-001-adr.md` |
| Research | `fr-dipl-001-research.md` |
| Plan | `fr-dipl-001-plan.md` |
