# Research: FR-INT-001 -- Integration
...
What is the best approach to implement Integration within the Civis simulation engine?

## Background

This FR belongs to the FR-INT epic and is expected to be implemented in `crates/engine/src/`.
