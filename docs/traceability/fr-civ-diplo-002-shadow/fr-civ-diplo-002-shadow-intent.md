# Intent: FR-CIV-DIPLO-002-SHADOW -- Diplomacy and treaties
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-DIPLO-002-SHADOW contributes to the overall simulation capability by addressing: Diplomacy and treaties.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-diplo-002-shadow-spec.md` |
| ADR | `fr-civ-diplo-002-shadow-adr.md` |
| Research | `fr-civ-diplo-002-shadow-research.md` |
| Plan | `fr-civ-diplo-002-shadow-plan.md` |
