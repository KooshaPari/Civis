# Intent: FR-CIV-DIFFUSION-014 -- Cultural diffusion
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-DIFFUSION-014 contributes to the overall simulation capability by addressing: Cultural diffusion.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-diffusion-014-spec.md` |
| ADR | `fr-civ-diffusion-014-adr.md` |
| Research | `fr-civ-diffusion-014-research.md` |
| Plan | `fr-civ-diffusion-014-plan.md` |
