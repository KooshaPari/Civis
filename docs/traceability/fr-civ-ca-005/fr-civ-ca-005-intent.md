# Intent: FR-CIV-CA-005 -- Combat and military
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-CA-005 contributes to the overall simulation capability by addressing: Combat and military.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-ca-005-spec.md` |
| ADR | `fr-civ-ca-005-adr.md` |
| Research | `fr-civ-ca-005-research.md` |
| Plan | `fr-civ-ca-005-plan.md` |
