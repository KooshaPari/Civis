# ADR: FR-CIV-HUD-003 -- HUD overlay

> Status: Proposed
> Date: 2026-09-17
> Deciders: CivLab
> Relates to: FR-CIV-HUD-003
> Epic: FR-CIV-HUD

## Context

FR-CIV-HUD-003 is part of the FR-CIV-HUD epic. This functional requirement captures: HUD overlay.
...
TBD -- The architectural decision for FR-CIV-HUD-003 needs to be finalized based on implementation exploration.
