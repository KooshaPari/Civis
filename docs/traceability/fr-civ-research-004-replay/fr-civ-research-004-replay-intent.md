# Intent: FR-CIV-RESEARCH-004-REPLAY -- Technology research

> Date: 2026-09-17
> FR: FR-CIV-RESEARCH-004-REPLAY
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-RESEARCH-004-REPLAY contributes to the overall simulation capability by addressing: Technology research.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-research-004-replay-spec.md` |
| ADR | `fr-civ-research-004-replay-adr.md` |
| Research | `fr-civ-research-004-replay-research.md` |
| Plan | `fr-civ-research-004-replay-plan.md` |
