# Intent: FR-CIV-RESEARCH-012 -- Technology research

> Date: 2026-09-17
> FR: FR-CIV-RESEARCH-012
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-RESEARCH-012 contributes to the overall simulation capability by addressing: Technology research.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-research-012-spec.md` |
| ADR | `fr-civ-research-012-adr.md` |
| Research | `fr-civ-research-012-research.md` |
| Plan | `fr-civ-research-012-plan.md` |
