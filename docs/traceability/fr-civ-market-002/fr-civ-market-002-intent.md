# Intent: FR-CIV-MARKET-002 -- Market dynamics
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-MARKET-002 contributes to the overall simulation capability by addressing: Market dynamics.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-market-002-spec.md` |
| ADR | `fr-civ-market-002-adr.md` |
| Research | `fr-civ-market-002-research.md` |
| Plan | `fr-civ-market-002-plan.md` |
