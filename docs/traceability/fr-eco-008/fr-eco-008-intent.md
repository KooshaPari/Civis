...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-ECO-008 contributes to the overall simulation capability by addressing: Economy.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-eco-008-spec.md` |
| ADR | `fr-eco-008-adr.md` |
| Research | `fr-eco-008-research.md` |
| Plan | `fr-eco-008-plan.md` |
