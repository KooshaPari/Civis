# Intent: FR-CIV-RESEARCH-002-SNAPSHOT -- Technology research

> Date: 2026-09-17
> FR: FR-CIV-RESEARCH-002-SNAPSHOT
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-RESEARCH-002-SNAPSHOT contributes to the overall simulation capability by addressing: Technology research.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-research-002-snapshot-spec.md` |
| ADR | `fr-civ-research-002-snapshot-adr.md` |
| Research | `fr-civ-research-002-snapshot-research.md` |
| Plan | `fr-civ-research-002-snapshot-plan.md` |
