# Intent: FR-CIV-RTS-015 -- RTS gameplay
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-RTS-015 contributes to the overall simulation capability by addressing: RTS gameplay.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-rts-015-spec.md` |
| ADR | `fr-civ-rts-015-adr.md` |
| Research | `fr-civ-rts-015-research.md` |
| Plan | `fr-civ-rts-015-plan.md` |
