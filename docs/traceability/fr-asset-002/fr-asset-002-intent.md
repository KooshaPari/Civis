...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-ASSET-002 contributes to the overall simulation capability by addressing: Asset.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-asset-002-spec.md` |
| ADR | `fr-asset-002-adr.md` |
| Research | `fr-asset-002-research.md` |
| Plan | `fr-asset-002-plan.md` |
