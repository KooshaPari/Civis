# Intent: FR-SOC-COH-002 -- Social cohesion
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-SOC-COH-002 contributes to the overall simulation capability by addressing: Social cohesion.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-soc-coh-002-spec.md` |
| ADR | `fr-soc-coh-002-adr.md` |
| Research | `fr-soc-coh-002-research.md` |
| Plan | `fr-soc-coh-002-plan.md` |
