# ADR: FR-CIV-ASSET-011 -- Asset pipeline

> Status: Proposed
> Date: 2026-09-17
> Deciders: CivLab
> Relates to: FR-CIV-ASSET-011
> Epic: FR-CIV-ASSET

## Context

FR-CIV-ASSET-011 is part of the FR-CIV-ASSET epic. This functional requirement captures: Asset pipeline.
...
- `docs/specs/CIV-0600-2d-asset-pipeline-spec.md:2870`
...
TBD -- The architectural decision for FR-CIV-ASSET-011 needs to be finalized based on implementation exploration.
