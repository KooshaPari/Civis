# ADR: FR-UX-018 -- User experience

> Status: Proposed
> Date: 2026-09-17
> Deciders: CivLab
> Relates to: FR-UX-018
> Epic: FR-UX

## Context

FR-UX-018 is part of the FR-UX epic. This functional requirement captures: User experience.
...
TBD -- The architectural decision for FR-UX-018 needs to be finalized based on implementation exploration.
