# Intent: FR-SOC-IDE-004 -- Social ideology
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-SOC-IDE-004 contributes to the overall simulation capability by addressing: Social ideology.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-soc-ide-004-spec.md` |
| ADR | `fr-soc-ide-004-adr.md` |
| Research | `fr-soc-ide-004-research.md` |
| Plan | `fr-soc-ide-004-plan.md` |
