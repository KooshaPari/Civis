# Intent: FR-CIV-SERVER-002 -- Server infrastructure

> Date: 2026-09-17
> FR: FR-CIV-SERVER-002
> Epic: FR-CIV-SERVER
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-SERVER-002 contributes to the overall simulation capability by addressing: Server infrastructure.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-server-002-spec.md` |
| ADR | `fr-civ-server-002-adr.md` |
| Research | `fr-civ-server-002-research.md` |
| Plan | `fr-civ-server-002-plan.md` |
