# Intent: FR-SAVE-016 -- Save system
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-SAVE-016 contributes to the overall simulation capability by addressing: Save system.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-save-016-spec.md` |
| ADR | `fr-save-016-adr.md` |
| Research | `fr-save-016-research.md` |
| Plan | `fr-save-016-plan.md` |
