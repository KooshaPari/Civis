# Intent: FR-PERF-003 -- Performance
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-PERF-003 contributes to the overall simulation capability by addressing: Performance.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-perf-003-spec.md` |
| ADR | `fr-perf-003-adr.md` |
| Research | `fr-perf-003-research.md` |
| Plan | `fr-perf-003-plan.md` |
