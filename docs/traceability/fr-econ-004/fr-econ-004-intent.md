...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-ECON-004 contributes to the overall simulation capability by addressing: Economics.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-econ-004-spec.md` |
| ADR | `fr-econ-004-adr.md` |
| Research | `fr-econ-004-research.md` |
| Plan | `fr-econ-004-plan.md` |
