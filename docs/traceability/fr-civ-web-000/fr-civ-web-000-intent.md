# Intent: FR-CIV-WEB-000 -- Web client
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-WEB-000 contributes to the overall simulation capability by addressing: Web client.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-web-000-spec.md` |
| ADR | `fr-civ-web-000-adr.md` |
| Research | `fr-civ-web-000-research.md` |
| Plan | `fr-civ-web-000-plan.md` |
