# Intent: FR-CIV-MCP-004 -- MCP server integration
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-MCP-004 contributes to the overall simulation capability by addressing: MCP server integration.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-mcp-004-spec.md` |
| ADR | `fr-civ-mcp-004-adr.md` |
| Research | `fr-civ-mcp-004-research.md` |
| Plan | `fr-civ-mcp-004-plan.md` |
