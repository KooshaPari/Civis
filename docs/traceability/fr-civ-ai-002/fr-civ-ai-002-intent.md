# Intent: FR-CIV-AI-002 -- Artificial intelligence
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-AI-002 contributes to the overall simulation capability by addressing: Artificial intelligence.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-ai-002-spec.md` |
| ADR | `fr-civ-ai-002-adr.md` |
| Research | `fr-civ-ai-002-research.md` |
| Plan | `fr-civ-ai-002-plan.md` |
