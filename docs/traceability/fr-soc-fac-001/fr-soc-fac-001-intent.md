# Intent: FR-SOC-FAC-001 -- Social faction
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-SOC-FAC-001 contributes to the overall simulation capability by addressing: Social faction.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-soc-fac-001-spec.md` |
| ADR | `fr-soc-fac-001-adr.md` |
| Research | `fr-soc-fac-001-research.md` |
| Plan | `fr-soc-fac-001-plan.md` |
