# Intent: FR-CIV-AGENTS-022 -- Agent systems

> Date: 2026-09-17
> FR: FR-CIV-AGENTS-022
> Epic: FR-CIV-AGENTS
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-AGENTS-022 contributes to the overall simulation capability by addressing: Agent systems.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-agents-022-spec.md` |
| ADR | `fr-civ-agents-022-adr.md` |
| Research | `fr-civ-agents-022-research.md` |
| Plan | `fr-civ-agents-022-plan.md` |
