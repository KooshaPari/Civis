# Intent: FR-SOC-INT-004 -- Social interaction
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-SOC-INT-004 contributes to the overall simulation capability by addressing: Social interaction.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-soc-int-004-spec.md` |
| ADR | `fr-soc-int-004-adr.md` |
| Research | `fr-soc-int-004-research.md` |
| Plan | `fr-soc-int-004-plan.md` |
