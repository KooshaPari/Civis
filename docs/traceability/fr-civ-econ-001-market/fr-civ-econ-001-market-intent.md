# Intent: FR-CIV-ECON-001-MARKET -- Economy and joule allocation
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-ECON-001-MARKET contributes to the overall simulation capability by addressing: Economy and joule allocation.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-econ-001-market-spec.md` |
| ADR | `fr-civ-econ-001-market-adr.md` |
| Research | `fr-civ-econ-001-market-research.md` |
| Plan | `fr-civ-econ-001-market-plan.md` |
