# Intent: FR-SAVE-018 -- Save system
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-SAVE-018 contributes to the overall simulation capability by addressing: Save system.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-save-018-spec.md` |
| ADR | `fr-save-018-adr.md` |
| Research | `fr-save-018-research.md` |
| Plan | `fr-save-018-plan.md` |
