# Intent: FR-CIV-EMERGENCE-001 -- Emergence metrics

> Date: 2026-09-17
> FR: FR-CIV-EMERGENCE-001
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-EMERGENCE-001 contributes to the overall simulation capability by addressing: Emergence metrics.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-emergence-001-spec.md` |
| ADR | `fr-civ-emergence-001-adr.md` |
| Research | `fr-civ-emergence-001-research.md` |
| Plan | `fr-civ-emergence-001-plan.md` |
