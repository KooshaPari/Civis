# Research: FR-SOC-INTG-002 -- Social integration
...
What is the best approach to implement Social integration within the Civis simulation engine?

## Background

This FR belongs to the FR-SOC-INTG epic and is expected to be implemented in `crates/civ-institutions/src/`.
