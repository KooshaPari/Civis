# Intent: FR-CIV-PROTO-003 -- 3D protocol
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-PROTO-003 contributes to the overall simulation capability by addressing: 3D protocol.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-proto-003-spec.md` |
| ADR | `fr-civ-proto-003-adr.md` |
| Research | `fr-civ-proto-003-research.md` |
| Plan | `fr-civ-proto-003-plan.md` |
