# Intent: FR-CIV-PBR-005 -- Physically based rendering
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-PBR-005 contributes to the overall simulation capability by addressing: Physically based rendering.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-pbr-005-spec.md` |
| ADR | `fr-civ-pbr-005-adr.md` |
| Research | `fr-civ-pbr-005-research.md` |
| Plan | `fr-civ-pbr-005-plan.md` |
