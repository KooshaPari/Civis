# Intent: FR-UX-021 -- User experience
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-UX-021 contributes to the overall simulation capability by addressing: User experience.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-ux-021-spec.md` |
| ADR | `fr-ux-021-adr.md` |
| Research | `fr-ux-021-research.md` |
| Plan | `fr-ux-021-plan.md` |
