# Intent: FR-CIV-HUD-004 -- HUD overlay
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-HUD-004 contributes to the overall simulation capability by addressing: HUD overlay.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-hud-004-spec.md` |
| ADR | `fr-civ-hud-004-adr.md` |
| Research | `fr-civ-hud-004-research.md` |
| Plan | `fr-civ-hud-004-plan.md` |
