# Research: FR-CIV-RTS-NATION-002 -- RTS nation system
...
What is the best approach to implement RTS nation system within the Civis simulation engine?

## Background

This FR belongs to the FR-CIV-RTS-NATION epic and is expected to be implemented in `crates/protocol-3d/src/`.
