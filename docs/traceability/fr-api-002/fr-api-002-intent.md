...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-API-002 contributes to the overall simulation capability by addressing: API.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-api-002-spec.md` |
| ADR | `fr-api-002-adr.md` |
| Research | `fr-api-002-research.md` |
| Plan | `fr-api-002-plan.md` |
