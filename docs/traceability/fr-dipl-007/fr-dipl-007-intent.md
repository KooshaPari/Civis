...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-DIPL-007 contributes to the overall simulation capability by addressing: Diplomacy.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-dipl-007-spec.md` |
| ADR | `fr-dipl-007-adr.md` |
| Research | `fr-dipl-007-research.md` |
| Plan | `fr-dipl-007-plan.md` |
