...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-ECON-006 contributes to the overall simulation capability by addressing: Economics.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-econ-006-spec.md` |
| ADR | `fr-econ-006-adr.md` |
| Research | `fr-econ-006-research.md` |
| Plan | `fr-econ-006-plan.md` |
