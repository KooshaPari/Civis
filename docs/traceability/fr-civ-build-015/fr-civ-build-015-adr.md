# ADR: FR-CIV-BUILD-015 -- Building tiers and construction

> Status: Proposed
> Date: 2026-09-17
> Deciders: CivLab
> Relates to: FR-CIV-BUILD-015
> Epic: FR-CIV-BUILD

## Context

FR-CIV-BUILD-015 is part of the FR-CIV-BUILD epic. This functional requirement captures: Building tiers and construction.
...
TBD -- The architectural decision for FR-CIV-BUILD-015 needs to be finalized based on implementation exploration.
