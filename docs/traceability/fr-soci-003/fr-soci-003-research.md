# Research: FR-SOCI-003 -- Sociology
...
What is the best approach to implement Sociology within the Civis simulation engine?

## Background

This FR belongs to the FR-SOCI epic and is expected to be implemented in `crates/civ-institutions/src/`.
