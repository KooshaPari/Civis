# Intent: FR-CIV-PLANET-001 -- Planetary generation

> Date: 2026-09-17
> FR: FR-CIV-PLANET-001
> Epic: FR-CIV-PLANET
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-PLANET-001 contributes to the overall simulation capability by addressing: Planetary generation.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-planet-001-spec.md` |
| ADR | `fr-civ-planet-001-adr.md` |
| Research | `fr-civ-planet-001-research.md` |
| Plan | `fr-civ-planet-001-plan.md` |
