...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-PROT-006 contributes to the overall simulation capability by addressing: Protocol.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-prot-006-spec.md` |
| ADR | `fr-prot-006-adr.md` |
| Research | `fr-prot-006-research.md` |
| Plan | `fr-prot-006-plan.md` |
