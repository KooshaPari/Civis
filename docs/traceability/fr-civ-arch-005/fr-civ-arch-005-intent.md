# Intent: FR-CIV-ARCH-005 -- Architecture and crate design
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-ARCH-005 contributes to the overall simulation capability by addressing: Architecture and crate design.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-arch-005-spec.md` |
| ADR | `fr-civ-arch-005-adr.md` |
| Research | `fr-civ-arch-005-research.md` |
| Plan | `fr-civ-arch-005-plan.md` |
