...
impl TechPrereqGraph {
    ...
    #[must_use]
    pub fn is_unlocked(&self, tech_id: &str, researched: &BTreeSet<String>, points: u32) -> bool {
    ...
    #[must_use]
    pub fn is_locked(&self, tech_id: &str, researched: &BTreeSet<String>, points: u32) -> bool {
...
mod tests {
    ...
    fn tech_stays_locked_until_prereqs_met_then_unlocks() {
        ...
        graph.insert(TechPrereqNode::new(
            "advanced_rail",
            ["basic_rail", "steel"],
            100,
        ));
