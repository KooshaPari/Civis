# Intent: FR-CIV-MOD-017 -- Mod system (WASM)
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-MOD-017 contributes to the overall simulation capability by addressing: Mod system (WASM).
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-mod-017-spec.md` |
| ADR | `fr-civ-mod-017-adr.md` |
| Research | `fr-civ-mod-017-research.md` |
| Plan | `fr-civ-mod-017-plan.md` |
