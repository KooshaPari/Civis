# Intent: FR-CIV-VEHICLE-010 -- Vehicle systems

> Date: 2026-09-17
> FR: FR-CIV-VEHICLE-010
> Epic: FR-CIV-VEHICLE
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-VEHICLE-010 contributes to the overall simulation capability by addressing: Vehicle systems.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-vehicle-010-spec.md` |
| ADR | `fr-civ-vehicle-010-adr.md` |
| Research | `fr-civ-vehicle-010-research.md` |
| Plan | `fr-civ-vehicle-010-plan.md` |
