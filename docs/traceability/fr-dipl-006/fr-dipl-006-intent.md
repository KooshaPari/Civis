...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-DIPL-006 contributes to the overall simulation capability by addressing: Diplomacy.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-dipl-006-spec.md` |
| ADR | `fr-dipl-006-adr.md` |
| Research | `fr-dipl-006-research.md` |
| Plan | `fr-dipl-006-plan.md` |
