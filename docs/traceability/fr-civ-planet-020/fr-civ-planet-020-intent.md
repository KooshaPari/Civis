# Intent: FR-CIV-PLANET-020 -- Planetary generation
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-PLANET-020 contributes to the overall simulation capability by addressing: Planetary generation.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-planet-020-spec.md` |
| ADR | `fr-civ-planet-020-adr.md` |
| Research | `fr-civ-planet-020-research.md` |
| Plan | `fr-civ-planet-020-plan.md` |
