# Intent: FR-SOC-IDE-001 -- Social ideology
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-SOC-IDE-001 contributes to the overall simulation capability by addressing: Social ideology.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-soc-ide-001-spec.md` |
| ADR | `fr-soc-ide-001-adr.md` |
| Research | `fr-soc-ide-001-research.md` |
| Plan | `fr-soc-ide-001-plan.md` |
