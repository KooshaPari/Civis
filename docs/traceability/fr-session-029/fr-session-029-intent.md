# Intent: FR-SESSION-029 -- Session management
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-SESSION-029 contributes to the overall simulation capability by addressing: Session management.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-session-029-spec.md` |
| ADR | `fr-session-029-adr.md` |
| Research | `fr-session-029-research.md` |
| Plan | `fr-session-029-plan.md` |
