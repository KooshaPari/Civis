# Intent: FR-CIV-DIFFUSION-005 -- Cultural diffusion

> Date: 2026-09-17
> FR: FR-CIV-DIFFUSION-005
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-DIFFUSION-005 contributes to the overall simulation capability by addressing: Cultural diffusion.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-diffusion-005-spec.md` |
| ADR | `fr-civ-diffusion-005-adr.md` |
| Research | `fr-civ-diffusion-005-research.md` |
| Plan | `fr-civ-diffusion-005-plan.md` |
