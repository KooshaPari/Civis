...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-SOCI-004 contributes to the overall simulation capability by addressing: Sociology.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-soci-004-spec.md` |
| ADR | `fr-soci-004-adr.md` |
| Research | `fr-soci-004-research.md` |
| Plan | `fr-soci-004-plan.md` |
