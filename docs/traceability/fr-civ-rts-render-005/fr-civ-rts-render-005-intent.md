# Intent: FR-CIV-RTS-RENDER-005 -- RTS rendering

> Date: 2026-09-17
> FR: FR-CIV-RTS-RENDER-005
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-RTS-RENDER-005 contributes to the overall simulation capability by addressing: RTS rendering.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-rts-render-005-spec.md` |
| ADR | `fr-civ-rts-render-005-adr.md` |
| Research | `fr-civ-rts-render-005-research.md` |
| Plan | `fr-civ-rts-render-005-plan.md` |
