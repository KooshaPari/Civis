# Intent: FR-CIV-TACTICS-050 -- Tactics and strategy
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-TACTICS-050 contributes to the overall simulation capability by addressing: Tactics and strategy.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-tactics-050-spec.md` |
| ADR | `fr-civ-tactics-050-adr.md` |
| Research | `fr-civ-tactics-050-research.md` |
| Plan | `fr-civ-tactics-050-plan.md` |
