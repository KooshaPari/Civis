# Intent: FR-SAVE-010 -- Save system
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-SAVE-010 contributes to the overall simulation capability by addressing: Save system.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-save-010-spec.md` |
| ADR | `fr-save-010-adr.md` |
| Research | `fr-save-010-research.md` |
| Plan | `fr-save-010-plan.md` |
