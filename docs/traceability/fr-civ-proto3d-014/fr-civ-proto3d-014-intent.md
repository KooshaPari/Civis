# Intent: FR-CIV-PROTO3D-014 -- Core civilisation simulation

> Date: 2026-09-17
> FR: FR-CIV-PROTO3D-014
> Epic: FR-CIV
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-PROTO3D-014 contributes to the overall simulation capability by addressing: Core civilisation simulation.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-proto3d-014-spec.md` |
| ADR | `fr-civ-proto3d-014-adr.md` |
| Research | `fr-civ-proto3d-014-research.md` |
| Plan | `fr-civ-proto3d-014-plan.md` |
