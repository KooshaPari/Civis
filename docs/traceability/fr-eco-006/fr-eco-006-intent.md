...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-ECO-006 contributes to the overall simulation capability by addressing: Economy.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-eco-006-spec.md` |
| ADR | `fr-eco-006-adr.md` |
| Research | `fr-eco-006-research.md` |
| Plan | `fr-eco-006-plan.md` |
