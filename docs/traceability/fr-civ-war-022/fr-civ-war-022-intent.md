# Intent: FR-CIV-WAR-022 -- War and conflict
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-WAR-022 contributes to the overall simulation capability by addressing: War and conflict.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-war-022-spec.md` |
| ADR | `fr-civ-war-022-adr.md` |
| Research | `fr-civ-war-022-research.md` |
| Plan | `fr-civ-war-022-plan.md` |
