# Intent: FR-CIV-BRUSH-12 -- Terrain brush tools
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-BRUSH-12 contributes to the overall simulation capability by addressing: Terrain brush tools.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-brush-12-spec.md` |
| ADR | `fr-civ-brush-12-adr.md` |
| Research | `fr-civ-brush-12-research.md` |
| Plan | `fr-civ-brush-12-plan.md` |
