# Research: FR-SOC-INT-004 -- Social interaction
...
What is the best approach to implement Social interaction within the Civis simulation engine?

## Background

This FR belongs to the FR-SOC-INT epic and is expected to be implemented in `crates/civ-institutions/src/`.
