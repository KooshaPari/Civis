# Intent: FR-SESSION-023 -- Session management
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-SESSION-023 contributes to the overall simulation capability by addressing: Session management.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-session-023-spec.md` |
| ADR | `fr-session-023-adr.md` |
| Research | `fr-session-023-research.md` |
| Plan | `fr-session-023-plan.md` |
