# Intent: FR-CIV-SERVER-001-WS -- Server infrastructure
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-SERVER-001-WS contributes to the overall simulation capability by addressing: Server infrastructure.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-server-001-ws-spec.md` |
| ADR | `fr-civ-server-001-ws-adr.md` |
| Research | `fr-civ-server-001-ws-research.md` |
| Plan | `fr-civ-server-001-ws-plan.md` |
