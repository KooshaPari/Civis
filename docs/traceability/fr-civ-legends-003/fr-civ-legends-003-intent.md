# Intent: FR-CIV-LEGENDS-003 -- Legend and narrative system
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-LEGENDS-003 contributes to the overall simulation capability by addressing: Legend and narrative system.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-legends-003-spec.md` |
| ADR | `fr-civ-legends-003-adr.md` |
| Research | `fr-civ-legends-003-research.md` |
| Plan | `fr-civ-legends-003-plan.md` |
