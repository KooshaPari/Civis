# Intent: FR-CIV-MOD-009 -- Mod system (WASM)
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-MOD-009 contributes to the overall simulation capability by addressing: Mod system (WASM).
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-mod-009-spec.md` |
| ADR | `fr-civ-mod-009-adr.md` |
| Research | `fr-civ-mod-009-research.md` |
| Plan | `fr-civ-mod-009-plan.md` |
