# Intent: FR-CIV-DIFFUSION-002 -- Cultural diffusion
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-DIFFUSION-002 contributes to the overall simulation capability by addressing: Cultural diffusion.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-diffusion-002-spec.md` |
| ADR | `fr-civ-diffusion-002-adr.md` |
| Research | `fr-civ-diffusion-002-research.md` |
| Plan | `fr-civ-diffusion-002-plan.md` |
