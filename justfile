...
# P-W1 kickoff item 41 / FR-CIV-BEVY-016; item 47 / FR-CIV-BEVY-022; item 50 / FR-CIV-BEVY-025; item 52 / FR-CIV-BEVY-027; item 57 / FR-CIV-BEVY-032; item 58 / FR-CIV-BEVY-033; item 60 / FR-CIV-BEVY-035; item 62 / FR-CIV-BEVY-037; items 63–67 / FR-CIV-BEVY-038–042 (six-frame bundle + live-attach closure).
civis-3d-live-smoke:
    ...
    cargo test -p civ-bevy-ref --lib parse_ws_payload_decodes_all_frame_kinds
    cargo test -p civ-bevy-ref --features bevy --lib gpu_features::
    cargo test -p civ-bevy-ref --features pbr-textures --lib materials::
