# Intent: FR-UX-007 -- User experience
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-UX-007 contributes to the overall simulation capability by addressing: User experience.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-ux-007-spec.md` |
| ADR | `fr-ux-007-adr.md` |
| Research | `fr-ux-007-research.md` |
| Plan | `fr-ux-007-plan.md` |
