...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-ECO-009 contributes to the overall simulation capability by addressing: Economy.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-eco-009-spec.md` |
| ADR | `fr-eco-009-adr.md` |
| Research | `fr-eco-009-research.md` |
| Plan | `fr-eco-009-plan.md` |
