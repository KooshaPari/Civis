# Intent: FR-UX-024 -- User experience
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-UX-024 contributes to the overall simulation capability by addressing: User experience.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-ux-024-spec.md` |
| ADR | `fr-ux-024-adr.md` |
| Research | `fr-ux-024-research.md` |
| Plan | `fr-ux-024-plan.md` |
