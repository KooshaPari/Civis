# Intent: FR-CIV-GEO-009 -- Geological systems
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-GEO-009 contributes to the overall simulation capability by addressing: Geological systems.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-geo-009-spec.md` |
| ADR | `fr-civ-geo-009-adr.md` |
| Research | `fr-civ-geo-009-research.md` |
| Plan | `fr-civ-geo-009-plan.md` |
