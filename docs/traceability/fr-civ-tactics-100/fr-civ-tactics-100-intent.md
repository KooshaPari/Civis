# Intent: FR-CIV-TACTICS-100 -- Tactics and strategy

> Date: 2026-09-17
> FR: FR-CIV-TACTICS-100
> Epic: FR-CIV-TACTICS
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-TACTICS-100 contributes to the overall simulation capability by addressing: Tactics and strategy.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-tactics-100-spec.md` |
| ADR | `fr-civ-tactics-100-adr.md` |
| Research | `fr-civ-tactics-100-research.md` |
| Plan | `fr-civ-tactics-100-plan.md` |
