# Intent: FR-CIV-PERF-003 -- Performance
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-PERF-003 contributes to the overall simulation capability by addressing: Performance.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-perf-003-spec.md` |
| ADR | `fr-civ-perf-003-adr.md` |
| Research | `fr-civ-perf-003-research.md` |
| Plan | `fr-civ-perf-003-plan.md` |
