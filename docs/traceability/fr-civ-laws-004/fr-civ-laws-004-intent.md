# Intent: FR-CIV-LAWS-004 -- Legal system
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-LAWS-004 contributes to the overall simulation capability by addressing: Legal system.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-laws-004-spec.md` |
| ADR | `fr-civ-laws-004-adr.md` |
| Research | `fr-civ-laws-004-research.md` |
| Plan | `fr-civ-laws-004-plan.md` |
