...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-DIPL-003 contributes to the overall simulation capability by addressing: Diplomacy.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-dipl-003-spec.md` |
| ADR | `fr-dipl-003-adr.md` |
| Research | `fr-dipl-003-research.md` |
| Plan | `fr-dipl-003-plan.md` |
