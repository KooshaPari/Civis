# Intent: FR-SESSION-026 -- Session management
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-SESSION-026 contributes to the overall simulation capability by addressing: Session management.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-session-026-spec.md` |
| ADR | `fr-session-026-adr.md` |
| Research | `fr-session-026-research.md` |
| Plan | `fr-session-026-plan.md` |
