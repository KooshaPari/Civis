# Intent: FR-SESSION-031 -- Session management
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-SESSION-031 contributes to the overall simulation capability by addressing: Session management.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-session-031-spec.md` |
| ADR | `fr-session-031-adr.md` |
| Research | `fr-session-031-research.md` |
| Plan | `fr-session-031-plan.md` |
