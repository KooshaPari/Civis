# Intent: FR-CIV-ROAD-902 -- Road and path systems
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-ROAD-902 contributes to the overall simulation capability by addressing: Road and path systems.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-road-902-spec.md` |
| ADR | `fr-civ-road-902-adr.md` |
| Research | `fr-civ-road-902-research.md` |
| Plan | `fr-civ-road-902-plan.md` |
