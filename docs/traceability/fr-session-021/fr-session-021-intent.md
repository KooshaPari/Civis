# Intent: FR-SESSION-021 -- Session management
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-SESSION-021 contributes to the overall simulation capability by addressing: Session management.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-session-021-spec.md` |
| ADR | `fr-session-021-adr.md` |
| Research | `fr-session-021-research.md` |
| Plan | `fr-session-021-plan.md` |
