# Intent: FR-CIV-AI-001 -- Artificial intelligence
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-AI-001 contributes to the overall simulation capability by addressing: Artificial intelligence.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-ai-001-spec.md` |
| ADR | `fr-civ-ai-001-adr.md` |
| Research | `fr-civ-ai-001-research.md` |
| Plan | `fr-civ-ai-001-plan.md` |
