# Intent: FR-CLIENT-002 -- Client system
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CLIENT-002 contributes to the overall simulation capability by addressing: Client system.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-client-002-spec.md` |
| ADR | `fr-client-002-adr.md` |
| Research | `fr-client-002-research.md` |
| Plan | `fr-client-002-plan.md` |
