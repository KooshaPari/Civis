# Intent: FR-SESSION-032 -- Session management
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-SESSION-032 contributes to the overall simulation capability by addressing: Session management.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-session-032-spec.md` |
| ADR | `fr-session-032-adr.md` |
| Research | `fr-session-032-research.md` |
| Plan | `fr-session-032-plan.md` |
