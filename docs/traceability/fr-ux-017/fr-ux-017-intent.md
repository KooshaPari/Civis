# Intent: FR-UX-017 -- User experience
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-UX-017 contributes to the overall simulation capability by addressing: User experience.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-ux-017-spec.md` |
| ADR | `fr-ux-017-adr.md` |
| Research | `fr-ux-017-research.md` |
| Plan | `fr-ux-017-plan.md` |
