# Intent: FR-CIV-SOCIAL-001-INSTITUTIONS -- Social systems

> Date: 2026-09-17
> FR: FR-CIV-SOCIAL-001-INSTITUTIONS
> Epic: FR-CIV-SOCIAL
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-SOCIAL-001-INSTITUTIONS contributes to the overall simulation capability by addressing: Social systems.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-social-001-institutions-spec.md` |
| ADR | `fr-civ-social-001-institutions-adr.md` |
| Research | `fr-civ-social-001-institutions-research.md` |
| Plan | `fr-civ-social-001-institutions-plan.md` |
