# Intent: FR-SOC-CIV-001 -- Social civilisation
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-SOC-CIV-001 contributes to the overall simulation capability by addressing: Social civilisation.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-soc-civ-001-spec.md` |
| ADR | `fr-soc-civ-001-adr.md` |
| Research | `fr-soc-civ-001-research.md` |
| Plan | `fr-soc-civ-001-plan.md` |
