# ADR: FR-CIV-RTS-RENDER-002 -- RTS rendering

> Status: Proposed
> Date: 2026-09-17
> Deciders: CivLab
> Relates to: FR-CIV-RTS-RENDER-002
> Epic: FR-CIV-RTS-RENDER

## Context

FR-CIV-RTS-RENDER-002 is part of the FR-CIV-RTS-RENDER epic. This functional requirement captures: RTS rendering.
...
TBD -- The architectural decision for FR-CIV-RTS-RENDER-002 needs to be finalized based on implementation exploration.
