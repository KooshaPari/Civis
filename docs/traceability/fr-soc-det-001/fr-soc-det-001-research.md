# Research: FR-SOC-DET-001 -- Social determinism
...
What is the best approach to implement Social determinism within the Civis simulation engine?

## Background

This FR belongs to the FR-SOC-DET epic and is expected to be implemented in `crates/civ-institutions/src/`.
