# Intent: FR-CORE-004 -- Core system
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CORE-004 contributes to the overall simulation capability by addressing: Core system.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-core-004-spec.md` |
| ADR | `fr-core-004-adr.md` |
| Research | `fr-core-004-research.md` |
| Plan | `fr-core-004-plan.md` |
