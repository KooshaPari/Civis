...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-SESS-001 contributes to the overall simulation capability by addressing: Session.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-sess-001-spec.md` |
| ADR | `fr-sess-001-adr.md` |
| Research | `fr-sess-001-research.md` |
| Plan | `fr-sess-001-plan.md` |
