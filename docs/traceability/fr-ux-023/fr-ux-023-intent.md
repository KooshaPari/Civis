# Intent: FR-UX-023 -- User experience
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-UX-023 contributes to the overall simulation capability by addressing: User experience.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-ux-023-spec.md` |
| ADR | `fr-ux-023-adr.md` |
| Research | `fr-ux-023-research.md` |
| Plan | `fr-ux-023-plan.md` |
