# Intent: FR-CIV-GENETICS-012 -- Procedural genetics

> Date: 2026-09-17
> FR: FR-CIV-GENETICS-012
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-GENETICS-012 contributes to the overall simulation capability by addressing: Procedural genetics.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-genetics-012-spec.md` |
| ADR | `fr-civ-genetics-012-adr.md` |
| Research | `fr-civ-genetics-012-research.md` |
| Plan | `fr-civ-genetics-012-plan.md` |
