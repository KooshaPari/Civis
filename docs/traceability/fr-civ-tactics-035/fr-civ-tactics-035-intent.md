# Intent: FR-CIV-TACTICS-035 -- Tactics and strategy
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-TACTICS-035 contributes to the overall simulation capability by addressing: Tactics and strategy.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-tactics-035-spec.md` |
| ADR | `fr-civ-tactics-035-adr.md` |
| Research | `fr-civ-tactics-035-research.md` |
| Plan | `fr-civ-tactics-035-plan.md` |
