# Intent: FR-CIV-PERF-RT-001 -- Civ Perf Rt

> Date: 2026-09-17
> FR: FR-CIV-PERF-RT-001
> Epic: FR-CIV-PERF-RT
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-PERF-RT-001 contributes to the overall simulation capability by addressing: Civ Perf Rt.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-perf-rt-001-spec.md` |
| ADR | `fr-civ-perf-rt-001-adr.md` |
| Research | `fr-civ-perf-rt-001-research.md` |
| Plan | `fr-civ-perf-rt-001-plan.md` |
