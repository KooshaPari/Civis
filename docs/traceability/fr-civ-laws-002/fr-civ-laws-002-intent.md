# Intent: FR-CIV-LAWS-002 -- Legal system
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-LAWS-002 contributes to the overall simulation capability by addressing: Legal system.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-laws-002-spec.md` |
| ADR | `fr-civ-laws-002-adr.md` |
| Research | `fr-civ-laws-002-research.md` |
| Plan | `fr-civ-laws-002-plan.md` |
