# Intent: FR-CIV-INSPECT-900 -- Inspection tools
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-INSPECT-900 contributes to the overall simulation capability by addressing: Inspection tools.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-inspect-900-spec.md` |
| ADR | `fr-civ-inspect-900-adr.md` |
| Research | `fr-civ-inspect-900-research.md` |
| Plan | `fr-civ-inspect-900-plan.md` |
