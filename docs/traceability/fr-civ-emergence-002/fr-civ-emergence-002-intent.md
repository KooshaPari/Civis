# Intent: FR-CIV-EMERGENCE-002 -- Emergence metrics

> Date: 2026-09-17
> FR: FR-CIV-EMERGENCE-002
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-EMERGENCE-002 contributes to the overall simulation capability by addressing: Emergence metrics.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-emergence-002-spec.md` |
| ADR | `fr-civ-emergence-002-adr.md` |
| Research | `fr-civ-emergence-002-research.md` |
| Plan | `fr-civ-emergence-002-plan.md` |
