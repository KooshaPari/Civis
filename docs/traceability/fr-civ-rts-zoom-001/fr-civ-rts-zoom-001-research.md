# Research: FR-CIV-RTS-ZOOM-001 -- RTS zoom
...
What is the best approach to implement RTS zoom within the Civis simulation engine?

## Background

This FR belongs to the FR-CIV-RTS-ZOOM epic and is expected to be implemented in `crates/protocol-3d/src/`.
