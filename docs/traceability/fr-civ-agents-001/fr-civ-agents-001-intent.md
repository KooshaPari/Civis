# Intent: FR-CIV-AGENTS-001 -- Agent systems
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-AGENTS-001 contributes to the overall simulation capability by addressing: Agent systems.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-agents-001-spec.md` |
| ADR | `fr-civ-agents-001-adr.md` |
| Research | `fr-civ-agents-001-research.md` |
| Plan | `fr-civ-agents-001-plan.md` |
