...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-DIPL-004 contributes to the overall simulation capability by addressing: Diplomacy.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-dipl-004-spec.md` |
| ADR | `fr-dipl-004-adr.md` |
| Research | `fr-dipl-004-research.md` |
| Plan | `fr-dipl-004-plan.md` |
