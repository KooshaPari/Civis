# Intent: FR-SESSION-030 -- Session management
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-SESSION-030 contributes to the overall simulation capability by addressing: Session management.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-session-030-spec.md` |
| ADR | `fr-session-030-adr.md` |
| Research | `fr-session-030-research.md` |
| Plan | `fr-session-030-plan.md` |
