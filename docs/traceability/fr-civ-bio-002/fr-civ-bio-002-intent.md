# Intent: FR-CIV-BIO-002 -- Biological simulation
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-BIO-002 contributes to the overall simulation capability by addressing: Biological simulation.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-bio-002-spec.md` |
| ADR | `fr-civ-bio-002-adr.md` |
| Research | `fr-civ-bio-002-research.md` |
| Plan | `fr-civ-bio-002-plan.md` |
