# Intent: FR-SESSION-012 -- Session management
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-SESSION-012 contributes to the overall simulation capability by addressing: Session management.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-session-012-spec.md` |
| ADR | `fr-session-012-adr.md` |
| Research | `fr-session-012-research.md` |
| Plan | `fr-session-012-plan.md` |
