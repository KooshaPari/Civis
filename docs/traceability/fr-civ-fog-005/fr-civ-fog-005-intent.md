# Intent: FR-CIV-FOG-005 -- Fog of war
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-FOG-005 contributes to the overall simulation capability by addressing: Fog of war.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-fog-005-spec.md` |
| ADR | `fr-civ-fog-005-adr.md` |
| Research | `fr-civ-fog-005-research.md` |
| Plan | `fr-civ-fog-005-plan.md` |
