...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-ECON-010 contributes to the overall simulation capability by addressing: Economics.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-econ-010-spec.md` |
| ADR | `fr-econ-010-adr.md` |
| Research | `fr-econ-010-research.md` |
| Plan | `fr-econ-010-plan.md` |
