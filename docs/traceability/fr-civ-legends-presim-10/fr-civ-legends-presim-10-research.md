# Research: FR-CIV-LEGENDS-PRESIM-10 -- Civ Legends Presim
...
What is the best approach to implement Civ Legends Presim within the Civis simulation engine?

## Background

This FR belongs to the FR-CIV-LEGENDS-PRESIM epic and is expected to be implemented in `crates/legends/src/`.
