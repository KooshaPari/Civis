# Intent: FR-SESSION-022 -- Session management
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-SESSION-022 contributes to the overall simulation capability by addressing: Session management.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-session-022-spec.md` |
| ADR | `fr-session-022-adr.md` |
| Research | `fr-session-022-research.md` |
| Plan | `fr-session-022-plan.md` |
