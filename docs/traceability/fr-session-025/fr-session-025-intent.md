# Intent: FR-SESSION-025 -- Session management
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-SESSION-025 contributes to the overall simulation capability by addressing: Session management.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-session-025-spec.md` |
| ADR | `fr-session-025-adr.md` |
| Research | `fr-session-025-research.md` |
| Plan | `fr-session-025-plan.md` |
