# Intent: FR-SAVE-007 -- Save system
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-SAVE-007 contributes to the overall simulation capability by addressing: Save system.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-save-007-spec.md` |
| ADR | `fr-save-007-adr.md` |
| Research | `fr-save-007-research.md` |
| Plan | `fr-save-007-plan.md` |
