...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-ECO-002 contributes to the overall simulation capability by addressing: Economy.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-eco-002-spec.md` |
| ADR | `fr-eco-002-adr.md` |
| Research | `fr-eco-002-research.md` |
| Plan | `fr-eco-002-plan.md` |
