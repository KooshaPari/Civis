# Intent: FR-SAVE-003 -- Save system
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-SAVE-003 contributes to the overall simulation capability by addressing: Save system.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-save-003-spec.md` |
| ADR | `fr-save-003-adr.md` |
| Research | `fr-save-003-research.md` |
| Plan | `fr-save-003-plan.md` |
