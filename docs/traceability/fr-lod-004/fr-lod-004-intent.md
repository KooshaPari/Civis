# Intent: FR-LOD-004 -- Level of detail
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-LOD-004 contributes to the overall simulation capability by addressing: Level of detail.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-lod-004-spec.md` |
| ADR | `fr-lod-004-adr.md` |
| Research | `fr-lod-004-research.md` |
| Plan | `fr-lod-004-plan.md` |
