# Intent: FR-CIV-INFOVIEW-913 -- Info views and inspectors

> Date: 2026-09-17
> FR: FR-CIV-INFOVIEW-913
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-INFOVIEW-913 contributes to the overall simulation capability by addressing: Info views and inspectors.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-infoview-913-spec.md` |
| ADR | `fr-civ-infoview-913-adr.md` |
| Research | `fr-civ-infoview-913-research.md` |
| Plan | `fr-civ-infoview-913-plan.md` |
