# Intent: FR-CIV-WEB-001 -- Web client
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-WEB-001 contributes to the overall simulation capability by addressing: Web client.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-web-001-spec.md` |
| ADR | `fr-civ-web-001-adr.md` |
| Research | `fr-civ-web-001-research.md` |
| Plan | `fr-civ-web-001-plan.md` |
