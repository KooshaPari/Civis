...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-QOL-210 contributes to the overall simulation capability by addressing: Civ Qol.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-qol-210-spec.md` |
| ADR | `fr-civ-qol-210-adr.md` |
| Research | `fr-civ-qol-210-research.md` |
| Plan | `fr-civ-qol-210-plan.md` |
