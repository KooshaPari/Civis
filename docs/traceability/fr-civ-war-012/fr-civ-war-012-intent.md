# Intent: FR-CIV-WAR-012 -- War and conflict
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-WAR-012 contributes to the overall simulation capability by addressing: War and conflict.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-war-012-spec.md` |
| ADR | `fr-civ-war-012-adr.md` |
| Research | `fr-civ-war-012-research.md` |
| Plan | `fr-civ-war-012-plan.md` |
