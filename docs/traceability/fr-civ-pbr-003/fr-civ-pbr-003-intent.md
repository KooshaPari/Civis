# Intent: FR-CIV-PBR-003 -- Physically based rendering
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-PBR-003 contributes to the overall simulation capability by addressing: Physically based rendering.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-pbr-003-spec.md` |
| ADR | `fr-civ-pbr-003-adr.md` |
| Research | `fr-civ-pbr-003-research.md` |
| Plan | `fr-civ-pbr-003-plan.md` |
