# Intent: FR-CIV-RTS-003 -- RTS gameplay
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-RTS-003 contributes to the overall simulation capability by addressing: RTS gameplay.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-rts-003-spec.md` |
| ADR | `fr-civ-rts-003-adr.md` |
| Research | `fr-civ-rts-003-research.md` |
| Plan | `fr-civ-rts-003-plan.md` |
