# Intent: FR-CIV-ARCH-001 -- Architecture and crate design
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-ARCH-001 contributes to the overall simulation capability by addressing: Architecture and crate design.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-arch-001-spec.md` |
| ADR | `fr-civ-arch-001-adr.md` |
| Research | `fr-civ-arch-001-research.md` |
| Plan | `fr-civ-arch-001-plan.md` |
