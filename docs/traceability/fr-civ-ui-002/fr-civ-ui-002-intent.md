# Intent: FR-CIV-UI-002 -- User interface
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-UI-002 contributes to the overall simulation capability by addressing: User interface.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-ui-002-spec.md` |
| ADR | `fr-civ-ui-002-adr.md` |
| Research | `fr-civ-ui-002-research.md` |
| Plan | `fr-civ-ui-002-plan.md` |
