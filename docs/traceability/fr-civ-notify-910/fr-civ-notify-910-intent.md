# Intent: FR-CIV-NOTIFY-910 -- Notification system
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-NOTIFY-910 contributes to the overall simulation capability by addressing: Notification system.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-notify-910-spec.md` |
| ADR | `fr-civ-notify-910-adr.md` |
| Research | `fr-civ-notify-910-research.md` |
| Plan | `fr-civ-notify-910-plan.md` |
