# Intent: FR-CIV-WEB-004 -- Web client
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-WEB-004 contributes to the overall simulation capability by addressing: Web client.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-web-004-spec.md` |
| ADR | `fr-civ-web-004-adr.md` |
| Research | `fr-civ-web-004-research.md` |
| Plan | `fr-civ-web-004-plan.md` |
