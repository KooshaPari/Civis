# ADR: FR-CIV-VOXEL-023 -- Voxel rendering

> Status: Proposed
> Date: 2026-09-17
> Deciders: CivLab
> Relates to: FR-CIV-VOXEL-023
> Epic: FR-CIV-VOXEL

## Context

FR-CIV-VOXEL-023 is part of the FR-CIV-VOXEL epic. This functional requirement captures: Voxel rendering.
...
TBD -- The architectural decision for FR-CIV-VOXEL-023 needs to be finalized based on implementation exploration.
