# Intent: FR-CIV-PROTO-015 -- 3D protocol
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-PROTO-015 contributes to the overall simulation capability by addressing: 3D protocol.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-proto-015-spec.md` |
| ADR | `fr-civ-proto-015-adr.md` |
| Research | `fr-civ-proto-015-research.md` |
| Plan | `fr-civ-proto-015-plan.md` |
