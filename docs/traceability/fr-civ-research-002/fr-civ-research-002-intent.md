# Intent: FR-CIV-RESEARCH-002 -- Technology research
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-RESEARCH-002 contributes to the overall simulation capability by addressing: Technology research.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-research-002-spec.md` |
| ADR | `fr-civ-research-002-adr.md` |
| Research | `fr-civ-research-002-research.md` |
| Plan | `fr-civ-research-002-plan.md` |
