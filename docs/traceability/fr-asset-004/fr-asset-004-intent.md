...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-ASSET-004 contributes to the overall simulation capability by addressing: Asset.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-asset-004-spec.md` |
| ADR | `fr-asset-004-adr.md` |
| Research | `fr-asset-004-research.md` |
| Plan | `fr-asset-004-plan.md` |
