# Intent: FR-CIV-VOXEL-023 -- Voxel rendering
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-VOXEL-023 contributes to the overall simulation capability by addressing: Voxel rendering.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-voxel-023-spec.md` |
| ADR | `fr-civ-voxel-023-adr.md` |
| Research | `fr-civ-voxel-023-research.md` |
| Plan | `fr-civ-voxel-023-plan.md` |
