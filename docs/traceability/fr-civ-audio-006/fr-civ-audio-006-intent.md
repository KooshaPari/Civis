# Intent: FR-CIV-AUDIO-006 -- Audio system
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-AUDIO-006 contributes to the overall simulation capability by addressing: Audio system.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-audio-006-spec.md` |
| ADR | `fr-civ-audio-006-adr.md` |
| Research | `fr-civ-audio-006-research.md` |
| Plan | `fr-civ-audio-006-plan.md` |
