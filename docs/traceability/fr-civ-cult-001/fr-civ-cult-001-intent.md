# Intent: FR-CIV-CULT-001 -- Culture system
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-CULT-001 contributes to the overall simulation capability by addressing: Culture system.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-cult-001-spec.md` |
| ADR | `fr-civ-cult-001-adr.md` |
| Research | `fr-civ-cult-001-research.md` |
| Plan | `fr-civ-cult-001-plan.md` |
