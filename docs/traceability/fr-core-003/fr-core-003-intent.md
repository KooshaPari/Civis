# Intent: FR-CORE-003 -- Core system
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CORE-003 contributes to the overall simulation capability by addressing: Core system.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-core-003-spec.md` |
| ADR | `fr-core-003-adr.md` |
| Research | `fr-core-003-research.md` |
| Plan | `fr-core-003-plan.md` |
