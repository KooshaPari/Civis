# Intent: FR-CIV-CA-006 -- Combat and military
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-CA-006 contributes to the overall simulation capability by addressing: Combat and military.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-ca-006-spec.md` |
| ADR | `fr-civ-ca-006-adr.md` |
| Research | `fr-civ-ca-006-research.md` |
| Plan | `fr-civ-ca-006-plan.md` |
