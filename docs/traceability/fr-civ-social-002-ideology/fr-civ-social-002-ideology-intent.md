# Intent: FR-CIV-SOCIAL-002-IDEOLOGY -- Social systems

> Date: 2026-09-17
> FR: FR-CIV-SOCIAL-002-IDEOLOGY
> Epic: FR-CIV-SOCIAL
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-SOCIAL-002-IDEOLOGY contributes to the overall simulation capability by addressing: Social systems.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-social-002-ideology-spec.md` |
| ADR | `fr-civ-social-002-ideology-adr.md` |
| Research | `fr-civ-social-002-ideology-research.md` |
| Plan | `fr-civ-social-002-ideology-plan.md` |
