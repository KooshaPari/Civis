# Intent: FR-CIV-ACT-003 -- Actor lifecycle
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-ACT-003 contributes to the overall simulation capability by addressing: Actor lifecycle.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-act-003-spec.md` |
| ADR | `fr-civ-act-003-adr.md` |
| Research | `fr-civ-act-003-research.md` |
| Plan | `fr-civ-act-003-plan.md` |
