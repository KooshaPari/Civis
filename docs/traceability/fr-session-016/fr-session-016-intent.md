# Intent: FR-SESSION-016 -- Session management
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-SESSION-016 contributes to the overall simulation capability by addressing: Session management.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-session-016-spec.md` |
| ADR | `fr-session-016-adr.md` |
| Research | `fr-session-016-research.md` |
| Plan | `fr-session-016-plan.md` |
