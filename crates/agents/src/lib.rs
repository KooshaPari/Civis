//! civ-agents — Civilian agent ECS components + LOD tick + per-civilian wardrobe/tools state
//!
...
//!
//! Functional requirements: FR-CIV-AGENTS-*
...
mod stub_tests {
    ...
    /// FR-CIV-AGENTS-000 — crate compiles and exposes a schema version.
