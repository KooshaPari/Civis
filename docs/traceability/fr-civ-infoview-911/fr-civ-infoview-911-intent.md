# Intent: FR-CIV-INFOVIEW-911 -- Info views and inspectors

> Date: 2026-09-17
> FR: FR-CIV-INFOVIEW-911
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-INFOVIEW-911 contributes to the overall simulation capability by addressing: Info views and inspectors.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-infoview-911-spec.md` |
| ADR | `fr-civ-infoview-911-adr.md` |
| Research | `fr-civ-infoview-911-research.md` |
| Plan | `fr-civ-infoview-911-plan.md` |
