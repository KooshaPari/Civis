...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-SOCI-006 contributes to the overall simulation capability by addressing: Sociology.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-soci-006-spec.md` |
| ADR | `fr-soci-006-adr.md` |
| Research | `fr-soci-006-research.md` |
| Plan | `fr-soci-006-plan.md` |
