# Intent: FR-CIV-PERF-020 -- Performance
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-PERF-020 contributes to the overall simulation capability by addressing: Performance.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-perf-020-spec.md` |
| ADR | `fr-civ-perf-020-adr.md` |
| Research | `fr-civ-perf-020-research.md` |
| Plan | `fr-civ-perf-020-plan.md` |
