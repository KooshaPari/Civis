...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-SESS-006 contributes to the overall simulation capability by addressing: Session.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-sess-006-spec.md` |
| ADR | `fr-sess-006-adr.md` |
| Research | `fr-sess-006-research.md` |
| Plan | `fr-sess-006-plan.md` |
