# Intent: FR-CIV-PROTO3D -- Core civilisation simulation
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-PROTO3D contributes to the overall simulation capability by addressing: Core civilisation simulation.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-proto3d-spec.md` |
| ADR | `fr-civ-proto3d-adr.md` |
| Research | `fr-civ-proto3d-research.md` |
| Plan | `fr-civ-proto3d-plan.md` |
