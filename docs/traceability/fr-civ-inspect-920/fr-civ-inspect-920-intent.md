# Intent: FR-CIV-INSPECT-920 -- Inspection tools
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-INSPECT-920 contributes to the overall simulation capability by addressing: Inspection tools.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-inspect-920-spec.md` |
| ADR | `fr-civ-inspect-920-adr.md` |
| Research | `fr-civ-inspect-920-research.md` |
| Plan | `fr-civ-inspect-920-plan.md` |
