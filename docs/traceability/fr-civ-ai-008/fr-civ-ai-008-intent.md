# Intent: FR-CIV-AI-008 -- Artificial intelligence
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-AI-008 contributes to the overall simulation capability by addressing: Artificial intelligence.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-ai-008-spec.md` |
| ADR | `fr-civ-ai-008-adr.md` |
| Research | `fr-civ-ai-008-research.md` |
| Plan | `fr-civ-ai-008-plan.md` |
