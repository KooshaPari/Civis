...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-PROT-004 contributes to the overall simulation capability by addressing: Protocol.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-prot-004-spec.md` |
| ADR | `fr-prot-004-adr.md` |
| Research | `fr-prot-004-research.md` |
| Plan | `fr-prot-004-plan.md` |
