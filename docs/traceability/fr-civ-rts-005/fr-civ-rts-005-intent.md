# Intent: FR-CIV-RTS-005 -- RTS gameplay
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-RTS-005 contributes to the overall simulation capability by addressing: RTS gameplay.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-rts-005-spec.md` |
| ADR | `fr-civ-rts-005-adr.md` |
| Research | `fr-civ-rts-005-research.md` |
| Plan | `fr-civ-rts-005-plan.md` |
