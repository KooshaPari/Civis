...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-DET-007 contributes to the overall simulation capability by addressing: Determinism.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-det-007-spec.md` |
| ADR | `fr-det-007-adr.md` |
| Research | `fr-det-007-research.md` |
| Plan | `fr-det-007-plan.md` |
