# Intent: FR-SOC-DET-001 -- Social determinism
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-SOC-DET-001 contributes to the overall simulation capability by addressing: Social determinism.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-soc-det-001-spec.md` |
| ADR | `fr-soc-det-001-adr.md` |
| Research | `fr-soc-det-001-research.md` |
| Plan | `fr-soc-det-001-plan.md` |
