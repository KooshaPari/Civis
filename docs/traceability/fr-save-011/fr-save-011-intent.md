# Intent: FR-SAVE-011 -- Save system
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-SAVE-011 contributes to the overall simulation capability by addressing: Save system.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-save-011-spec.md` |
| ADR | `fr-save-011-adr.md` |
| Research | `fr-save-011-research.md` |
| Plan | `fr-save-011-plan.md` |
