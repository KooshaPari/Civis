...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-QOL-100 contributes to the overall simulation capability by addressing: Civ Qol.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-qol-100-spec.md` |
| ADR | `fr-civ-qol-100-adr.md` |
| Research | `fr-civ-qol-100-research.md` |
| Plan | `fr-civ-qol-100-plan.md` |
