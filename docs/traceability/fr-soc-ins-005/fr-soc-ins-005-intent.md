# Intent: FR-SOC-INS-005 -- Social institution
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-SOC-INS-005 contributes to the overall simulation capability by addressing: Social institution.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-soc-ins-005-spec.md` |
| ADR | `fr-soc-ins-005-adr.md` |
| Research | `fr-soc-ins-005-research.md` |
| Plan | `fr-soc-ins-005-plan.md` |
