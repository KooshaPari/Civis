# Research: FR-CIV-PERF-BUILD-001 -- Civ Perf Build
...
What is the best approach to implement Civ Perf Build within the Civis simulation engine?

## Background

This FR belongs to the FR-CIV-PERF-BUILD epic and is expected to be implemented in `crates/engine/src/`.
