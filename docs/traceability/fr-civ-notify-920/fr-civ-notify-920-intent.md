# Intent: FR-CIV-NOTIFY-920 -- Notification system

> Date: 2026-09-17
> FR: FR-CIV-NOTIFY-920
> Epic: FR-CIV-NOTIFY
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-NOTIFY-920 contributes to the overall simulation capability by addressing: Notification system.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-notify-920-spec.md` |
| ADR | `fr-civ-notify-920-adr.md` |
| Research | `fr-civ-notify-920-research.md` |
| Plan | `fr-civ-notify-920-plan.md` |
