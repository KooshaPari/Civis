# Intent: FR-CIV-TECH-007 -- Technology tree
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-TECH-007 contributes to the overall simulation capability by addressing: Technology tree.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-tech-007-spec.md` |
| ADR | `fr-civ-tech-007-adr.md` |
| Research | `fr-civ-tech-007-research.md` |
| Plan | `fr-civ-tech-007-plan.md` |
