# Intent: FR-CIV-VERIFY-006 -- Verification harness
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-VERIFY-006 contributes to the overall simulation capability by addressing: Verification harness.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-verify-006-spec.md` |
| ADR | `fr-civ-verify-006-adr.md` |
| Research | `fr-civ-verify-006-research.md` |
| Plan | `fr-civ-verify-006-plan.md` |
