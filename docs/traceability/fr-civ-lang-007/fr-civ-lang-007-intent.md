# Intent: FR-CIV-LANG-007 -- Language and naming
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-LANG-007 contributes to the overall simulation capability by addressing: Language and naming.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-lang-007-spec.md` |
| ADR | `fr-civ-lang-007-adr.md` |
| Research | `fr-civ-lang-007-research.md` |
| Plan | `fr-civ-lang-007-plan.md` |
