# Intent: FR-CIV-VOXEL-006 -- Voxel rendering
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-VOXEL-006 contributes to the overall simulation capability by addressing: Voxel rendering.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-voxel-006-spec.md` |
| ADR | `fr-civ-voxel-006-adr.md` |
| Research | `fr-civ-voxel-006-research.md` |
| Plan | `fr-civ-voxel-006-plan.md` |
