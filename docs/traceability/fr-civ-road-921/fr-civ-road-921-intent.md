# Intent: FR-CIV-ROAD-921 -- Road and path systems
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-ROAD-921 contributes to the overall simulation capability by addressing: Road and path systems.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-road-921-spec.md` |
| ADR | `fr-civ-road-921-adr.md` |
| Research | `fr-civ-road-921-research.md` |
| Plan | `fr-civ-road-921-plan.md` |
