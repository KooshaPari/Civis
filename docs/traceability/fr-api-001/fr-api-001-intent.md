...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-API-001 contributes to the overall simulation capability by addressing: API.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-api-001-spec.md` |
| ADR | `fr-api-001-adr.md` |
| Research | `fr-api-001-research.md` |
| Plan | `fr-api-001-plan.md` |
