# Intent: FR-SOC-INS-002 -- Social institution
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-SOC-INS-002 contributes to the overall simulation capability by addressing: Social institution.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-soc-ins-002-spec.md` |
| ADR | `fr-soc-ins-002-adr.md` |
| Research | `fr-soc-ins-002-research.md` |
| Plan | `fr-soc-ins-002-plan.md` |
