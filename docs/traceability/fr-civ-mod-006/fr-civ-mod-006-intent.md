# Intent: FR-CIV-MOD-006 -- Mod system (WASM)
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-MOD-006 contributes to the overall simulation capability by addressing: Mod system (WASM).
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-mod-006-spec.md` |
| ADR | `fr-civ-mod-006-adr.md` |
| Research | `fr-civ-mod-006-research.md` |
| Plan | `fr-civ-mod-006-plan.md` |
