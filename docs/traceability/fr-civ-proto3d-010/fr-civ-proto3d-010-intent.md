# Intent: FR-CIV-PROTO3D-010 -- Core civilisation simulation

> Date: 2026-09-17
> FR: FR-CIV-PROTO3D-010
> Epic: FR-CIV
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-PROTO3D-010 contributes to the overall simulation capability by addressing: Core civilisation simulation.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-proto3d-010-spec.md` |
| ADR | `fr-civ-proto3d-010-adr.md` |
| Research | `fr-civ-proto3d-010-research.md` |
| Plan | `fr-civ-proto3d-010-plan.md` |
