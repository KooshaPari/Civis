# Intent: FR-CIV-3D-002 -- Core civilisation simulation
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-3D-002 contributes to the overall simulation capability by addressing: Core civilisation simulation.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-3d-002-spec.md` |
| ADR | `fr-civ-3d-002-adr.md` |
| Research | `fr-civ-3d-002-research.md` |
| Plan | `fr-civ-3d-002-plan.md` |
