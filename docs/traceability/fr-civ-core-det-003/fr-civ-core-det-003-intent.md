# Intent: FR-CIV-CORE-DET-003 -- Determinism guarantees

> Date: 2026-09-17
> FR: FR-CIV-CORE-DET-003
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-CORE-DET-003 contributes to the overall simulation capability by addressing: Determinism guarantees.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-core-det-003-spec.md` |
| ADR | `fr-civ-core-det-003-adr.md` |
| Research | `fr-civ-core-det-003-research.md` |
| Plan | `fr-civ-core-det-003-plan.md` |
