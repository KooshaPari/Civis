# Intent: FR-CIV-TRAFFIC-LANE-001 -- Traffic lanes
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-TRAFFIC-LANE-001 contributes to the overall simulation capability by addressing: Traffic lanes.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-traffic-lane-001-spec.md` |
| ADR | `fr-civ-traffic-lane-001-adr.md` |
| Research | `fr-civ-traffic-lane-001-research.md` |
| Plan | `fr-civ-traffic-lane-001-plan.md` |
