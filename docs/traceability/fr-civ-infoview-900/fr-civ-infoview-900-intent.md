# Intent: FR-CIV-INFOVIEW-900 -- Info views and inspectors
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-INFOVIEW-900 contributes to the overall simulation capability by addressing: Info views and inspectors.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-infoview-900-spec.md` |
| ADR | `fr-civ-infoview-900-adr.md` |
| Research | `fr-civ-infoview-900-research.md` |
| Plan | `fr-civ-infoview-900-plan.md` |
