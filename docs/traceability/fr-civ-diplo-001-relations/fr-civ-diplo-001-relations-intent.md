# Intent: FR-CIV-DIPLO-001-RELATIONS -- Diplomacy and treaties

> Date: 2026-09-17
> FR: FR-CIV-DIPLO-001-RELATIONS
> Epic: FR-CIV-DIPLO
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-DIPLO-001-RELATIONS contributes to the overall simulation capability by addressing: Diplomacy and treaties.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-diplo-001-relations-spec.md` |
| ADR | `fr-civ-diplo-001-relations-adr.md` |
| Research | `fr-civ-diplo-001-relations-research.md` |
| Plan | `fr-civ-diplo-001-relations-plan.md` |
