//! civ-species — Phenotype expression: DNA → morphology + behavior weights; multi-species tagging
//!
...
//!
//! Functional requirements: FR-CIV-SPECIES-*
...
mod stub_tests {
    ...
    /// FR-CIV-SPECIES-000 — crate compiles and exposes a schema version.
