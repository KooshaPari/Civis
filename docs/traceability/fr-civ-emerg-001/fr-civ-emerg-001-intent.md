# Intent: FR-CIV-EMERG-001 -- Emergence mechanics
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-EMERG-001 contributes to the overall simulation capability by addressing: Emergence mechanics.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-emerg-001-spec.md` |
| ADR | `fr-civ-emerg-001-adr.md` |
| Research | `fr-civ-emerg-001-research.md` |
| Plan | `fr-civ-emerg-001-plan.md` |
