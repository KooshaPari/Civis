# Intent: FR-CIV-LANG-006 -- Language and naming
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-LANG-006 contributes to the overall simulation capability by addressing: Language and naming.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-lang-006-spec.md` |
| ADR | `fr-civ-lang-006-adr.md` |
| Research | `fr-civ-lang-006-research.md` |
| Plan | `fr-civ-lang-006-plan.md` |
