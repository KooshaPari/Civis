# Intent: FR-CIV-AUDIO-012 -- Audio system
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-AUDIO-012 contributes to the overall simulation capability by addressing: Audio system.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-audio-012-spec.md` |
| ADR | `fr-civ-audio-012-adr.md` |
| Research | `fr-civ-audio-012-research.md` |
| Plan | `fr-civ-audio-012-plan.md` |
