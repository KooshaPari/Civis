# Intent: FR-SAVE-020 -- Save system
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-SAVE-020 contributes to the overall simulation capability by addressing: Save system.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-save-020-spec.md` |
| ADR | `fr-save-020-adr.md` |
| Research | `fr-save-020-research.md` |
| Plan | `fr-save-020-plan.md` |
