# Intent: FR-CIV-CA-003 -- Combat and military
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-CA-003 contributes to the overall simulation capability by addressing: Combat and military.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-ca-003-spec.md` |
| ADR | `fr-civ-ca-003-adr.md` |
| Research | `fr-civ-ca-003-research.md` |
| Plan | `fr-civ-ca-003-plan.md` |
