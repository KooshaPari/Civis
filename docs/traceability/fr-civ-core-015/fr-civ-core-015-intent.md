# Intent: FR-CIV-CORE-015 -- Core simulation engine
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-CORE-015 contributes to the overall simulation capability by addressing: Core simulation engine.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-core-015-spec.md` |
| ADR | `fr-civ-core-015-adr.md` |
| Research | `fr-civ-core-015-research.md` |
| Plan | `fr-civ-core-015-plan.md` |
