# Intent: FR-CIV-RTS-RENDER-003 -- RTS rendering
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-RTS-RENDER-003 contributes to the overall simulation capability by addressing: RTS rendering.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-rts-render-003-spec.md` |
| ADR | `fr-civ-rts-render-003-adr.md` |
| Research | `fr-civ-rts-render-003-research.md` |
| Plan | `fr-civ-rts-render-003-plan.md` |
