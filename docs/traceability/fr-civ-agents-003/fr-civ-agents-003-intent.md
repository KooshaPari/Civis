# Intent: FR-CIV-AGENTS-003 -- Agent systems

> Date: 2026-09-17
> FR: FR-CIV-AGENTS-003
> Epic: FR-CIV-AGENTS
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-AGENTS-003 contributes to the overall simulation capability by addressing: Agent systems.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-agents-003-spec.md` |
| ADR | `fr-civ-agents-003-adr.md` |
| Research | `fr-civ-agents-003-research.md` |
| Plan | `fr-civ-agents-003-plan.md` |
