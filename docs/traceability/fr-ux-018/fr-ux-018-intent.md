# Intent: FR-UX-018 -- User experience
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-UX-018 contributes to the overall simulation capability by addressing: User experience.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-ux-018-spec.md` |
| ADR | `fr-ux-018-adr.md` |
| Research | `fr-ux-018-research.md` |
| Plan | `fr-ux-018-plan.md` |
