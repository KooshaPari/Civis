# Intent: FR-CIV-BRUSH-13 -- Terrain brush tools
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-BRUSH-13 contributes to the overall simulation capability by addressing: Terrain brush tools.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-brush-13-spec.md` |
| ADR | `fr-civ-brush-13-adr.md` |
| Research | `fr-civ-brush-13-research.md` |
| Plan | `fr-civ-brush-13-plan.md` |
