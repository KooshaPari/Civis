# Intent: FR-SAVE-019 -- Save system
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-SAVE-019 contributes to the overall simulation capability by addressing: Save system.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-save-019-spec.md` |
| ADR | `fr-save-019-adr.md` |
| Research | `fr-save-019-research.md` |
| Plan | `fr-save-019-plan.md` |
