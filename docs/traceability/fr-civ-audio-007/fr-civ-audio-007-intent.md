# Intent: FR-CIV-AUDIO-007 -- Audio system
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-AUDIO-007 contributes to the overall simulation capability by addressing: Audio system.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-audio-007-spec.md` |
| ADR | `fr-civ-audio-007-adr.md` |
| Research | `fr-civ-audio-007-research.md` |
| Plan | `fr-civ-audio-007-plan.md` |
