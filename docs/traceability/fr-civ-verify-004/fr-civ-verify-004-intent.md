# Intent: FR-CIV-VERIFY-004 -- Verification harness

> Date: 2026-09-17
> FR: FR-CIV-VERIFY-004
> Epic: FR-CIV-VERIFY
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-VERIFY-004 contributes to the overall simulation capability by addressing: Verification harness.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-verify-004-spec.md` |
| ADR | `fr-civ-verify-004-adr.md` |
| Research | `fr-civ-verify-004-research.md` |
| Plan | `fr-civ-verify-004-plan.md` |
