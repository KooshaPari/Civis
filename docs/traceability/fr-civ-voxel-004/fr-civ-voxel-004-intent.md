# Intent: FR-CIV-VOXEL-004 -- Voxel rendering
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-VOXEL-004 contributes to the overall simulation capability by addressing: Voxel rendering.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-voxel-004-spec.md` |
| ADR | `fr-civ-voxel-004-adr.md` |
| Research | `fr-civ-voxel-004-research.md` |
| Plan | `fr-civ-voxel-004-plan.md` |
