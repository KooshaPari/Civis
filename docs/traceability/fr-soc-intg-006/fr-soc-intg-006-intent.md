# Intent: FR-SOC-INTG-006 -- Social integration
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-SOC-INTG-006 contributes to the overall simulation capability by addressing: Social integration.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-soc-intg-006-spec.md` |
| ADR | `fr-soc-intg-006-adr.md` |
| Research | `fr-soc-intg-006-research.md` |
| Plan | `fr-soc-intg-006-plan.md` |
