# Intent: FR-NFR-R-03 -- Reliability placeholder (deprecated)
...
`assert!(ws.tick == 0)` stub (`crates/engine/tests/fr_nfr_r_03.rs`)
...
| Artifact | Path |
|----------|------|
| Stub (removed) | `crates/engine/tests/fr_nfr_r_03.rs` |
