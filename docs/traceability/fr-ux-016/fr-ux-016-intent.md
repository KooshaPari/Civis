# Intent: FR-UX-016 -- User experience
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-UX-016 contributes to the overall simulation capability by addressing: User experience.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-ux-016-spec.md` |
| ADR | `fr-ux-016-adr.md` |
| Research | `fr-ux-016-research.md` |
| Plan | `fr-ux-016-plan.md` |
