# Intent: FR-CIV-SPECIES-203 -- Species definitions
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-SPECIES-203 contributes to the overall simulation capability by addressing: Species definitions.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-species-203-spec.md` |
| ADR | `fr-civ-species-203-adr.md` |
| Research | `fr-civ-species-203-research.md` |
| Plan | `fr-civ-species-203-plan.md` |
