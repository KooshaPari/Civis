# Intent: FR-CIV-FOG-003 -- Fog of war
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-FOG-003 contributes to the overall simulation capability by addressing: Fog of war.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-fog-003-spec.md` |
| ADR | `fr-civ-fog-003-adr.md` |
| Research | `fr-civ-fog-003-research.md` |
| Plan | `fr-civ-fog-003-plan.md` |
