...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-SOCI-001 contributes to the overall simulation capability by addressing: Sociology.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-soci-001-spec.md` |
| ADR | `fr-soci-001-adr.md` |
| Research | `fr-soci-001-research.md` |
| Plan | `fr-soci-001-plan.md` |
