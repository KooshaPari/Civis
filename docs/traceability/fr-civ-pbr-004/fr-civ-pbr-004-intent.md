# Intent: FR-CIV-PBR-004 -- Physically based rendering
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-PBR-004 contributes to the overall simulation capability by addressing: Physically based rendering.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-pbr-004-spec.md` |
| ADR | `fr-civ-pbr-004-adr.md` |
| Research | `fr-civ-pbr-004-research.md` |
| Plan | `fr-civ-pbr-004-plan.md` |
