# Intent: FR-CIV-ACTOR-002 -- Actor and citizen lifecycle
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-ACTOR-002 contributes to the overall simulation capability by addressing: Actor and citizen lifecycle.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-actor-002-spec.md` |
| ADR | `fr-civ-actor-002-adr.md` |
| Research | `fr-civ-actor-002-research.md` |
| Plan | `fr-civ-actor-002-plan.md` |
