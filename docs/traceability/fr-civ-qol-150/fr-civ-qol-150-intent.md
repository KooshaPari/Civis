...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-QOL-150 contributes to the overall simulation capability by addressing: Civ Qol.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-qol-150-spec.md` |
| ADR | `fr-civ-qol-150-adr.md` |
| Research | `fr-civ-qol-150-research.md` |
| Plan | `fr-civ-qol-150-plan.md` |
