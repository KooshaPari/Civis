# Intent: FR-CIV-CLIMATE-001 -- Climate, weather, seasons

> Date: 2026-09-17
> FR: FR-CIV-CLIMATE-001
> Epic: FR-CIV-CLIMATE
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-CLIMATE-001 contributes to the overall simulation capability by addressing: Climate, weather, seasons.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-climate-001-spec.md` |
| ADR | `fr-civ-climate-001-adr.md` |
| Research | `fr-civ-climate-001-research.md` |
| Plan | `fr-civ-climate-001-plan.md` |
