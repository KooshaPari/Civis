# Intent: FR-CIV-CULT-002 -- Culture system
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-CULT-002 contributes to the overall simulation capability by addressing: Culture system.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-cult-002-spec.md` |
| ADR | `fr-civ-cult-002-adr.md` |
| Research | `fr-civ-cult-002-research.md` |
| Plan | `fr-civ-cult-002-plan.md` |
