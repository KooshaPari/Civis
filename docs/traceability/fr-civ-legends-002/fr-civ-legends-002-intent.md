# Intent: FR-CIV-LEGENDS-002 -- Legend and narrative system
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-LEGENDS-002 contributes to the overall simulation capability by addressing: Legend and narrative system.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-legends-002-spec.md` |
| ADR | `fr-civ-legends-002-adr.md` |
| Research | `fr-civ-legends-002-research.md` |
| Plan | `fr-civ-legends-002-plan.md` |
