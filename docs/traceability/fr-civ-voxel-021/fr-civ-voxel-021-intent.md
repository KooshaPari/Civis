# Intent: FR-CIV-VOXEL-021 -- Voxel rendering
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-VOXEL-021 contributes to the overall simulation capability by addressing: Voxel rendering.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-voxel-021-spec.md` |
| ADR | `fr-civ-voxel-021-adr.md` |
| Research | `fr-civ-voxel-021-research.md` |
| Plan | `fr-civ-voxel-021-plan.md` |
