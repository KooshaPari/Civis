# Intent: FR-CIV-SCALE-002 -- Scale and performance
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-SCALE-002 contributes to the overall simulation capability by addressing: Scale and performance.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-scale-002-spec.md` |
| ADR | `fr-civ-scale-002-adr.md` |
| Research | `fr-civ-scale-002-research.md` |
| Plan | `fr-civ-scale-002-plan.md` |
