...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-MOD-002 contributes to the overall simulation capability by addressing: Modding.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-mod-002-spec.md` |
| ADR | `fr-mod-002-adr.md` |
| Research | `fr-mod-002-research.md` |
| Plan | `fr-mod-002-plan.md` |
