# Intent: FR-CIV-3D-003 -- Core civilisation simulation
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-3D-003 contributes to the overall simulation capability by addressing: Core civilisation simulation.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-3d-003-spec.md` |
| ADR | `fr-civ-3d-003-adr.md` |
| Research | `fr-civ-3d-003-research.md` |
| Plan | `fr-civ-3d-003-plan.md` |
