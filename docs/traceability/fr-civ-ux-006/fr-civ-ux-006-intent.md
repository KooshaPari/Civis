# Intent: FR-CIV-UX-006 -- User experience
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-UX-006 contributes to the overall simulation capability by addressing: User experience.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-ux-006-spec.md` |
| ADR | `fr-civ-ux-006-adr.md` |
| Research | `fr-civ-ux-006-research.md` |
| Plan | `fr-civ-ux-006-plan.md` |
