# Intent: FR-CIV-POLITY-002 -- Polity system

> Date: 2026-09-17
> FR: FR-CIV-POLITY-002
> Epic: FR-CIV-POLITY
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-POLITY-002 contributes to the overall simulation capability by addressing: Polity system.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-polity-002-spec.md` |
| ADR | `fr-civ-polity-002-adr.md` |
| Research | `fr-civ-polity-002-research.md` |
| Plan | `fr-civ-polity-002-plan.md` |
