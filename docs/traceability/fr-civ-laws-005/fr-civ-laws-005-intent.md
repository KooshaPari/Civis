# Intent: FR-CIV-LAWS-005 -- Legal system
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-LAWS-005 contributes to the overall simulation capability by addressing: Legal system.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-laws-005-spec.md` |
| ADR | `fr-civ-laws-005-adr.md` |
| Research | `fr-civ-laws-005-research.md` |
| Plan | `fr-civ-laws-005-plan.md` |
