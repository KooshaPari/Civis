# Intent: FR-CIV-TERRAIN-001 -- Civ Terrain

> Date: 2026-09-17
> FR: FR-CIV-TERRAIN-001
> Epic: FR-CIV-TERRAIN
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-TERRAIN-001 contributes to the overall simulation capability by addressing: Civ Terrain.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-terrain-001-spec.md` |
| ADR | `fr-civ-terrain-001-adr.md` |
| Research | `fr-civ-terrain-001-research.md` |
| Plan | `fr-civ-terrain-001-plan.md` |
