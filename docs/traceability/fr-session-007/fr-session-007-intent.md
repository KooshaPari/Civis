# Intent: FR-SESSION-007 -- Session management
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-SESSION-007 contributes to the overall simulation capability by addressing: Session management.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-session-007-spec.md` |
| ADR | `fr-session-007-adr.md` |
| Research | `fr-session-007-research.md` |
| Plan | `fr-session-007-plan.md` |
