# Intent: FR-CORE-007 -- Core system
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CORE-007 contributes to the overall simulation capability by addressing: Core system.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-core-007-spec.md` |
| ADR | `fr-core-007-adr.md` |
| Research | `fr-core-007-research.md` |
| Plan | `fr-core-007-plan.md` |
