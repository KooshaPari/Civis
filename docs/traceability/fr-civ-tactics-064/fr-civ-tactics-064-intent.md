# Intent: FR-CIV-TACTICS-064 -- Tactics and strategy

> Date: 2026-09-17
> FR: FR-CIV-TACTICS-064
> Epic: FR-CIV-TACTICS
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-TACTICS-064 contributes to the overall simulation capability by addressing: Tactics and strategy.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-tactics-064-spec.md` |
| ADR | `fr-civ-tactics-064-adr.md` |
| Research | `fr-civ-tactics-064-research.md` |
| Plan | `fr-civ-tactics-064-plan.md` |
