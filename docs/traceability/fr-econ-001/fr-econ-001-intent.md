...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-ECON-001 contributes to the overall simulation capability by addressing: Economics.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-econ-001-spec.md` |
| ADR | `fr-econ-001-adr.md` |
| Research | `fr-econ-001-research.md` |
| Plan | `fr-econ-001-plan.md` |
