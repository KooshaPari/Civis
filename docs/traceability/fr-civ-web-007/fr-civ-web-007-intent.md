# Intent: FR-CIV-WEB-007 -- Web client
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-WEB-007 contributes to the overall simulation capability by addressing: Web client.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-web-007-spec.md` |
| ADR | `fr-civ-web-007-adr.md` |
| Research | `fr-civ-web-007-research.md` |
| Plan | `fr-civ-web-007-plan.md` |
