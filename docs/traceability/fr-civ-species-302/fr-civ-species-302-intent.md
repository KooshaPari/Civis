# Intent: FR-CIV-SPECIES-302 -- Species definitions

> Date: 2026-09-17
> FR: FR-CIV-SPECIES-302
> Epic: FR-CIV-SPECIES
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-SPECIES-302 contributes to the overall simulation capability by addressing: Species definitions.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-species-302-spec.md` |
| ADR | `fr-civ-species-302-adr.md` |
| Research | `fr-civ-species-302-research.md` |
| Plan | `fr-civ-species-302-plan.md` |
