# Intent: FR-CIV-RTS-008 -- RTS gameplay
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-RTS-008 contributes to the overall simulation capability by addressing: RTS gameplay.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-rts-008-spec.md` |
| ADR | `fr-civ-rts-008-adr.md` |
| Research | `fr-civ-rts-008-research.md` |
| Plan | `fr-civ-rts-008-plan.md` |
