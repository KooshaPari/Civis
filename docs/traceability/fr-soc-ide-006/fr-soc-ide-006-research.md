# Research: FR-SOC-IDE-006 -- Social ideology
...
What is the best approach to implement Social ideology within the Civis simulation engine?

## Background

This FR belongs to the FR-SOC-IDE epic and is expected to be implemented in `crates/civ-institutions/src/`.
