# Intent: FR-CIV-EMERGENCE-004 -- Emergence metrics
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-EMERGENCE-004 contributes to the overall simulation capability by addressing: Emergence metrics.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-emergence-004-spec.md` |
| ADR | `fr-civ-emergence-004-adr.md` |
| Research | `fr-civ-emergence-004-research.md` |
| Plan | `fr-civ-emergence-004-plan.md` |
