# Intent: FR-CIV-ACTOR-001-LIFECYCLE -- Actor and citizen lifecycle

> Date: 2026-09-17
> FR: FR-CIV-ACTOR-001-LIFECYCLE
> Epic: FR-CIV-ACTOR
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-ACTOR-001-LIFECYCLE contributes to the overall simulation capability by addressing: Actor and citizen lifecycle.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-actor-001-lifecycle-spec.md` |
| ADR | `fr-civ-actor-001-lifecycle-adr.md` |
| Research | `fr-civ-actor-001-lifecycle-research.md` |
| Plan | `fr-civ-actor-001-lifecycle-plan.md` |
