# Intent: FR-CIV-VOXEL-DIRTY-001 -- Dirty voxel tracking
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-VOXEL-DIRTY-001 contributes to the overall simulation capability by addressing: Dirty voxel tracking.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-voxel-dirty-001-spec.md` |
| ADR | `fr-civ-voxel-dirty-001-adr.md` |
| Research | `fr-civ-voxel-dirty-001-research.md` |
| Plan | `fr-civ-voxel-dirty-001-plan.md` |
