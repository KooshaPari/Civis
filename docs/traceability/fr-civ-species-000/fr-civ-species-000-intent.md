# Intent: FR-CIV-SPECIES-000 -- Species definitions
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-SPECIES-000 contributes to the overall simulation capability by addressing: Species definitions.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-species-000-spec.md` |
| ADR | `fr-civ-species-000-adr.md` |
| Research | `fr-civ-species-000-research.md` |
| Plan | `fr-civ-species-000-plan.md` |
