# Intent: FR-SESSION-019 -- Session management
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-SESSION-019 contributes to the overall simulation capability by addressing: Session management.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-session-019-spec.md` |
| ADR | `fr-session-019-adr.md` |
| Research | `fr-session-019-research.md` |
| Plan | `fr-session-019-plan.md` |
