# Intent: FR-CIV-DIFFUSION-000 -- Cultural diffusion
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-DIFFUSION-000 contributes to the overall simulation capability by addressing: Cultural diffusion.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-diffusion-000-spec.md` |
| ADR | `fr-civ-diffusion-000-adr.md` |
| Research | `fr-civ-diffusion-000-research.md` |
| Plan | `fr-civ-diffusion-000-plan.md` |
