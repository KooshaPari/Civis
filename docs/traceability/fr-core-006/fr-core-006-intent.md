# Intent: FR-CORE-006 -- Core system
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CORE-006 contributes to the overall simulation capability by addressing: Core system.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-core-006-spec.md` |
| ADR | `fr-core-006-adr.md` |
| Research | `fr-core-006-research.md` |
| Plan | `fr-core-006-plan.md` |
