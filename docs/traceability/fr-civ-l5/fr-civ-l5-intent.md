# Intent: FR-CIV-L5 -- Core civilisation simulation
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-L5 contributes to the overall simulation capability by addressing: Core civilisation simulation.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-l5-spec.md` |
| ADR | `fr-civ-l5-adr.md` |
| Research | `fr-civ-l5-research.md` |
| Plan | `fr-civ-l5-plan.md` |
