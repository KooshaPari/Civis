# Intent: FR-CIV-VOXEL-003 -- Voxel rendering
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-VOXEL-003 contributes to the overall simulation capability by addressing: Voxel rendering.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-voxel-003-spec.md` |
| ADR | `fr-civ-voxel-003-adr.md` |
| Research | `fr-civ-voxel-003-research.md` |
| Plan | `fr-civ-voxel-003-plan.md` |
