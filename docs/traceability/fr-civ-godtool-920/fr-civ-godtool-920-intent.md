# Intent: FR-CIV-GODTOOL-920 -- Civ Godtool

> Date: 2026-09-17
> FR: FR-CIV-GODTOOL-920
> Epic: FR-CIV-GODTOOL
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-GODTOOL-920 contributes to the overall simulation capability by addressing: Civ Godtool.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-godtool-920-spec.md` |
| ADR | `fr-civ-godtool-920-adr.md` |
| Research | `fr-civ-godtool-920-research.md` |
| Plan | `fr-civ-godtool-920-plan.md` |
