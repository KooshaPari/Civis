# Intent: FR-UX-004 -- User experience
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-UX-004 contributes to the overall simulation capability by addressing: User experience.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-ux-004-spec.md` |
| ADR | `fr-ux-004-adr.md` |
| Research | `fr-ux-004-research.md` |
| Plan | `fr-ux-004-plan.md` |
