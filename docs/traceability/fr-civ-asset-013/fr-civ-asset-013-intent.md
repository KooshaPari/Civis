# Intent: FR-CIV-ASSET-013 -- Asset pipeline
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-ASSET-013 contributes to the overall simulation capability by addressing: Asset pipeline.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-asset-013-spec.md` |
| ADR | `fr-civ-asset-013-adr.md` |
| Research | `fr-civ-asset-013-research.md` |
| Plan | `fr-civ-asset-013-plan.md` |
