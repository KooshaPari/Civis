# Intent: FR-SOC-HLT-002 -- Social health
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-SOC-HLT-002 contributes to the overall simulation capability by addressing: Social health.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-soc-hlt-002-spec.md` |
| ADR | `fr-soc-hlt-002-adr.md` |
| Research | `fr-soc-hlt-002-research.md` |
| Plan | `fr-soc-hlt-002-plan.md` |
