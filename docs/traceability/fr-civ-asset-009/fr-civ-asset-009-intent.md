# Intent: FR-CIV-ASSET-009 -- Asset pipeline
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-ASSET-009 contributes to the overall simulation capability by addressing: Asset pipeline.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-asset-009-spec.md` |
| ADR | `fr-civ-asset-009-adr.md` |
| Research | `fr-civ-asset-009-research.md` |
| Plan | `fr-civ-asset-009-plan.md` |
