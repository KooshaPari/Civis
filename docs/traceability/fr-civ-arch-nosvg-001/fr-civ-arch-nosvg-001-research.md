# Research: FR-CIV-ARCH-NOSVG-001 -- Civ Arch Nosvg
...
What is the best approach to implement Civ Arch Nosvg within the Civis simulation engine?

## Background

This FR belongs to the FR-CIV-ARCH-NOSVG epic and is expected to be implemented in `crates/engine/src/`.
