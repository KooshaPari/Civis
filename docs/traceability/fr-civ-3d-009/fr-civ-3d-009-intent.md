# Intent: FR-CIV-3D-009 -- Core civilisation simulation
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-3D-009 contributes to the overall simulation capability by addressing: Core civilisation simulation.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-3d-009-spec.md` |
| ADR | `fr-civ-3d-009-adr.md` |
| Research | `fr-civ-3d-009-research.md` |
| Plan | `fr-civ-3d-009-plan.md` |
