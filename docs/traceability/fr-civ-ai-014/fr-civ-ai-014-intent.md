# Intent: FR-CIV-AI-014 -- Artificial intelligence
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-AI-014 contributes to the overall simulation capability by addressing: Artificial intelligence.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-ai-014-spec.md` |
| ADR | `fr-civ-ai-014-adr.md` |
| Research | `fr-civ-ai-014-research.md` |
| Plan | `fr-civ-ai-014-plan.md` |
