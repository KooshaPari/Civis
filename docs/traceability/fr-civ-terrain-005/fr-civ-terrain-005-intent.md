# Intent: FR-CIV-TERRAIN-005 -- Civ Terrain

> Date: 2026-09-17
> FR: FR-CIV-TERRAIN-005
> Epic: FR-CIV-TERRAIN
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-TERRAIN-005 contributes to the overall simulation capability by addressing: Civ Terrain.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-terrain-005-spec.md` |
| ADR | `fr-civ-terrain-005-adr.md` |
| Research | `fr-civ-terrain-005-research.md` |
| Plan | `fr-civ-terrain-005-plan.md` |
