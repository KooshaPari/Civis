# Intent: FR-CIV-MARKET-001 -- Market dynamics

> Date: 2026-09-17
> FR: FR-CIV-MARKET-001
> Epic: FR-CIV-MARKET
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-MARKET-001 contributes to the overall simulation capability by addressing: Market dynamics.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-market-001-spec.md` |
| ADR | `fr-civ-market-001-adr.md` |
| Research | `fr-civ-market-001-research.md` |
| Plan | `fr-civ-market-001-plan.md` |
