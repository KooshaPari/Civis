...
use civ_emergence_metrics::{
    criticality_indicator, coupling_mi_estimate, novelty_score, CriticalityInputs, TileDashboard,
};
...
impl Simulation {
    ...
    fn sample_emergence_with_source(&mut self, source: Option<&CaGrid>) -> bool {
        ...
        let coupling_mi_value =
            coupling_mi_estimate(mi_material_faction_norm.unwrap_or(0.0), entropy_norm);
