# Research: FR-CIV-ASSET-MANI-001 -- Civ Asset Mani
...
What is the best approach to implement Civ Asset Mani within the Civis simulation engine?

## Background

This FR belongs to the FR-CIV-ASSET-MANI epic and is expected to be implemented in `crates/asset-pipeline/src/`.
