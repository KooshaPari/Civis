# Intent: FR-CIV-ARCH-003 -- Architecture and crate design
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-ARCH-003 contributes to the overall simulation capability by addressing: Architecture and crate design.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-arch-003-spec.md` |
| ADR | `fr-civ-arch-003-adr.md` |
| Research | `fr-civ-arch-003-research.md` |
| Plan | `fr-civ-arch-003-plan.md` |
