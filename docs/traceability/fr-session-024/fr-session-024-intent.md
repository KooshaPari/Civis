# Intent: FR-SESSION-024 -- Session management
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-SESSION-024 contributes to the overall simulation capability by addressing: Session management.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-session-024-spec.md` |
| ADR | `fr-session-024-adr.md` |
| Research | `fr-session-024-research.md` |
| Plan | `fr-session-024-plan.md` |
