...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-THRY-002 contributes to the overall simulation capability by addressing: Theory.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-thry-002-spec.md` |
| ADR | `fr-thry-002-adr.md` |
| Research | `fr-thry-002-research.md` |
| Plan | `fr-thry-002-plan.md` |
