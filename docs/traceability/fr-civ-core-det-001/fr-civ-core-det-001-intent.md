# Intent: FR-CIV-CORE-DET-001 -- Determinism guarantees

> Date: 2026-09-17
> FR: FR-CIV-CORE-DET-001
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-CORE-DET-001 contributes to the overall simulation capability by addressing: Determinism guarantees.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-core-det-001-spec.md` |
| ADR | `fr-civ-core-det-001-adr.md` |
| Research | `fr-civ-core-det-001-research.md` |
| Plan | `fr-civ-core-det-001-plan.md` |
