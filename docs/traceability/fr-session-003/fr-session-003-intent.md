# Intent: FR-SESSION-003 -- Session management
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-SESSION-003 contributes to the overall simulation capability by addressing: Session management.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-session-003-spec.md` |
| ADR | `fr-session-003-adr.md` |
| Research | `fr-session-003-research.md` |
| Plan | `fr-session-003-plan.md` |
