# Intent: FR-CIV-DIPLO-005 -- Diplomacy and treaties
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-DIPLO-005 contributes to the overall simulation capability by addressing: Diplomacy and treaties.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-diplo-005-spec.md` |
| ADR | `fr-civ-diplo-005-adr.md` |
| Research | `fr-civ-diplo-005-research.md` |
| Plan | `fr-civ-diplo-005-plan.md` |
