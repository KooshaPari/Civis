# Intent: FR-UX-003 -- User experience
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-UX-003 contributes to the overall simulation capability by addressing: User experience.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-ux-003-spec.md` |
| ADR | `fr-ux-003-adr.md` |
| Research | `fr-ux-003-research.md` |
| Plan | `fr-ux-003-plan.md` |
