# Intent: FR-CIV-DIFFUSION-015 -- Cultural diffusion
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-DIFFUSION-015 contributes to the overall simulation capability by addressing: Cultural diffusion.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-diffusion-015-spec.md` |
| ADR | `fr-civ-diffusion-015-adr.md` |
| Research | `fr-civ-diffusion-015-research.md` |
| Plan | `fr-civ-diffusion-015-plan.md` |
