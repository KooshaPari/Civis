# Intent: FR-CIV-SAVE-003 -- Save/load persistence
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-SAVE-003 contributes to the overall simulation capability by addressing: Save/load persistence.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-save-003-spec.md` |
| ADR | `fr-civ-save-003-adr.md` |
| Research | `fr-civ-save-003-research.md` |
| Plan | `fr-civ-save-003-plan.md` |
