...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-DET-004 contributes to the overall simulation capability by addressing: Determinism.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-det-004-spec.md` |
| ADR | `fr-det-004-adr.md` |
| Research | `fr-det-004-research.md` |
| Plan | `fr-det-004-plan.md` |
