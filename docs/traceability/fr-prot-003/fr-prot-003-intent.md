...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-PROT-003 contributes to the overall simulation capability by addressing: Protocol.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-prot-003-spec.md` |
| ADR | `fr-prot-003-adr.md` |
| Research | `fr-prot-003-research.md` |
| Plan | `fr-prot-003-plan.md` |
