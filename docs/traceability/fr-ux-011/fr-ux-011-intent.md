# Intent: FR-UX-011 -- User experience
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-UX-011 contributes to the overall simulation capability by addressing: User experience.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-ux-011-spec.md` |
| ADR | `fr-ux-011-adr.md` |
| Research | `fr-ux-011-research.md` |
| Plan | `fr-ux-011-plan.md` |
