# Intent: FR-INST-001 -- Institution
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-INST-001 contributes to the overall simulation capability by addressing: Institution.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-inst-001-spec.md` |
| ADR | `fr-inst-001-adr.md` |
| Research | `fr-inst-001-research.md` |
| Plan | `fr-inst-001-plan.md` |
