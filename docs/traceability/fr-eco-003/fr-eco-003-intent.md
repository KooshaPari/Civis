...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-ECO-003 contributes to the overall simulation capability by addressing: Economy.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-eco-003-spec.md` |
| ADR | `fr-eco-003-adr.md` |
| Research | `fr-eco-003-research.md` |
| Plan | `fr-eco-003-plan.md` |
