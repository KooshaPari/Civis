//! civ-research — LLM R&D proposal/validation pipeline; replay-safe hash-keyed cache
//!
...
//!
//! Functional requirements: FR-CIV-RESEARCH-*
...
mod stub_tests {
    ...
    /// FR-CIV-RESEARCH-000 — crate compiles and exposes a schema version.
