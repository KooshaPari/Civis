# Intent: FR-SESSION-006 -- Session management
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-SESSION-006 contributes to the overall simulation capability by addressing: Session management.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-session-006-spec.md` |
| ADR | `fr-session-006-adr.md` |
| Research | `fr-session-006-research.md` |
| Plan | `fr-session-006-plan.md` |
