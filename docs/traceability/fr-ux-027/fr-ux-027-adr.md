# ADR: FR-UX-027 -- User experience

> Status: Proposed
> Date: 2026-09-17
> Deciders: CivLab
> Relates to: FR-UX-027
> Epic: FR-UX

## Context

FR-UX-027 is part of the FR-UX epic. This functional requirement captures: User experience.
...
TBD -- The architectural decision for FR-UX-027 needs to be finalized based on implementation exploration.
