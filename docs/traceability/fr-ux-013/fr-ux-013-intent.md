# Intent: FR-UX-013 -- User experience
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-UX-013 contributes to the overall simulation capability by addressing: User experience.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-ux-013-spec.md` |
| ADR | `fr-ux-013-adr.md` |
| Research | `fr-ux-013-research.md` |
| Plan | `fr-ux-013-plan.md` |
