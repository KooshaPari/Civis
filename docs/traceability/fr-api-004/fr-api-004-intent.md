...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-API-004 contributes to the overall simulation capability by addressing: API.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-api-004-spec.md` |
| ADR | `fr-api-004-adr.md` |
| Research | `fr-api-004-research.md` |
| Plan | `fr-api-004-plan.md` |
