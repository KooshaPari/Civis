# Intent: FR-CIV-BUILD-015 -- Building tiers and construction
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-BUILD-015 contributes to the overall simulation capability by addressing: Building tiers and construction.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-build-015-spec.md` |
| ADR | `fr-civ-build-015-adr.md` |
| Research | `fr-civ-build-015-research.md` |
| Plan | `fr-civ-build-015-plan.md` |
