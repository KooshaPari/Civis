# Intent: FR-CORE-009 -- Core system
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CORE-009 contributes to the overall simulation capability by addressing: Core system.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-core-009-spec.md` |
| ADR | `fr-core-009-adr.md` |
| Research | `fr-core-009-research.md` |
| Plan | `fr-core-009-plan.md` |
