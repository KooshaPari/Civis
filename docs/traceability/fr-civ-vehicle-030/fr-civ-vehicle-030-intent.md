# Intent: FR-CIV-VEHICLE-030 -- Vehicle systems
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-VEHICLE-030 contributes to the overall simulation capability by addressing: Vehicle systems.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-vehicle-030-spec.md` |
| ADR | `fr-civ-vehicle-030-adr.md` |
| Research | `fr-civ-vehicle-030-research.md` |
| Plan | `fr-civ-vehicle-030-plan.md` |
