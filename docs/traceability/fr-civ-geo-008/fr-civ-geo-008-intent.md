# Intent: FR-CIV-GEO-008 -- Geological systems
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-GEO-008 contributes to the overall simulation capability by addressing: Geological systems.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-geo-008-spec.md` |
| ADR | `fr-civ-geo-008-adr.md` |
| Research | `fr-civ-geo-008-research.md` |
| Plan | `fr-civ-geo-008-plan.md` |
