# Intent: FR-CIV-DIFFUSION-012 -- Cultural diffusion
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-DIFFUSION-012 contributes to the overall simulation capability by addressing: Cultural diffusion.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-diffusion-012-spec.md` |
| ADR | `fr-civ-diffusion-012-adr.md` |
| Research | `fr-civ-diffusion-012-research.md` |
| Plan | `fr-civ-diffusion-012-plan.md` |
