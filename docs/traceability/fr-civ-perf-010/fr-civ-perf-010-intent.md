# Intent: FR-CIV-PERF-010 -- Performance
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-PERF-010 contributes to the overall simulation capability by addressing: Performance.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-perf-010-spec.md` |
| ADR | `fr-civ-perf-010-adr.md` |
| Research | `fr-civ-perf-010-research.md` |
| Plan | `fr-civ-perf-010-plan.md` |
