# Intent: FR-CIV-ROAD-900 -- Road and path systems
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-ROAD-900 contributes to the overall simulation capability by addressing: Road and path systems.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-road-900-spec.md` |
| ADR | `fr-civ-road-900-adr.md` |
| Research | `fr-civ-road-900-research.md` |
| Plan | `fr-civ-road-900-plan.md` |
