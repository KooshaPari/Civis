# Intent: FR-SESSION-011 -- Session management
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-SESSION-011 contributes to the overall simulation capability by addressing: Session management.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-session-011-spec.md` |
| ADR | `fr-session-011-adr.md` |
| Research | `fr-session-011-research.md` |
| Plan | `fr-session-011-plan.md` |
