# Intent: FR-UX-025 -- User experience
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-UX-025 contributes to the overall simulation capability by addressing: User experience.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-ux-025-spec.md` |
| ADR | `fr-ux-025-adr.md` |
| Research | `fr-ux-025-research.md` |
| Plan | `fr-ux-025-plan.md` |
