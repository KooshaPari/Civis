# Intent: FR-CIV-MOD-014 -- Mod system (WASM)
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-MOD-014 contributes to the overall simulation capability by addressing: Mod system (WASM).
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-mod-014-spec.md` |
| ADR | `fr-civ-mod-014-adr.md` |
| Research | `fr-civ-mod-014-research.md` |
| Plan | `fr-civ-mod-014-plan.md` |
