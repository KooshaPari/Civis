...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-THRY-001 contributes to the overall simulation capability by addressing: Theory.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-thry-001-spec.md` |
| ADR | `fr-thry-001-adr.md` |
| Research | `fr-thry-001-research.md` |
| Plan | `fr-thry-001-plan.md` |
