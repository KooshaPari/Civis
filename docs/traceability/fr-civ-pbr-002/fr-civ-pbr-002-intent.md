# Intent: FR-CIV-PBR-002 -- Physically based rendering
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-PBR-002 contributes to the overall simulation capability by addressing: Physically based rendering.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-pbr-002-spec.md` |
| ADR | `fr-civ-pbr-002-adr.md` |
| Research | `fr-civ-pbr-002-research.md` |
| Plan | `fr-civ-pbr-002-plan.md` |
