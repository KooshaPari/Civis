# Intent: FR-CIV-INFRA-011 -- Infrastructure systems
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-INFRA-011 contributes to the overall simulation capability by addressing: Infrastructure systems.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-infra-011-spec.md` |
| ADR | `fr-civ-infra-011-adr.md` |
| Research | `fr-civ-infra-011-research.md` |
| Plan | `fr-civ-infra-011-plan.md` |
