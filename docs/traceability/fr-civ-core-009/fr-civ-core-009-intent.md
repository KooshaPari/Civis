# Intent: FR-CIV-CORE-009 -- Core simulation engine
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-CORE-009 contributes to the overall simulation capability by addressing: Core simulation engine.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-core-009-spec.md` |
| ADR | `fr-civ-core-009-adr.md` |
| Research | `fr-civ-core-009-research.md` |
| Plan | `fr-civ-core-009-plan.md` |
