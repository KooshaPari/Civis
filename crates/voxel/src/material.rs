...
pub struct MaterialDef {
    ...
    /// FR-CIV-CA-002 TPT-style thermal model fields for data-driven phase work.
    pub tpt_thermal: TptThermalProps,
...
/// FR-CIV-CA-002 TPT-style thermal fields stored as plain material data.
#[derive(Debug, Clone, Copy, PartialEq, Eq, Serialize, Deserialize)]
pub struct TptThermalProps {
    /// Relative conductivity on the TPT 0-255 scale.
    pub heat_conduct: u8,
    /// Temperature where the material melts, when modeled.
    pub melt_point: Option<i32>,
    /// Temperature where the material boils, when modeled.
    pub boil_point: Option<i32>,
    /// Temperature where the material freezes, when modeled.
    pub freeze_point: Option<i32>,
    /// Latent heat budget for phase changes.
    pub latent_heat: u32,
    /// Material produced by a thermal phase transition, when deterministic.
    pub phase_target: Option<MaterialId>,
}
...
pub const STANDARD_MATERIALS: [MaterialDef; 41] = [
    MaterialDef {
        ...
        tpt_thermal: TptThermalProps {
            heat_conduct: 4,
            melt_point: Some(-273),
            boil_point: Some(32000),
            freeze_point: Some(-273),
            latent_heat: 0,
            phase_target: None,
        },
        heat_conduct: 4,
    ...
    MaterialDef {
        ...
        tpt_thermal: TptThermalProps {
            heat_conduct: 15,
            melt_point: Some(1_100),
            boil_point: Some(3_000),
            freeze_point: Some(700),
            latent_heat: 400,
            phase_target: Some(STONE),
        },
        heat_conduct: 15,
        melting_point: 1_100,
        boiling_point: 3_000,
    ...
    MaterialDef {
        ...
        tpt_thermal: TptThermalProps {
            heat_conduct: 45,
            melt_point: Some(1_710),
            boil_point: Some(2_600),
            freeze_point: Some(-20),
            latent_heat: 0,
            phase_target: None,
        },
        heat_conduct: 45,
    ...
    MaterialDef {
        ...
        tpt_thermal: TptThermalProps {
            heat_conduct: 80,
            melt_point: Some(1_450),
            boil_point: Some(2_900),
            freeze_point: Some(-20),
            latent_heat: 0,
            phase_target: None,
        },
    ...
    MaterialDef {
        ...
        tpt_thermal: TptThermalProps {
            heat_conduct: 50,
            melt_point: Some(1_530),
            boil_point: Some(3_500),
            freeze_point: Some(20),
            latent_heat: 0,
            phase_target: None,
        },
    ...
    MaterialDef {
        ...
        tpt_thermal: TptThermalProps {
            heat_conduct: 20,
            melt_point: Some(3_500),
            boil_point: Some(9_000),
            freeze_point: Some(-20),
            latent_heat: 0,
            phase_target: None,
        },
    ...
    MaterialDef {
        ...
        tpt_thermal: TptThermalProps {
            heat_conduct: 60,
            melt_point: Some(1_450),
            boil_point: Some(3_200),
            freeze_point: Some(1_200),
            latent_heat: 800,
            phase_target: None,
        },
        heat_conduct: 60,
    ...
    MaterialDef {
        ...
        tpt_thermal: TptThermalProps {
            heat_conduct: 55,
            melt_point: Some(1_650),
            boil_point: Some(2_500),
            freeze_point: Some(-10),
            latent_heat: 0,
            phase_target: None,
        },
    ...
    MaterialDef {
        ...
        tpt_thermal: TptThermalProps {
            heat_conduct: 20,
            melt_point: Some(1_430),
            boil_point: Some(2_700),
            freeze_point: Some(-20),
            latent_heat: 0,
            phase_target: None,
        },
    ...
    MaterialDef {
        ...
        tpt_thermal: TptThermalProps {
            heat_conduct: 35,
            melt_point: Some(1_300),
            boil_point: Some(2_100),
            freeze_point: Some(-20),
            latent_heat: 0,
            phase_target: None,
        },
    ...
    MaterialDef {
        ...
        tpt_thermal: TptThermalProps {
            heat_conduct: 1,
            melt_point: Some(4_000),
            boil_point: Some(10_000),
            freeze_point: Some(-400),
            latent_heat: 0,
            phase_target: None,
        },
        heat_conduct: 1,
...
mod tests {
    ...
    /// FR-CIV-CA-002 keeps TPT-model thermal fields in the material data table.
    #[test]
    fn water_tpt_thermal_defaults_are_data_driven() {
        let registry = MaterialRegistry::standard();
        let water = registry.get(WATER).expect("water");

        assert_eq!(water.tpt_thermal.heat_conduct, 90);
        assert_eq!(water.tpt_thermal.melt_point, Some(0));
        assert_eq!(water.tpt_thermal.boil_point, Some(100));
        assert_eq!(water.tpt_thermal.freeze_point, Some(0));
        assert_eq!(water.tpt_thermal.latent_heat, 2_257);
        assert_eq!(water.tpt_thermal.phase_target, Some(STEAM));
    }
