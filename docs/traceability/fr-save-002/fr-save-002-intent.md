# Intent: FR-SAVE-002 -- Save system
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-SAVE-002 contributes to the overall simulation capability by addressing: Save system.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-save-002-spec.md` |
| ADR | `fr-save-002-adr.md` |
| Research | `fr-save-002-research.md` |
| Plan | `fr-save-002-plan.md` |
