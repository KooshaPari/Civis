# Intent: FR-SOC-HLT-003 -- Social health
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-SOC-HLT-003 contributes to the overall simulation capability by addressing: Social health.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-soc-hlt-003-spec.md` |
| ADR | `fr-soc-hlt-003-adr.md` |
| Research | `fr-soc-hlt-003-research.md` |
| Plan | `fr-soc-hlt-003-plan.md` |
