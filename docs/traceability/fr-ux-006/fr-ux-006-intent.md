# Intent: FR-UX-006 -- User experience
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-UX-006 contributes to the overall simulation capability by addressing: User experience.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-ux-006-spec.md` |
| ADR | `fr-ux-006-adr.md` |
| Research | `fr-ux-006-research.md` |
| Plan | `fr-ux-006-plan.md` |
