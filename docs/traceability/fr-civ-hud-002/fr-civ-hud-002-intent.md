# Intent: FR-CIV-HUD-002 -- HUD overlay
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-HUD-002 contributes to the overall simulation capability by addressing: HUD overlay.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-hud-002-spec.md` |
| ADR | `fr-civ-hud-002-adr.md` |
| Research | `fr-civ-hud-002-research.md` |
| Plan | `fr-civ-hud-002-plan.md` |
