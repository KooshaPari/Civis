# Intent: FR-CIV-TACTICS-003 -- Tactics and strategy

> Date: 2026-09-17
> FR: FR-CIV-TACTICS-003
> Epic: FR-CIV-TACTICS
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-TACTICS-003 contributes to the overall simulation capability by addressing: Tactics and strategy.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-tactics-003-spec.md` |
| ADR | `fr-civ-tactics-003-adr.md` |
| Research | `fr-civ-tactics-003-research.md` |
| Plan | `fr-civ-tactics-003-plan.md` |
