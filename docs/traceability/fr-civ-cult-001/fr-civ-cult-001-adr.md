# ADR: FR-CIV-CULT-001 -- Culture system

> Status: Proposed
> Date: 2026-09-17
> Deciders: CivLab
> Relates to: FR-CIV-CULT-001
> Epic: FR-CIV-CULT

## Context

FR-CIV-CULT-001 is part of the FR-CIV-CULT epic. This functional requirement captures: Culture system.

Implementing crate: `crates/civ-institutions/src/`

### Referenced Source
- `docs/reference/agileplus-artifacts-index.md:169`
- `docs/reference/agileplus-artifacts-index.md:290`
...
TBD -- The architectural decision for FR-CIV-CULT-001 needs to be finalized based on implementation exploration.
