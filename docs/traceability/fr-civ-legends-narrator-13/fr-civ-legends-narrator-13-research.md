# Research: FR-CIV-LEGENDS-NARRATOR-13 -- Civ Legends Narrator
...
What is the best approach to implement Civ Legends Narrator within the Civis simulation engine?

## Background

This FR belongs to the FR-CIV-LEGENDS-NARRATOR epic and is expected to be implemented in `crates/legends/src/`.
