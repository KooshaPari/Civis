# Intent: FR-SESSION-009 -- Session management
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-SESSION-009 contributes to the overall simulation capability by addressing: Session management.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-session-009-spec.md` |
| ADR | `fr-session-009-adr.md` |
| Research | `fr-session-009-research.md` |
| Plan | `fr-session-009-plan.md` |
