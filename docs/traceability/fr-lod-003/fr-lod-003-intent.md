# Intent: FR-LOD-003 -- Level of detail
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-LOD-003 contributes to the overall simulation capability by addressing: Level of detail.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-lod-003-spec.md` |
| ADR | `fr-lod-003-adr.md` |
| Research | `fr-lod-003-research.md` |
| Plan | `fr-lod-003-plan.md` |
