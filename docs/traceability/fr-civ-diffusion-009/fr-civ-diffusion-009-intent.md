# Intent: FR-CIV-DIFFUSION-009 -- Cultural diffusion
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-DIFFUSION-009 contributes to the overall simulation capability by addressing: Cultural diffusion.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-diffusion-009-spec.md` |
| ADR | `fr-civ-diffusion-009-adr.md` |
| Research | `fr-civ-diffusion-009-research.md` |
| Plan | `fr-civ-diffusion-009-plan.md` |
