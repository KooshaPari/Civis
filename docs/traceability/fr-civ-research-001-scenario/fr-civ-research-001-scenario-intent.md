# Intent: FR-CIV-RESEARCH-001-SCENARIO -- Technology research

> Date: 2026-09-17
> FR: FR-CIV-RESEARCH-001-SCENARIO
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-RESEARCH-001-SCENARIO contributes to the overall simulation capability by addressing: Technology research.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-research-001-scenario-spec.md` |
| ADR | `fr-civ-research-001-scenario-adr.md` |
| Research | `fr-civ-research-001-scenario-research.md` |
| Plan | `fr-civ-research-001-scenario-plan.md` |
