...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-ECON-003 contributes to the overall simulation capability by addressing: Economics.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-econ-003-spec.md` |
| ADR | `fr-econ-003-adr.md` |
| Research | `fr-econ-003-research.md` |
| Plan | `fr-econ-003-plan.md` |
