# Intent: FR-CIV-CORE-016 -- Core simulation engine
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-CORE-016 contributes to the overall simulation capability by addressing: Core simulation engine.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-core-016-spec.md` |
| ADR | `fr-civ-core-016-adr.md` |
| Research | `fr-civ-core-016-research.md` |
| Plan | `fr-civ-core-016-plan.md` |
