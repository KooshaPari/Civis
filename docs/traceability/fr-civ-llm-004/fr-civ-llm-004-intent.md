...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-LLM-004 contributes to the overall simulation capability by addressing: Civ Llm.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-llm-004-spec.md` |
| ADR | `fr-civ-llm-004-adr.md` |
| Research | `fr-civ-llm-004-research.md` |
| Plan | `fr-civ-llm-004-plan.md` |
