# Intent: FR-CIV-MCP-006 -- MCP server integration
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-MCP-006 contributes to the overall simulation capability by addressing: MCP server integration.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-mcp-006-spec.md` |
| ADR | `fr-civ-mcp-006-adr.md` |
| Research | `fr-civ-mcp-006-research.md` |
| Plan | `fr-civ-mcp-006-plan.md` |
