...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-MOD-001 contributes to the overall simulation capability by addressing: Modding.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-mod-001-spec.md` |
| ADR | `fr-mod-001-adr.md` |
| Research | `fr-mod-001-research.md` |
| Plan | `fr-mod-001-plan.md` |
