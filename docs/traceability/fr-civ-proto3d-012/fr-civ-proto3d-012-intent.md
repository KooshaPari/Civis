# Intent: FR-CIV-PROTO3D-012 -- Core civilisation simulation

> Date: 2026-09-17
> FR: FR-CIV-PROTO3D-012
> Epic: FR-CIV
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-PROTO3D-012 contributes to the overall simulation capability by addressing: Core civilisation simulation.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-proto3d-012-spec.md` |
| ADR | `fr-civ-proto3d-012-adr.md` |
| Research | `fr-civ-proto3d-012-research.md` |
| Plan | `fr-civ-proto3d-012-plan.md` |
