# ADR: FR-CIV-PBR-008 -- Physically based rendering

> Status: Proposed
> Date: 2026-09-17
> Deciders: CivLab
> Relates to: FR-CIV-PBR-008
> Epic: FR-CIV-PBR

## Context

FR-CIV-PBR-008 is part of the FR-CIV-PBR epic. This functional requirement captures: Physically based rendering.
...
TBD -- The architectural decision for FR-CIV-PBR-008 needs to be finalized based on implementation exploration.
