# Intent: FR-CIV-UX-002 -- User experience
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-UX-002 contributes to the overall simulation capability by addressing: User experience.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-ux-002-spec.md` |
| ADR | `fr-civ-ux-002-adr.md` |
| Research | `fr-civ-ux-002-research.md` |
| Plan | `fr-civ-ux-002-plan.md` |
