# Intent: FR-CIV-ASSET-012 -- Asset pipeline
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-ASSET-012 contributes to the overall simulation capability by addressing: Asset pipeline.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-asset-012-spec.md` |
| ADR | `fr-civ-asset-012-adr.md` |
| Research | `fr-civ-asset-012-research.md` |
| Plan | `fr-civ-asset-012-plan.md` |
