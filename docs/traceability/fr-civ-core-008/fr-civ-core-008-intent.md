# Intent: FR-CIV-CORE-008 -- Core simulation engine
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-CORE-008 contributes to the overall simulation capability by addressing: Core simulation engine.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-core-008-spec.md` |
| ADR | `fr-civ-core-008-adr.md` |
| Research | `fr-civ-core-008-research.md` |
| Plan | `fr-civ-core-008-plan.md` |
