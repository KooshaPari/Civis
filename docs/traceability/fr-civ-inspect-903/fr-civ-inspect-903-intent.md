# Intent: FR-CIV-INSPECT-903 -- Inspection tools

> Date: 2026-09-17
> FR: FR-CIV-INSPECT-903
> Epic: FR-CIV-INSPECT
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-INSPECT-903 contributes to the overall simulation capability by addressing: Inspection tools.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-inspect-903-spec.md` |
| ADR | `fr-civ-inspect-903-adr.md` |
| Research | `fr-civ-inspect-903-research.md` |
| Plan | `fr-civ-inspect-903-plan.md` |
