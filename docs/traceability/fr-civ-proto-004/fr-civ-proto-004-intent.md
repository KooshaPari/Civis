# Intent: FR-CIV-PROTO-004 -- 3D protocol
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-PROTO-004 contributes to the overall simulation capability by addressing: 3D protocol.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-proto-004-spec.md` |
| ADR | `fr-civ-proto-004-adr.md` |
| Research | `fr-civ-proto-004-research.md` |
| Plan | `fr-civ-proto-004-plan.md` |
