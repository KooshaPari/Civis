# Intent: FR-CIV-VOXEL-025 -- Voxel rendering
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-VOXEL-025 contributes to the overall simulation capability by addressing: Voxel rendering.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-voxel-025-spec.md` |
| ADR | `fr-civ-voxel-025-adr.md` |
| Research | `fr-civ-voxel-025-research.md` |
| Plan | `fr-civ-voxel-025-plan.md` |
