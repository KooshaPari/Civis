# Intent: FR-CIV-RESEARCH-011 -- Technology research

> Date: 2026-09-17
> FR: FR-CIV-RESEARCH-011
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-RESEARCH-011 contributes to the overall simulation capability by addressing: Technology research.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-research-011-spec.md` |
| ADR | `fr-civ-research-011-adr.md` |
| Research | `fr-civ-research-011-research.md` |
| Plan | `fr-civ-research-011-plan.md` |
