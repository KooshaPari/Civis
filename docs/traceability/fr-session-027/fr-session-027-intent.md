# Intent: FR-SESSION-027 -- Session management
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-SESSION-027 contributes to the overall simulation capability by addressing: Session management.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-session-027-spec.md` |
| ADR | `fr-session-027-adr.md` |
| Research | `fr-session-027-research.md` |
| Plan | `fr-session-027-plan.md` |
