# Intent: FR-SOC-HLT-001 -- Social health
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-SOC-HLT-001 contributes to the overall simulation capability by addressing: Social health.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-soc-hlt-001-spec.md` |
| ADR | `fr-soc-hlt-001-adr.md` |
| Research | `fr-soc-hlt-001-research.md` |
| Plan | `fr-soc-hlt-001-plan.md` |
