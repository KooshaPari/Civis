# Intent: FR-CIV-GOV-001 -- Government and governance
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-GOV-001 contributes to the overall simulation capability by addressing: Government and governance.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-gov-001-spec.md` |
| ADR | `fr-civ-gov-001-adr.md` |
| Research | `fr-civ-gov-001-research.md` |
| Plan | `fr-civ-gov-001-plan.md` |
