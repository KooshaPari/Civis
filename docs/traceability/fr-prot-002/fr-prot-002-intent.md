...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-PROT-002 contributes to the overall simulation capability by addressing: Protocol.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-prot-002-spec.md` |
| ADR | `fr-prot-002-adr.md` |
| Research | `fr-prot-002-research.md` |
| Plan | `fr-prot-002-plan.md` |
