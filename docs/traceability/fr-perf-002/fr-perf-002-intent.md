# Intent: FR-PERF-002 -- Performance
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-PERF-002 contributes to the overall simulation capability by addressing: Performance.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-perf-002-spec.md` |
| ADR | `fr-perf-002-adr.md` |
| Research | `fr-perf-002-research.md` |
| Plan | `fr-perf-002-plan.md` |
