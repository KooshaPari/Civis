# Intent: FR-CIV-RESEARCH-020 -- Technology research

> Date: 2026-09-17
> FR: FR-CIV-RESEARCH-020
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-RESEARCH-020 contributes to the overall simulation capability by addressing: Technology research.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-research-020-spec.md` |
| ADR | `fr-civ-research-020-adr.md` |
| Research | `fr-civ-research-020-research.md` |
| Plan | `fr-civ-research-020-plan.md` |
