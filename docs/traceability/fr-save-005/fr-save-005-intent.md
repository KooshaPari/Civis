# Intent: FR-SAVE-005 -- Save system
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-SAVE-005 contributes to the overall simulation capability by addressing: Save system.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-save-005-spec.md` |
| ADR | `fr-save-005-adr.md` |
| Research | `fr-save-005-research.md` |
| Plan | `fr-save-005-plan.md` |
