//! civ-diffusion — Tech adoption S-curve engine (Bass/Rogers) driving wardrobe/tools propagation
//!
...
//!
//! Functional requirements: FR-CIV-DIFFUSION-*
...
mod stub_tests {
    ...
    /// FR-CIV-DIFFUSION-000 — crate compiles and exposes a schema version.
