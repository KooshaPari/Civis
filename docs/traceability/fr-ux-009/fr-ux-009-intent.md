# Intent: FR-UX-009 -- User experience
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-UX-009 contributes to the overall simulation capability by addressing: User experience.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-ux-009-spec.md` |
| ADR | `fr-ux-009-adr.md` |
| Research | `fr-ux-009-research.md` |
| Plan | `fr-ux-009-plan.md` |
