...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CLIM-001 contributes to the overall simulation capability by addressing: Climate.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-clim-001-spec.md` |
| ADR | `fr-clim-001-adr.md` |
| Research | `fr-clim-001-research.md` |
| Plan | `fr-clim-001-plan.md` |
