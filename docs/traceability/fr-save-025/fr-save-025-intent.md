# Intent: FR-SAVE-025 -- Save system
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-SAVE-025 contributes to the overall simulation capability by addressing: Save system.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-save-025-spec.md` |
| ADR | `fr-save-025-adr.md` |
| Research | `fr-save-025-research.md` |
| Plan | `fr-save-025-plan.md` |
