# Intent: FR-CIV-LEGENDS-004 -- Legend and narrative system

> Date: 2026-09-17
> FR: FR-CIV-LEGENDS-004
> Epic: FR-CIV-LEGENDS
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-LEGENDS-004 contributes to the overall simulation capability by addressing: Legend and narrative system.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-legends-004-spec.md` |
| ADR | `fr-civ-legends-004-adr.md` |
| Research | `fr-civ-legends-004-research.md` |
| Plan | `fr-civ-legends-004-plan.md` |
