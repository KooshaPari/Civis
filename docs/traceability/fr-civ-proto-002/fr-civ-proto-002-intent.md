# Intent: FR-CIV-PROTO-002 -- 3D protocol
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-PROTO-002 contributes to the overall simulation capability by addressing: 3D protocol.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-proto-002-spec.md` |
| ADR | `fr-civ-proto-002-adr.md` |
| Research | `fr-civ-proto-002-research.md` |
| Plan | `fr-civ-proto-002-plan.md` |
