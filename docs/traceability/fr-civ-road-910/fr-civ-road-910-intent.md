# Intent: FR-CIV-ROAD-910 -- Road and path systems
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-ROAD-910 contributes to the overall simulation capability by addressing: Road and path systems.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-road-910-spec.md` |
| ADR | `fr-civ-road-910-adr.md` |
| Research | `fr-civ-road-910-research.md` |
| Plan | `fr-civ-road-910-plan.md` |
