...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-DET-002 contributes to the overall simulation capability by addressing: Determinism.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-det-002-spec.md` |
| ADR | `fr-det-002-adr.md` |
| Research | `fr-det-002-research.md` |
| Plan | `fr-det-002-plan.md` |
