# Intent: FR-INST-002 -- Institution
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-INST-002 contributes to the overall simulation capability by addressing: Institution.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-inst-002-spec.md` |
| ADR | `fr-inst-002-adr.md` |
| Research | `fr-inst-002-research.md` |
| Plan | `fr-inst-002-plan.md` |
