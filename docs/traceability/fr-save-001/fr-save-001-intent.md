# Intent: FR-SAVE-001 -- Save system
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-SAVE-001 contributes to the overall simulation capability by addressing: Save system.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-save-001-spec.md` |
| ADR | `fr-save-001-adr.md` |
| Research | `fr-save-001-research.md` |
| Plan | `fr-save-001-plan.md` |
