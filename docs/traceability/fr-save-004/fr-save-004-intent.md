# Intent: FR-SAVE-004 -- Save system
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-SAVE-004 contributes to the overall simulation capability by addressing: Save system.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-save-004-spec.md` |
| ADR | `fr-save-004-adr.md` |
| Research | `fr-save-004-research.md` |
| Plan | `fr-save-004-plan.md` |
