# Research: FR-CIV-GODOT-UX-000 -- Civ Godot Ux
...
What is the best approach to implement Civ Godot Ux within the Civis simulation engine?

## Background

This FR belongs to the FR-CIV-GODOT-UX epic and is expected to be implemented in `crates/protocol-3d/src/`.
