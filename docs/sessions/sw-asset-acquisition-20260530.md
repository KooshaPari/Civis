...
19 real meshes generated (Blender, `generate_sw_procedural.py`), converted to FBX
(`convert_real_models.py`), and built into Unity 2021.3.45f1 AssetBundles
(`Assets/Editor/BuildSwMissingBundles.cs`, `-batchmode -nographics -noUpm`). Bundles copied to
`packs/warfare-starwars/assets/bundles/` with filename == visual_asset == Addressable key.

| Bundle key (visual_asset) | Bundle bytes | Source mesh / archetype |
|---------------------------|--------------|-------------------------|
| sw-general-grievous       | 137822 | grievous (4-arm humanoid) |
| sw-jedi-knight            | 103217 | biped |
| sw-rep-at-te-walker       | 153625 | 6-leg walker |
| sw-tri-fighter            | 82406  | tri-armed fighter |
| sw-rep-arc-trooper        | 103598 | biped |
| sw-cis-magna-guard        | 103128 | biped |
| sw-clone-commando         | 103386 | biped |
| sw-rep-clone-sniper       | 103627 | biped |
| sw-cis-medical-droid      | 104191 | biped |
| sw-b1-squad               | 104255 | biped |
| sw-clone-wall-guard       | 103298 | biped |
| sw-aat-walker             | 93727  | hovertank |
| sw-cis-aat                | 93762  | hovertank (alias) |
| sw-v19-torrent            | 117412 | forked-wing fighter |
| sw-rep-laat-gunship       | 94493  | gunship |
| sw-cis-spider-droid       | 131774 | quad spider droid |
| sw-cis-stap               | 99086  | speeder |
| sw-barc-speeder           | 99362  | speeder |
| sw-droideka               | 99743  | tripod droideka |

Render proofs (Blender EEVEE-Next, 256px) for 10 marquee units in
`docs/screenshots/model-previews/sw-procedural/`. AT-TE proof confirms a recognizable
multi-leg-walker silhouette (vs the prior stub cube).

All bundles are 82–153 KB (real geometry, 2.4k–8k verts each) — they are NOT the 90-byte stub
bundles flagged in #101. They render a shaped, faction-colored unit. They are placeholder-grade
(parametric silhouettes) and meant to be upgraded by Path A/B fidelity sources.
