...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-NET-002 contributes to the overall simulation capability by addressing: Networking.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-net-002-spec.md` |
| ADR | `fr-net-002-adr.md` |
| Research | `fr-net-002-research.md` |
| Plan | `fr-net-002-plan.md` |
