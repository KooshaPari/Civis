# Intent: FR-SAVE-017 -- Save system
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-SAVE-017 contributes to the overall simulation capability by addressing: Save system.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-save-017-spec.md` |
| ADR | `fr-save-017-adr.md` |
| Research | `fr-save-017-research.md` |
| Plan | `fr-save-017-plan.md` |
