# Intent: FR-CIV-GENETICS-000 -- Procedural genetics

> Date: 2026-09-17
> FR: FR-CIV-GENETICS-000
...
### Product Context
Civis is a Rust-based civilisation simulation built on Bevy ECS with 42 crates. FR-CIV-GENETICS-000 contributes to the overall simulation capability by addressing: Procedural genetics.
...
| Artifact | Path |
|----------|------|
| Spec | `fr-civ-genetics-000-spec.md` |
| ADR | `fr-civ-genetics-000-adr.md` |
| Research | `fr-civ-genetics-000-research.md` |
| Plan | `fr-civ-genetics-000-plan.md` |
